...
public abstract class MountedItemStorageType<T extends MountedItemStorage> {
    public static final Codec<MountedItemStorageType<?>> CODEC =
            CreateBuiltInRegistries.MOUNTED_ITEM_STORAGE_TYPE.byNameCodec();
    ...
    public final Holder.Reference<MountedItemStorageType<?>> holder =
            CreateBuiltInRegistries.MOUNTED_ITEM_STORAGE_TYPE.createIntrusiveHolder(this);
    ...
    public static <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> mountedItemStorage(
        ...
        return builder -> builder.onRegisterAfter(
                ...
                block -> REGISTRY.register(block, type.get()));
    }
}
