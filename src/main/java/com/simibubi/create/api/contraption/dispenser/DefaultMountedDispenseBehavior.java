...
public class DefaultMountedDispenseBehavior implements MountedDispenseBehavior {
    ...
    public ItemStack dispense(ItemStack stack, MovementContext context, BlockPos pos) {
        ...
        if (inventory == null) {
            ...
            ItemStack remainder = HopperBlockEntity.addItem(
                    null, inventory, toInsert, closestToFacing.getOpposite());
    ...
    public static void spawnItem(
        ...
        if (MountedDispenseBehavior.getClosestFacingDirection(facing).getAxis()
                == Direction.Axis.Y) {
            y = y - 0.125;
        } else {
            y = y - 0.15625;
