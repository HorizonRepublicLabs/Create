...
public abstract class ConductorBlockInteractionBehavior extends MovingInteractionBehaviour {
    ...
    public final boolean handlePlayerInteraction(
        ...
        if (!(contraptionEntity instanceof CarriageContraptionEntity carriageEntity)) return false;
        ...
        if (info == null || !this.isValidConductor(info.state())) return false;
        ...
        for (Direction direction : Iterate.directionsInAxis(assemblyDirection.getAxis())) {
            ...
            if (train.runtime.getSchedule() != null) {
                if (train.runtime.paused && !train.runtime.completed) {
                    ...
                    AllSoundEvents.CONFIRM.playOnServer(
                            player.level(), player.blockPosition(), 1, 1);
                    player.displayClientMessage(
                            CreateLang.translateDirect("schedule.continued"), true);
                    return true;
                }
                ...
                player.setItemInHand(
                        activeHand, train.runtime.returnSchedule(player.registryAccess()));
            ...
            if (!AllItems.SCHEDULE.isIn(itemInHand)) return true;
    ...
    private void setBlockState(
            BlockPos localPos, AbstractContraptionEntity contraption, BlockState newState) {
