...
public interface MovementBehaviour {
     ...
     */
    static <B extends Block> NonNullConsumer<? super B> movementBehaviour(
    ...
    default void dropItem(MovementContext context, ItemStack stack) {
        ...
        if (AllConfigs.server().kinetics.moveItemsToStorage.get())
            remainder = ItemHandlerHelper.insertItem(
        ...
        itemEntity.setDeltaMovement(
                context.motion.add(0, 0.5f, 0).scale(context.world.random.nextFloat() * .3f));
