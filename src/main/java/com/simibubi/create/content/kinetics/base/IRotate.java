...
public interface IRotate extends IWrenchable {
    ...
    enum SpeedLevel {
        ...
        public static SpeedLevel of(float speed) {
            ...
            if (speed >= AllConfigs.server().kinetics.fastSpeed.get()) return FAST;
            if (speed >= AllConfigs.server().kinetics.mediumSpeed.get()) return MEDIUM;
        ...
        public static LangBuilder getFormattedSpeedText(float speed, boolean overstressed) {
            ...
            LangBuilder builder =
                    CreateLang.text(TooltipHelper.makeProgressBar(3, speedLevel.ordinal()));
            ...
            else builder.style(speedLevel.getTextColor());
    ...
    enum StressImpact {
        ...
        public static StressImpact of(double stressPercent) {
            ...
            if (stressPercent > .75d) return StressImpact.HIGH;
            if (stressPercent > .5d) return StressImpact.MEDIUM;
        ...
        public static LangBuilder getFormattedStressText(double stressPercent) {
            ...
            return CreateLang.text(TooltipHelper.makeProgressBar(
                            3, Math.min(stressLevel.ordinal() + 1, 3)))
