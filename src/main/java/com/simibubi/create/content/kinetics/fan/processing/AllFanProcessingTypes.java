...
public class AllFanProcessingTypes {
    ...
    static {
        Object2ReferenceOpenHashMap<String, FanProcessingType> map =
    ...
    private static <T extends FanProcessingType> T register(String name, T type) {
        return Registry.register(
                CreateBuiltInRegistries.FAN_PROCESSING_TYPE, Create.asResource(name), type);
    }
        ...
        public boolean isValidAt(Level level, BlockPos pos) {
            ...
            if (AllBlockTags.FAN_PROCESSING_CATALYSTS_BLASTING.matches(blockState)) {
                return !blockState.hasProperty(BlazeBurnerBlock.HEAT_LEVEL)
                        || blockState
                                .getValue(BlazeBurnerBlock.HEAT_LEVEL)
        ...
        public List<ItemStack> process(ItemStack stack, Level level) {
            ...
            if (smeltingRecipe.isPresent()) {
                ...
                if (smokingRecipe.isEmpty()
                    ...
                    return RecipeApplier.applyRecipeOn(
                            level, stack, smeltingRecipe.get().value(), false);
                }
            }
        ...
        public boolean isValidAt(Level level, BlockPos pos) {
            ...
            if (AllBlockTags.FAN_PROCESSING_CATALYSTS_HAUNTING.matches(blockState)) {
                if (blockState.is(BlockTags.CAMPFIRES)
                        && blockState.hasProperty(CampfireBlock.LIT)
                ...
                return !blockState.hasProperty(LitBlazeBurnerBlock.FLAME_TYPE)
                        || blockState.getValue(LitBlazeBurnerBlock.FLAME_TYPE)
                                == LitBlazeBurnerBlock.FlameType.SOUL;
            }
            return false;
        }
        ...
        public void affectEntity(Entity entity, Level level) {
            ...
            if (entity instanceof LivingEntity livingEntity) {
                livingEntity.addEffect(
                        new MobEffectInstance(MobEffects.BLINDNESS, 30, 0, false, false));
                livingEntity.addEffect(
        ...
        public boolean isValidAt(Level level, BlockPos pos) {
            ...
            if (AllBlockTags.FAN_PROCESSING_CATALYSTS_SMOKING.matches(blockState)) {
                ...
                if (blockState.hasProperty(LitBlazeBurnerBlock.FLAME_TYPE)
                        && blockState.getValue(LitBlazeBurnerBlock.FLAME_TYPE)
                                != LitBlazeBurnerBlock.FlameType.REGULAR) {
                    return false;
                }
                return !blockState.hasProperty(BlazeBurnerBlock.HEAT_LEVEL)
