...
public class SingleAxisRotatingVisual<T extends KineticBlockEntity>
        extends KineticBlockEntityVisual<T> implements SimpleTickableVisual {
    public static boolean rainbowMode = false;

    protected final RotatingInstance rotatingModel;

    public SingleAxisRotatingVisual(
            VisualizationContext context, T blockEntity, float partialTick, Model model) {
    ...
    public static <T extends KineticBlockEntity> SimpleBlockEntityVisualizer.Factory<T> of(
        ...
        return (context, blockEntity, partialTick) -> {
            return new SingleAxisRotatingVisual<>(
                    context, blockEntity, partialTick, Models.partial(partial));
        };
    }
    ...
    public static <T extends KineticBlockEntity> SingleAxisRotatingVisual<T> shaft(
        ...
        return new SingleAxisRotatingVisual<>(
                context, blockEntity, partialTick, Models.partial(AllPartialModels.SHAFT));
    }
