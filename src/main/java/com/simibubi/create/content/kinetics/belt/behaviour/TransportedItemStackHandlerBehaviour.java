...
public class TransportedItemStackHandlerBehaviour extends BlockEntityBehaviour {
    ...
    public static final BehaviourType<TransportedItemStackHandlerBehaviour> TYPE =
            new BehaviourType<>();
    ...
    public static class TransportedResult {
        ...
        private static final TransportedResult REMOVE_ITEM =
                new TransportedResult(ImmutableList.of(), null);
        ...
        public static TransportedResult convertToAndLeaveHeld(
                List<TransportedItemStack> outputs, TransportedItemStack heldOutput) {
        ...
        public boolean didntChangeFrom(ItemStack stackBefore) {
            return doesNothing()
                    || outputs.size() == 1
                            && ItemStack.matches(outputs.get(0).stack, stackBefore)
                            && !hasHeldOutput();
        }
        ...
        public List<TransportedItemStack> getOutputs() {
            if (outputs == null)
                throw new IllegalStateException(
                        "Do not call getOutputs() on a Result that doesNothing().");
            return outputs;
        }
    ...
    public TransportedItemStackHandlerBehaviour(
            SmartBlockEntity be, ProcessingCallback processingCallback) {
        super(be);
    ...
    public void handleProcessingOnAllItems(
