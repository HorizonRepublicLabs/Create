...
public class RotationIndicatorParticleData
    ...
    public static final MapCodec<RotationIndicatorParticleData> CODEC =
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, RotationIndicatorParticleData>
    ...
    public RotationIndicatorParticleData(
            int color, float speed, float radius1, float radius2, int lifeSpan, Axis axis) {
        this.color = color;
        this.speed = speed;
    ...
    @Override
    public StreamCodec<? super RegistryFriendlyByteBuf, RotationIndicatorParticleData>
            getStreamCodec() {
        return STREAM_CODEC;
    }

    @Override
    public MapCodec<RotationIndicatorParticleData> getCodec(
