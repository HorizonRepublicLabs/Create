...
public class SplitShaftRenderer extends KineticBlockEntityRenderer<SplitShaftBlockEntity> {
	...
	@Override
	protected void renderSafe(SplitShaftBlockEntity be, float partialTicks, PoseStack ms, SuperRenderTypeBuffer buffer,
		...
		for (Direction direction : Iterate.directions) {
			...
			superByteBuffer.renderInto(ms, buffer.getBuffer(CreateRenderTypes.solidMovingBlock()));
		}
	}
