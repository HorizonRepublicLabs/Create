...
public class GearboxVisual extends KineticBlockEntityVisual<GearboxBlockEntity> {
    ...
    public GearboxVisual(
            VisualizationContext context, GearboxBlockEntity blockEntity, float partialTick) {
        ...
        var instancer = instancerProvider()
    ...
    private float getSpeed(Direction direction) {
        ...
        if (speed != 0 && sourceFacing != null) {
            ...
            else if (sourceFacing.getAxisDirection() == direction.getAxisDirection()) speed *= -1;
        }
        return speed;
    }
