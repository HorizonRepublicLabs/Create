...
public class ChainConveyorPackage {
    ...
    public static final WorldAttached<Cache<Integer, ChainConveyorPackagePhysicsData>>
            physicsDataCache =
    ...
    public class ChainConveyorPackagePhysicsData {
        ...
        public boolean shouldTick() {
            if (lastTick == AnimationTickHolder.getTicks()) return false;
    ...
    public static ChainConveyorPackage read(
    ...
    public ChainConveyorPackagePhysicsData physicsData(LevelAccessor level) {
        if (physicsData == null) {
            try {
                return physicsData = physicsDataCache
                        .get(level)
        ...
        physicsDataCache.get(level).getIfPresent(netId);
        return physicsData;
    }
}
