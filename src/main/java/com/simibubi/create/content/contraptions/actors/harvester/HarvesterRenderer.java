...
public class HarvesterRenderer extends SafeBlockEntityRenderer<HarvesterBlockEntity> {
    ...
    protected void renderSafe(
        ...
        SuperByteBuffer superBuffer =
                CachedBuffers.partial(AllPartialModels.HARVESTER_BLADE, blockState);
        transform(
                be.getLevel(),
    ...
    public static void renderInContraption(
        ...
        superBuffer
                ...
                .renderInto(
                        matrices.getViewProjection(), buffers.getBuffer(RenderType.cutoutMipped()));
    }

    public static void transform(
            Level world, Direction facing, SuperByteBuffer superBuffer, float speed, Vec3 pivot) {
