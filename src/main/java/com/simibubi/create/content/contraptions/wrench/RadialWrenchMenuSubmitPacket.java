...
public record RadialWrenchMenuSubmitPacket(BlockPos blockPos, BlockState newState)
        implements ServerboundPacketPayload {
    public static final StreamCodec<ByteBuf, RadialWrenchMenuSubmitPacket> STREAM_CODEC =
    ...
    public void handle(ServerPlayer player) {
        ...
        if (!level.getBlockState(blockPos).is(newState.getBlock())) return;
