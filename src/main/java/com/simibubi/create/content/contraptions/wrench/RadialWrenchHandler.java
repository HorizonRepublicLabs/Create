...
public class RadialWrenchHandler {
    ...
    public static void clientTick() {
        if (COOLDOWN > 0 && !AllKeys.ROTATE_MENU.isPressed()) COOLDOWN--;
    }
    ...
    public static void onKeyInput(int key, boolean pressed) {
        ...
        if (heldItem.getItem() != AllItems.WRENCH.get()) return;
        ...
        RadialWrenchMenu.tryCreateFor(state, blockHitResult.getBlockPos(), level)
