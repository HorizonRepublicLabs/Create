...
public class RollerRenderer extends SmartBlockEntityRenderer<RollerBlockEntity> {
    ...
    protected void renderSafe(
        ...
        SuperByteBuffer superBuffer =
                CachedBuffers.partial(AllPartialModels.ROLLER_WHEEL, blockState);
        Direction facing = blockState.getValue(RollerBlock.FACING);
        superBuffer.translate(Vec3.atLowerCornerOf(facing.getNormal()).scale(17 / 16f));
        HarvesterRenderer.transform(
                be.getLevel(), facing, superBuffer, be.getAnimatedSpeed(), Vec3.ZERO);
        ...
        CachedBuffers.partial(AllPartialModels.ROLLER_FRAME, blockState)
                .rotateCentered(
                        AngleHelper.rad(AngleHelper.horizontalAngle(facing) + 180), Direction.UP)
                .light(light)
                .renderInto(ms, vc);
    }
    ...
    public static void renderInContraption(
        ...
        superBuffer
                ...
                .translate(Vec3.atLowerCornerOf(facing.getNormal()).scale(17 / 16f));
