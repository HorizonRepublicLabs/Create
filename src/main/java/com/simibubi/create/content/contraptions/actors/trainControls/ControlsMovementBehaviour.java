...
public class ControlsMovementBehaviour implements MovementBehaviour {
    ...
    public void renderInContraption(
        ...
        if (!(context.temporaryData instanceof LeverAngles angles)) return;
        ...
        if (ControlsHandler.getContraption() == entity
                && ControlsHandler.getControlsPos() != null
            ...
            angles.steering.chase(
                    (pressed.contains(3) ? 1 : 0) + (pressed.contains(2) ? -1 : 0),
                    0.2f,
                    Chaser.EXP);
