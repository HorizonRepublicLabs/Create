...
public class OrientedContraptionEntityRenderer
    ...
    public boolean shouldRender(
            ...
            double cameraY,
            double cameraZ) {
        if (!super.shouldRender(entity, frustum, cameraX, cameraY, cameraZ)) return false;
        return entity.getVehicle() != null
                || !AllContraptionTypeTags.REQUIRES_VEHICLE_FOR_RENDER.matches(
                        entity.getContraption().getType());
    }
}
