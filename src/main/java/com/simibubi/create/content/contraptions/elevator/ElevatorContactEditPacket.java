...
public class ElevatorContactEditPacket
    ...
    public static final StreamCodec<FriendlyByteBuf, ElevatorContactEditPacket> STREAM_CODEC =
            StreamCodec.composite(
                    BlockPos.STREAM_CODEC,
                    packet -> packet.pos,
                    ByteBufCodecs.stringUtf8(4),
                    packet -> packet.shortName,
                    ByteBufCodecs.stringUtf8(90),
                    packet -> packet.longName,
    ...
    public ElevatorContactEditPacket(
