...
public class ContraptionControlsMovement implements MovementBehaviour {
    ...
    public void stopMoving(MovementContext context) {
        ...
        if (filter != null)
            context.blockEntityData.putBoolean(
                    "Disabled",
                    context.contraption.isActorTypeDisabled(filter)
    ...
    public static ItemStack getFilter(MovementContext ctx) {
        ...
        return ItemStack.parseOptional(
                ctx.world.registryAccess(), blockEntityData.getCompound("Filter"));
    }
    ...
    public void tick(MovementContext ctx) {
        ...
        if (!(contraption instanceof ElevatorContraption ec)) {
            ...
            int value = contraption.isActorTypeDisabled(filter)
        ...
        if (!atTargetY || currentStage / 45 != 0) {
            ...
            indicator.chase(
                    currentIndicator + (below ? increment : -increment), 45f, Chaser.LINEAR);
            return;
        }
