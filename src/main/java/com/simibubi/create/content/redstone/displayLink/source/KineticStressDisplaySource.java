...
public class KineticStressDisplaySource extends PercentOrProgressBarDisplaySource {
    ...
    protected MutableComponent formatNumeric(DisplayLinkContext context, Float currentLevel) {
        ...
        if (mode == 1) return super.formatNumeric(context, currentLevel);
        LangBuilder builder = CreateLang.number(currentLevel);
        if (context.getTargetBlockEntity() instanceof FlapDisplayBlockEntity) builder.space();
        ...
        builder.addSelectionScrollInput(
                ...
                (si, l) -> si.forOptions(CreateLang.translatedOptions(
                        ...
                        .titled(CreateLang.translateDirect(
                                "display_source.kinetic_stress.display")),
                "Mode");
    }
