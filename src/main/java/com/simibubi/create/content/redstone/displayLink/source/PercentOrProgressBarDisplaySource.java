...
public abstract class PercentOrProgressBarDisplaySource extends NumericSingleLineDisplaySource {
    ...
    protected MutableComponent provideLine(DisplayLinkContext context, DisplayTargetStats stats) {
        ...
        if (!progressBarActive(context)) return formatNumeric(context, rawProgress);
    ...
    protected FlapDisplaySection createSectionForValue(DisplayLinkContext context, int size) {
        return !progressBarActive(context)
                ...
                : new FlapDisplaySection(size * FlapDisplaySection.MONOSPACE, "pixel", false, false)
                        .wideFlaps();
    }
