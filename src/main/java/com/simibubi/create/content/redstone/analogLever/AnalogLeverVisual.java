...
public class AnalogLeverVisual extends AbstractBlockEntityVisual<AnalogLeverBlockEntity>
    ...
    public AnalogLeverVisual(
            VisualizationContext context, AnalogLeverBlockEntity blockEntity, float partialTick) {
        super(context, blockEntity, partialTick);

        handle = instancerProvider()
                .instancer(
    ...
    public void beginFrame(DynamicVisual.Context ctx) {
        if (!blockEntity.clientState.settled()) animateLever(ctx.partialTick());
    }
    ...
    protected void animateLever(float pt) {
        ...
        transform(handle.setIdentityTransform())
