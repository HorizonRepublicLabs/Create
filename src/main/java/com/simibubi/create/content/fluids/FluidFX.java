...
public class FluidFX {
    ...
    public static void splash(BlockPos pos, FluidStack fluidStack) {
        ...
        BlockParticleOption blockParticleData =
                new BlockParticleOption(ParticleTypes.BLOCK, defaultState.createLegacyBlock());
    ...
    public static ParticleOptions getDrippingParticle(FluidStack fluid) {
        ...
        if (FluidHelper.isWater(fluid.getFluid())) particle = ParticleTypes.DRIPPING_WATER;
        if (FluidHelper.isLava(fluid.getFluid())) particle = ParticleTypes.DRIPPING_LAVA;
        if (particle == null)
