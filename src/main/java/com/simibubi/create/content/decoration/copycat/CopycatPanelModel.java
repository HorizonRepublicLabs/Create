...
public class CopycatPanelModel extends CopycatModel {
    ...
    protected List<BakedQuad> getCroppedQuads(
        ...
        if (specialCopycatModelState != null) {
            BakedModel blockModel = blockRenderer.getBlockModel(
        ...
        for (boolean front : Iterate.trueAndFalse) {
            ...
            AABB bb = CUBE_AABB.contract(
                    normal.x * contract / 16, normal.y * contract / 16, normal.z * contract / 16);
            if (!front) bb = bb.move(normalScaled14);
            ...
            for (int i = 0; i < size; i++) {
                ...
                quads.add(BakedQuadHelper.cloneWithCustomGeometry(
                        ...
                        BakedModelHelper.cropAndMove(
                                quad.getVertices(), quad.getSprite(), bb, normalScaledN13)));
            }
        }
