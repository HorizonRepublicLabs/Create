...
public class GirderBlockStateGenerator {
    ...
    public static void blockStateWithShaft(
            DataGenContext<Block, GirderEncasedShaftBlock> c, RegistrateBlockstateProvider p) {
    ...
    public static void blockState(
            DataGenContext<Block, GirderBlock> c, RegistrateBlockstateProvider p) {
        MultiPartBlockStateBuilder builder = p.getMultipartBuilder(c.get());
