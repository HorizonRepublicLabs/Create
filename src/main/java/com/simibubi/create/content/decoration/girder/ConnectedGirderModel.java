...
public class ConnectedGirderModel extends CTModel {
    ...
    protected static final ModelProperty<ConnectionData> CONNECTION_PROPERTY =
            new ModelProperty<>();
