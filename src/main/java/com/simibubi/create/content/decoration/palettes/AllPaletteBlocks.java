...
public class AllPaletteBlocks {
    ...
    public static final BlockEntry<TransparentBlock> TILED_GLASS = REGISTRATE
            .block("tiled_glass", TransparentBlock::new)
    ...
    public static final BlockEntry<WindowBlock>
            OAK_WINDOW = woodenWindowBlock(WoodType.OAK, Blocks.OAK_PLANKS),
            ...
            WEATHERED_IRON_WINDOW =
                    WindowGen.randomisedWindowBlock(
                            ...
                            .onRegister(CreateRegistrate.connectedTextures(
                                    () -> new WeatheredIronWindowCTBehaviour()))
                            .register();
    public static final BlockEntry<ConnectedGlassPaneBlock>
            OAK_WINDOW_PANE = woodenWindowPane(WoodType.OAK, OAK_WINDOW),
            SPRUCE_WINDOW_PANE = woodenWindowPane(WoodType.SPRUCE, SPRUCE_WINDOW),
            BIRCH_WINDOW_PANE =
                    woodenWindowPane(WoodType.BIRCH, BIRCH_WINDOW, () -> RenderType::translucent),
            ...
            WEATHERED_IRON_WINDOW_PANE =
                    customWindowPane(
                                    ...
                                    () -> RenderType::translucent)
                            .onRegister(CreateRegistrate.connectedTextures(
                                    () -> new WeatheredIronWindowPaneCTBehaviour()))
                            .register();
