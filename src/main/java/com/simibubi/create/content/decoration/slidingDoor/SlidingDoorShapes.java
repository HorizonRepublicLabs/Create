...
public class SlidingDoorShapes {
    ...
    protected static final VoxelShape SE_AABB_FOLD =
            Block.box(0.0D, 0.0D, -3.0D, 9.0D, 16.0D, 3.0D);
    protected static final VoxelShape ES_AABB_FOLD =
            Block.box(-3.0D, 0.0D, 0.0D, 3.0D, 16.0D, 9.0D);
    protected static final VoxelShape NW_AABB_FOLD =
            Block.box(7.0D, 0.0D, 13.0D, 16.0D, 16.0D, 19.0D);
    protected static final VoxelShape WN_AABB_FOLD =
            Block.box(13.0D, 0.0D, 7.0D, 19.0D, 16.0D, 16.0D);
    protected static final VoxelShape SW_AABB_FOLD =
            Block.box(7.0D, 0.0D, -3.0D, 16.0D, 16.0D, 3.0D);
    protected static final VoxelShape WS_AABB_FOLD =
            Block.box(13.0D, 0.0D, 0.0D, 19.0D, 16.0D, 9.0D);
    protected static final VoxelShape NE_AABB_FOLD =
            Block.box(0.0D, 0.0D, 13.0D, 9.0D, 16.0D, 19.0D);
    protected static final VoxelShape EN_AABB_FOLD =
            Block.box(-3.0D, 0.0D, 7.0D, 3.0D, 16.0D, 16.0D);
