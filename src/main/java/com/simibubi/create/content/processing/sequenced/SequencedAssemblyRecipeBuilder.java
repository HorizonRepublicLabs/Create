...
public class SequencedAssemblyRecipeBuilder {
    ...
    public <B extends ProcessingRecipeBuilder<?, ?, B>> SequencedAssemblyRecipeBuilder addStep(
        ...
        recipe.getSequence()
                .add(new SequencedRecipe<>(
                        builder.apply(recipeBuilder.require(placeHolder).output(placeHolder))
                                .build()));
        return this;
    }
    ...
    public SequencedAssemblyRecipeBuilder addOutput(ItemStack item, float weight) {
        recipe.resultPool.add(new ProcessingOutput(
    ...
    public void build(RecipeOutput consumer) {
        ...
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(
                ...
                AllRecipeTypes.SEQUENCED_ASSEMBLY.getId().getPath() + "/"
                        + holder.id().getPath());
