...
public abstract class ProcessingRecipe<I extends RecipeInput, P extends ProcessingRecipeParams>
    ...
    public List<String> validate() {
        ...
        if (processingDuration > 0 && !canSpecifyDuration())
            errors.add("Recipe specified a duration. Durations have no impact on this type of"
                    + " recipe.");

        if (requiredHeat != HeatCondition.NONE && !canRequireHeat())
            errors.add("Recipe specified a heat condition. Heat conditions have no impact on this"
                    + " type of recipe.");
    ...
    public List<ItemStack> rollResults(
        ...
        for (int i = 0; i < rollableResults.size(); i++) {
            ...
            ItemStack stack = i == 0 && forcedResult != null
                    ? forcedResult.get()
    ...
    public static <P extends ProcessingRecipeParams, R extends ProcessingRecipe<?, P>>
            MapCodec<R> codec(Factory<P, R> factory, MapCodec<P> paramsCodec) {
