...
public class PackageFilterMenu extends AbstractFilterMenu {
    ...
    protected void saveData(ItemStack filterItem) {
        ...
        if (address.isBlank()) filterItem.remove(AllDataComponents.PACKAGE_ADDRESS);
        else filterItem.set(AllDataComponents.PACKAGE_ADDRESS, address);
    }
