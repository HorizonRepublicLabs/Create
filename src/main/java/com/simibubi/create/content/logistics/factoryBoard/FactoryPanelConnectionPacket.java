...
public class FactoryPanelConnectionPacket
    ...
    public static final StreamCodec<ByteBuf, FactoryPanelConnectionPacket> STREAM_CODEC =
            StreamCodec.composite(
                    FactoryPanelPosition.STREAM_CODEC,
                    packet -> packet.fromPos,
                    FactoryPanelPosition.STREAM_CODEC,
                    packet -> packet.toPos,
                    ByteBufCodecs.BOOL,
                    packet -> packet.relocate,
    ...
    public FactoryPanelConnectionPacket(
    ...
    protected void applySettings(ServerPlayer player, FactoryPanelBlockEntity be) {
        ...
        if (behaviour != null)
            if (relocate) behaviour.moveTo(fromPos, player);
            else behaviour.addConnection(fromPos);
    }
