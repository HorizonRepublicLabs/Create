...
public class AttributeFilterMenu extends AbstractFilterMenu {
    ...
    protected void init(Inventory inv, ItemStack contentHolder) {
        ...
        stack.set(
                ...
                Component.literal("Selected Tags")
    ...
    public boolean canDragTo(Slot slotIn) {
        if (slotIn.index == 37) return false;
    ...
    public ItemStack quickMoveStack(Player playerIn, int index) {
        if (index == 37) return ItemStack.EMPTY;
        if (index == 36) {
    ...
    protected void initAndReadInventory(ItemStack filterItem) {
        ...
        List<ItemAttribute.ItemAttributeEntry> attributes = filterItem.getOrDefault(
