...
public record FluidContentsAttribute(@Nullable Fluid fluid) implements ItemAttribute {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, FluidContentsAttribute> STREAM_CODEC =
            CatnipStreamCodecBuilders.nullable(CatnipStreamCodecs.FLUID)
    ...
    public Object[] getTranslationParameters() {
        String parameter = "";
        if (fluid != null) parameter = fluid.getFluidType().getDescription().getString();
