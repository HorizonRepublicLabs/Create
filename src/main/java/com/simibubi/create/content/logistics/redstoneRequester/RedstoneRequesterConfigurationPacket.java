...
public class RedstoneRequesterConfigurationPacket
    ...
    public static final StreamCodec<ByteBuf, RedstoneRequesterConfigurationPacket> STREAM_CODEC =
    ...
    public RedstoneRequesterConfigurationPacket(
