    ...
    protected void renderSafe(
        ...
        if (blockEntity.isShop()) {
            CachedBuffers.partial(
                            blockEntity.sideOccluded
                                    ? AllPartialModels.TABLE_CLOTH_PRICE_TOP
                                    : AllPartialModels.TABLE_CLOTH_PRICE_SIDE,
        ...
        for (int i = 0; i < stacks.size(); i++) {
            ...
            BakedModel bakedModel =
                    Minecraft.getInstance().getItemRenderer().getModel(entry, null, null, 0);
