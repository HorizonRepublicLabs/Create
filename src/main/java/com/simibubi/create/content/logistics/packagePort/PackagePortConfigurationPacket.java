...
public class PackagePortConfigurationPacket
    ...
    public static final StreamCodec<ByteBuf, PackagePortConfigurationPacket> STREAM_CODEC =
    ...
    protected void applySettings(ServerPlayer player, PackagePortBlockEntity be) {
        if (be.addressFilter.equals(newFilter) && be.acceptsPackages == acceptPackages) return;
