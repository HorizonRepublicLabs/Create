...
public class ListFilterItem extends FilterItem {
    ...
    public List<Component> makeSummary(ItemStack filter) {
        ...
        list.add((blacklist
                        ? CreateLang.translateDirect("gui.filter.deny_list")
                        : CreateLang.translateDirect("gui.filter.allow_list"))
    ...
    public ItemStackHandler getFilterItemHandler(ItemStack stack) {
        ...
        ItemContainerContents contents =
                stack.getOrDefault(AllDataComponents.FILTER_ITEMS, ItemContainerContents.EMPTY);
