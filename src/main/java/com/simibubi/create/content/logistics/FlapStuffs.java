...
public class FlapStuffs {
    ...
    public static float flapAngle(float flapness, int segment) {
        ...
        if (flapness < 0) flapAngle *= .5f;
        return flapAngle;
    }

    public static Matrix4f commonTransform(
            BlockPos visualPosition, Direction side, float baseZOffset) {
    ...
    public static class Visual {
        ...
        public Visual(
                ...
                Matrix4fc commonTransform,
                Vec3 pivot,
                Model flapModel) {
            this.pivot = pivot;
            this.commonTransform
                    .set(commonTransform)
            ...
            instancerProvider
                    .instancer(InstanceTypes.TRANSFORMED, flapModel)
