...
public class FilterScreen extends AbstractFilterScreen<FilterMenu> {
    ...
    private final Component allowDESC =
            CreateLang.translateDirect(PREFIX + "allow_list.description");
    ...
    private final Component respectDataDESC =
            CreateLang.translateDirect(PREFIX + "respect_data.description");
    private final Component ignoreDataN = CreateLang.translateDirect(PREFIX + "ignore_data");
    private final Component ignoreDataDESC =
            CreateLang.translateDirect(PREFIX + "ignore_data.description");
    ...
    protected boolean isButtonEnabled(IconButton button) {
        if (button == blacklist) return !menu.blacklist;
        if (button == whitelist) return menu.blacklist;
        if (button == respectNBT) return !menu.respectNBT;
