...
public abstract class AbstractStationScreen extends AbstractSimiScreen {
    ...
    private void renderAdditional(
        ...
        msr.pushPose()
                .translate(
                        guiLeft + background.getWidth() + 4,
                        guiTop + background.getHeight() + 4,
                        100)
                .scale(40)
                .rotateXDegrees(-22)
                .rotateYDegrees(63);
        ...
        if (blockEntity.resolveFlagAngle()) {
            ...
            GuiGameElement.of(getFlag(partialTicks)).render(graphics);
        }
    ...
    protected Train getImminent() {
        return blockEntity.imminentTrain == null
                ? null
                : CreateClient.RAILWAYS.trains.get(blockEntity.imminentTrain);
    }
