...
public class TrainHatInfoReloadListener {
    ...
    public static final ResourceManagerReloadListener LISTENER =
            TrainHatInfoReloadListener::registerOffsetOverrides;
    ...
    private static void registerOffsetOverrides(ResourceManager manager) {
        ...
        converter.listMatchingResources(manager).forEach((location, resource) -> {
            ...
            ResourceLocation entityName = ResourceLocation.fromNamespaceAndPath(
                    location.getNamespace(), splitPath[splitPath.length - 1].replace(".json", ""));
    ...
    public static TrainHatInfo getHatInfoFor(Entity entity) {
        // Manual override for snow golems, they are a special case when they have a pumpkin on
        // their
        // head
