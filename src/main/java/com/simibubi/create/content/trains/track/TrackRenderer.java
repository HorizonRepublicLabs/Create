...
public class TrackRenderer extends SafeBlockEntityRenderer<TrackBlockEntity> {
    ...
    public static void renderBezierTurn(
        ...
        for (int i = 1; i < segment.length; i++) {
            int light =
                    LevelRenderer.getLightColor(level, segment.lightPosition[i].offset(bePosition));
    ...
    private static void renderGirder(
        ...
        for (int i = 1; i < segment.length; i++) {
            int light =
                    LevelRenderer.getLightColor(level, segment.lightPosition[i].offset(tePosition));
