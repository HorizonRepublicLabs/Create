...
public class TrackMaterial {
    ...
    public static final TrackMaterial ANDESITE = make(Create.asResource("andesite"))
            ...
            .particle(
                    Create.asResource("block/palettes/stone_types/polished/andesite_cut_polished"))
            .defaultModels()
            .build();
    ...
    public TrackMaterial(
            ...
            Ingredient railsIngredient,
            TrackType trackType,
            Supplier<Supplier<TrackModelHolder>> modelHolder) {
        this(
                id,
                langName,
                trackBlock,
    ...
    public static class TrackType {
        ...
        public static final TrackType STANDARD =
                new TrackType(Create.asResource("standard"), TrackBlock::new);
    ...
    @OnlyIn(Dist.CLIENT)
    public record TrackModelHolder(
            PartialModel tie, PartialModel leftSegment, PartialModel rightSegment) {
        static final TrackModelHolder DEFAULT = new TrackModelHolder(
