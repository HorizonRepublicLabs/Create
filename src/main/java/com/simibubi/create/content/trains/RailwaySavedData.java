...
public class RailwaySavedData extends SavedData {
    ...
    public CompoundTag save(CompoundTag nbt, HolderLookup.Provider registries) {
        ...
        nbt.put(
                ...
                NBTHelper.writeCompoundList(
                        railways.trackNetworks.values(), tg -> tg.write(registries, dimensions)));
        nbt.put(
                "SignalBlocks",
        ...
        nbt.put(
                "Trains",
                NBTHelper.writeCompoundList(
                        railways.trains.values(), t -> t.write(dimensions, registries)));
    ...
    public static RailwaySavedData load(MinecraftServer server) {
        return server.overworld().getDataStorage().computeIfAbsent(factory(), "create_tracks");
    }
}
