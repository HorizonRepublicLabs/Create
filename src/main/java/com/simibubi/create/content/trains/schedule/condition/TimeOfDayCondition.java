...
public class TimeOfDayCondition extends ScheduleWaitCondition {
    ...
    public boolean tickCompletion(Level level, Train train, CompoundTag context) {
        ...
        int targetTicks =
                (int) ((((targetHour + 18) % 24) * 1000 + Math.ceil(targetMinute / 60f * 1000))
                        % getRotation());
    ...
    public MutableComponent getDigitalDisplay(int hour, int minute, boolean doubleDigitHrs) {
        ...
        return CreateLang.translateDirect(
                "schedule.condition.time_of_day.digital_format",
                hr12,
                hr24,
                twoDigits(minute),
                hour > 11
                        ? CreateLang.translateDirect("generic.daytime.pm")
                        : CreateLang.translateDirect("generic.daytime.am"));
    }
    ...
    public boolean renderSpecialIcon(GuiGraphics graphics, int x, int y) {
        ...
        ResourceLocation location = ResourceLocation.withDefaultNamespace("textures/item/clock_"
    ...
    public void initConfigurationWidgets(ModularGuiLineBuilder builder) {
        ...
        hourInput
                ...
                .calling(t -> {
                    data.putInt("Hour", t);
                    timeLabel.getValue().text =
                            getDigitalDisplay(t, minuteInput.getValue().getState(), true);
                })
                .writingTo(null)
                .withShiftStep(6);
        ...
        minuteInput
                ...
                .calling(t -> {
                    ...
                    timeLabel.getValue().text =
                            getDigitalDisplay(hourInput.getValue().getState(), t, true);
                })
                .writingTo(null)
                .withShiftStep(15);
        ...
        hourInput.getValue().setState(intData("Hour"));
        minuteInput.getValue().setState(intData("Minute")).onChanged();
