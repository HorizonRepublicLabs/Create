...
public class StandardBogeyRenderer implements BogeyRenderer {
    ...
    public void render(
        ...
        SuperByteBuffer shaft = CachedBuffers.block(
    ...
    public static class Small extends StandardBogeyRenderer {
        ...
        public void render(
            ...
            SuperByteBuffer wheels = CachedBuffers.partial(
                    AllPartialModels.SMALL_BOGEY_WHEELS, Blocks.AIR.defaultBlockState());
    ...
    public static class Large extends StandardBogeyRenderer {
        ...
        public void render(
            ...
            SuperByteBuffer secondaryShaft = CachedBuffers.block(
            ...
            float spriteSize = AllSpriteShifts.BOGEY_BELT.getTarget().getV1()
                    - AllSpriteShifts.BOGEY_BELT.getTarget().getV0();
            ...
            CachedBuffers.partial(
                            AllPartialModels.LARGE_BOGEY_WHEELS, Blocks.AIR.defaultBlockState())
                    .translate(0, 1, 0)
                    .rotateXDegrees(wheelAngle)
                    .light(light)
                    .overlay(overlay)
