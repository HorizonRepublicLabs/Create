...
public class CarriageCouplingRenderer {
    ...
    public static void renderAll(PoseStack ms, MultiBufferSource buffer, Vec3 camera) {
        ...
        for (Train train : trains) {
            ...
            for (int i = 0; i < carriages.size() - 1; i++) {
                ...
                CarriageContraptionEntity entity2 =
                        carriage.getDimensional(level).entity.get();
...

                {
                    ...
                    float margin = 3 / 16f;
                    double couplingDistance = train.carriageSpacing.get(i)
                            - 2 * margin
                    ...
                    double stretch =
                            ((anchor2.distanceTo(anchor) - 2 * margin) * 4) / couplingSegments;
    ...
    public static int getPackedLightCoords(Entity pEntity, float pPartialTicks) {
        ...
        return LightTexture.pack(
                getBlockLightLevel(pEntity, blockpos), getSkyLightLevel(pEntity, blockpos));
    }
