...
public class SignalVisual extends AbstractBlockEntityVisual<SignalBlockEntity>
    ...
    public SignalVisual(
            VisualizationContext ctx, SignalBlockEntity blockEntity, float partialTick) {
        ...
        signalOverlay = ctx.instancerProvider()
                .instancer(
                        ...
                        Models.partial(AllPartialModels.TRACK_SIGNAL_OVERLAY))
                .createInstance();
    ...
    private void setupVisual() {
        {
            ...
            if (isRedLight != previousIsRedLight) {
                PartialModel partial =
                        isRedLight ? AllPartialModels.SIGNAL_ON : AllPartialModels.SIGNAL_OFF;
                instancerProvider()
            ...
            if (isRedLight) signalLight.light(LightTexture.FULL_BLOCK);
...

        {
            ...
            if (overlayState != previousOverlayState) {
                ...
                trackBlock.prepareTrackOverlay(
                        signalOverlay,
                        level,
                        targetPosition,
                        trackState,
