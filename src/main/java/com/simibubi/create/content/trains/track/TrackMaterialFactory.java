...
public class TrackMaterialFactory {
    ...
    public static TrackMaterialFactory make(
            ResourceLocation id) { // Convenience function for static import
    ...
    public TrackMaterialFactory block(
            NonNullSupplier<NonNullSupplier<? extends TrackBlock>> trackBlock) {
    ...
    public TrackMaterialFactory standardModels() { // was defaultModels
        CatnipServices.PLATFORM.executeOnClientOnly(() -> () -> {
            ...
            tieModel = PartialModel.of(
                    ResourceLocation.fromNamespaceAndPath(namespace, prefix + "tie"));
            leftSegmentModel = PartialModel.of(
                    ResourceLocation.fromNamespaceAndPath(namespace, prefix + "segment_left"));
            rightSegmentModel = PartialModel.of(
                    ResourceLocation.fromNamespaceAndPath(namespace, prefix + "segment_right"));
        });
        return this;
    }

    public TrackMaterialFactory customModels(
            Supplier<Supplier<PartialModel>> tieModel,
            Supplier<Supplier<PartialModel>> leftSegmentModel,
            Supplier<Supplier<PartialModel>> rightSegmentModel) {
        CatnipServices.PLATFORM.executeOnClientOnly(() -> () -> {
    ...
    public TrackMaterialFactory customBlockFactory(
            TrackMaterial.TrackType.TrackBlockFactory factory) {
    ...
    public TrackMaterial build() {
        ...
        CatnipServices.PLATFORM.executeOnClientOnly(() -> () -> {
            ...
            if (tieModel != null || leftSegmentModel != null || rightSegmentModel != null) {
                ...
                modelHolder = new TrackMaterial.TrackModelHolder(
                        tieModel, leftSegmentModel, rightSegmentModel);
            }
        });
        return new TrackMaterial(
                id,
                langName,
                trackBlock,
                particle,
