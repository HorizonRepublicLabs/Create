...
public class CurvedTrackInteraction {
    ...
    public static void clientTick() {
        ...
        if (mc.options.keyAttack.isDown() && result != null) {
            ...
            breakTimeout = 2;
            breakProgress +=
                    creative ? 0.125f : blockState.getDestroyProgress(player, level, breakPos) / 8f;
            ...
            if (breakProgress >= 1) {
                CatnipServices.NETWORK.sendToServer(new CurvedTrackDestroyPacket(
                        breakPos,
