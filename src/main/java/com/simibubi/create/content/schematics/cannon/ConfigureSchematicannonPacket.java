...
public record ConfigureSchematicannonPacket(Option option, boolean set)
        implements ServerboundPacketPayload {
    public static final StreamCodec<ByteBuf, ConfigureSchematicannonPacket> STREAM_CODEC =
    ...
    public void handle(ServerPlayer player) {
        if (player == null || !(player.containerMenu instanceof SchematicannonMenu)) return;
