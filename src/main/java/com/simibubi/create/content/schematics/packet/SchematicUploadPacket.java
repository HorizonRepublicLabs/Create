...
public record SchematicUploadPacket(int code, long size, String schematic, byte[] data)
        implements ServerboundPacketPayload {
    public static final int BEGIN = 0;
    public static final int WRITE = 1;
    public static final int FINISH = 2;

    public static final StreamCodec<ByteBuf, SchematicUploadPacket> STREAM_CODEC =
