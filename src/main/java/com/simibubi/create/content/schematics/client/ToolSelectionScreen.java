...
public class ToolSelectionScreen extends Screen {
    ...
    public final String scrollToCycle =
            CreateLang.translateDirect("gui.toolmenu.cycle").getString();
    ...
    private void draw(GuiGraphics graphics, float partialTicks) {
        ...
        if (tools.size() > 1) {
            ...
            if (!focused)
                ...
                graphics.drawCenteredString(
                        minecraft.font, scrollToCycle, width / 2, y - 10, 0xCCDDFF);
        } else {
            x += 65;
        }
