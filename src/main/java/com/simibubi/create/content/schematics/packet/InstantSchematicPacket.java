...
public record InstantSchematicPacket(String name, BlockPos origin, BlockPos bounds)
        implements ServerboundPacketPayload {
    public static final StreamCodec<ByteBuf, InstantSchematicPacket> STREAM_CODEC =
    ...
    public void handle(ServerPlayer player) {
        Create.SCHEMATIC_RECEIVER.handleInstantSchematic(
                player, name, player.level(), origin, bounds);
    }
}
