...
public class SchematicPromptScreen extends AbstractSimiScreen {
    ...
    protected void renderWindow(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        GuiGameElement.of(AllItems.SCHEMATIC.asStack()).at(x + 22, y + 24, 0).render(graphics);
    ...
    private void confirm(boolean convertImmediately) {
        CreateClient.SCHEMATIC_AND_QUILL_HANDLER.saveSchematic(
                nameField.getValue(), convertImmediately);
        onClose();
    }
}
