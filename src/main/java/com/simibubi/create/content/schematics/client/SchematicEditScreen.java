...
public class SchematicEditScreen extends AbstractSimiScreen {
    ...
    protected void init() {
        ...
        rotationArea = new SelectionScrollInput(x + 45, y + 43, 118, 18)
                .forOptions(rotationOptions)
        ...
        mirrorArea = new SelectionScrollInput(x + 45, y + 65, 118, 18)
                .forOptions(mirrorOptions)
    ...
    protected void renderWindow(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        GuiGameElement.of(AllItems.SCHEMATIC.asStack())
                .<GuiGameElement.GuiRenderBuilder>at(
                        x + background.getWidth() + 6, y + background.getHeight() - 40, -200)
                .scale(3)
                .render(graphics);
    }
