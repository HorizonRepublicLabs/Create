...
public class CustomRotationParticle extends SimpleAnimatedParticle {
    ...
    public CustomRotationParticle(
            ClientLevel worldIn, double x, double y, double z, SpriteSet spriteSet, float yAccel) {
    ...
    public void render(VertexConsumer builder, Camera camera, float partialTicks) {
        ...
        float minV = getV0();
        float maxV = getV1();
        int brightness = ShadersModHelper.isShaderPackInUse()
                ? LightTexture.pack(12, 15)
