...
public class WorldshaperRenderHandler {
    ...
    public static void tick() {
        ...
        if (renderedPositions == null) return;
    ...
    public static void createBrushOutline(LocalPlayer player, ItemStack zapper) {
        ...
        Brush brush = zapper.getOrDefault(AllDataComponents.SHAPER_BRUSH, TerrainBrushes.Cuboid)
                .get();
        ...
        renderedPositions = () -> brush.addToGlobalPositions(
                player.level(), pos, raytrace.getDirection(), new ArrayList<>(), tool);
    }
}
