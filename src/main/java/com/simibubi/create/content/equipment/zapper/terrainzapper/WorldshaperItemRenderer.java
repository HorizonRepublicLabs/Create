...
public class WorldshaperItemRenderer extends ZapperItemRenderer {
    ...
    protected static final PartialModel CORE =
            PartialModel.of(Create.asResource("item/handheld_worldshaper/core"));
    protected static final PartialModel CORE_GLOW =
            PartialModel.of(Create.asResource("item/handheld_worldshaper/core_glow"));
    protected static final PartialModel ACCELERATOR =
            PartialModel.of(Create.asResource("item/handheld_worldshaper/accelerator"));
