...
public class ExtendoGripRenderHandler {
    ...
    public static void tick() {
        ...
        if (!AllItems.EXTENDO_GRIP.isIn(getRenderedOffHandStack())) return;
    ...
    public static void onRenderPlayerHand(RenderHandEvent event) {
        ...
        if (notInOffhand && !AllItems.EXTENDO_GRIP.isIn(heldItem)) return;
        ...
        if (event.getHand() == InteractionHand.MAIN_HAND) {
            ...
            ms.translate(
                    flip * (0.64000005F - .1f), -0.4F + equipProgress * -0.6F, -0.71999997F + .3f);
            ...
            ItemDisplayContext transform = rightHand
            ...
            if (!notInOffhand) {
                ClientHooks.handleCameraTransforms(
                        ms,
                        mc.getItemRenderer().getModel(offhandItem, null, null, 0),
                        transform,
                        !rightHand);
