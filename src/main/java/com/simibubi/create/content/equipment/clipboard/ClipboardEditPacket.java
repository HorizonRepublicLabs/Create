...
public record ClipboardEditPacket(
        int hotbarSlot,
        @Nullable ClipboardContent clipboardContent,
        @Nullable BlockPos targetedBlock)
        implements ServerboundPacketPayload {
    public static final StreamCodec<RegistryFriendlyByteBuf, ClipboardEditPacket> STREAM_CODEC =
    ...
    public void handle(ServerPlayer sender) {
        ...
        ItemStack itemStack = sender.getInventory().getItem(hotbarSlot);
