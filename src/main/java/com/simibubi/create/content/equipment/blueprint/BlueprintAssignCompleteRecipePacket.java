...
public record BlueprintAssignCompleteRecipePacket(ResourceLocation recipeId)
        implements ServerboundPacketPayload {
    public static final StreamCodec<
                    ByteBuf,
                    com.simibubi.create.content.equipment.blueprint
                            .BlueprintAssignCompleteRecipePacket>
            STREAM_CODEC = ResourceLocation.STREAM_CODEC.map(
                    com.simibubi.create.content.equipment.blueprint
        ...
        if (player.containerMenu instanceof BlueprintMenu c) {
            player.level()
                    ...
                    .ifPresent(r -> BlueprintItem.assignCompleteRecipe(
                            c.player.level(), c.ghostInventory, r.value()));
        }
    }
