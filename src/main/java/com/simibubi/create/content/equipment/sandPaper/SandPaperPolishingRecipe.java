...
public class SandPaperPolishingRecipe extends StandardProcessingRecipe<SingleRecipeInput> {
    ...
    public static ItemStack applyPolish(
            Level world, Vec3 position, ItemStack stack, ItemStack sandPaperStack) {
        List<RecipeHolder<Recipe<SingleRecipeInput>>> matchingRecipes =
                getMatchingRecipes(world, stack);
    ...
    public static List<RecipeHolder<Recipe<SingleRecipeInput>>> getMatchingRecipes(
