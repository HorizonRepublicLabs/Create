...
public class BlueprintRenderer extends EntityRenderer<BlueprintEntity> {
    ...
    public void render(
        ...
        PartialModel partialModel = entity.size == 3
                ? AllPartialModels.CRAFTING_BLUEPRINT_3x3
                : entity.size == 2
                        ? AllPartialModels.CRAFTING_BLUEPRINT_2x2
                        : AllPartialModels.CRAFTING_BLUEPRINT_1x1;
        ...
        sbb.rotateYDegrees(-yaw)
                ...
                .translate(-.5, -1 / 32f, -.5);
        if (entity.size == 2) sbb.translate(.5, 0, -.5);
        ...
        if (entity.getXRot() == -90) fakeNormalXRotation = -45;
        ...
        if (entity.size == 3) ms.translate(-1, -1, 0);
