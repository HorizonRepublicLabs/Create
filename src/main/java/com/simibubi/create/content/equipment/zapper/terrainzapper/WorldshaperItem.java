...
public class WorldshaperItem extends ZapperItem {
    ...
    protected boolean activate(
        ...
        Brush brush = stack.getOrDefault(AllDataComponents.SHAPER_BRUSH, TerrainBrushes.Cuboid)
                .get();
    ...
    public static void configureSettings(
        ...
        stack.set(
                AllDataComponents.SHAPER_BRUSH_PARAMS,
                new BlockPos(brushParamX, brushParamY, brushParamZ));
