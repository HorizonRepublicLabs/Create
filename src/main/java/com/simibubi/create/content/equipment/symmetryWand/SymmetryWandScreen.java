...
public class SymmetryWandScreen extends AbstractSimiScreen {
    ...
    public void init() {
        ...
        labelType = new Label(x + 51, y + 28, CommonComponents.EMPTY)
                .colored(0xFFFFFFFF)
                .withShadow();
        labelAlign = new Label(x + 51, y + 50, CommonComponents.EMPTY)
                .colored(0xFFFFFFFF)
                .withShadow();

        int state = currentElement instanceof TriplePlaneMirror
                ? 2
                : currentElement instanceof CrossPlaneMirror ? 1 : 0;
        areaType = new SelectionScrollInput(x + 45, y + 21, 109, 18)
    ...
    private void initAlign(SymmetryMirror element, int x, int y) {
        ...
        areaAlign = new SelectionScrollInput(x + 45, y + 43, 109, 18)
