...
public class ExtendoGripItemRenderer extends CustomRenderedItemModelRenderer {
    ...
    protected static final PartialModel COG =
            PartialModel.of(Create.asResource("item/extendo_grip/cog"));
    protected static final PartialModel THIN_SHORT =
            PartialModel.of(Create.asResource("item/extendo_grip/thin_short"));
    protected static final PartialModel WIDE_SHORT =
            PartialModel.of(Create.asResource("item/extendo_grip/wide_short"));
    protected static final PartialModel THIN_LONG =
            PartialModel.of(Create.asResource("item/extendo_grip/thin_long"));
    protected static final PartialModel WIDE_LONG =
            PartialModel.of(Create.asResource("item/extendo_grip/wide_long"));
    ...
    protected void render(
        ...
        ms.pushPose();
        stacker.rotateXDegrees(-halfAngle).translate(ROTATION_OFFSET);
        renderer.renderSolid(THIN_SHORT.get(), light);
        stacker.translateBack(ROTATION_OFFSET);

        ms.translate(0, 5.5f / 16f, 0);
        stacker.rotateXDegrees(-oppositeAngle).translate(ROTATION_OFFSET);
        ...
        stacker.rotateXDegrees(-180 + halfAngle).translate(ROTATION_OFFSET);
        ...
        // hand
        ms.translate(0, 5.5f / 16f, 0);
        stacker.rotateXDegrees(180 - halfAngle).rotateYDegrees(180);
        ms.translate(0, 0, -4 / 16f);
        ms.scale(1, 1, 1 / (1 + animation));
        renderer.renderSolid(
                (leftHand || rightHand)
                        ? ExtendoGripRenderHandler.pose.get()
                        : AllPartialModels.DEPLOYER_HAND_POINTING.get(),
                light);
        ms.popPose();
        ...
        if (leftHand || rightHand) angle += 360 * animation;
        angle %= 360;
