...
public class DynamicTree extends AbstractBlockBreakQueue {
    ...
    public void destroyBlocks(
        ...
        //			start = setBranchToShellMuse(world, world.getBlockState(startCutPos)); //we check for a
        // trunk shell instead
        //
        //		if (start == null) //if it is null again, it was neither a branch nor a trunk shell and
        // thus
        // we return
        //			return;
        //
        ...
        //		BranchDestructionData data = start.destroyBranchFromNode(world, startCutPos,
        // Direction.DOWN,
        // false, playerEntity);
        //
        //		// Feed all the tree drops to drop bi-consumer
        //		data.leavesDrops.forEach(stackPos -> drop.accept(stackPos.pos.offset(startCutPos),
        // stackPos.stack));
        //		start.getFamily().getCommonSpecies().getBranchesDrops(world,
        // data.woodVolume).forEach(stack
