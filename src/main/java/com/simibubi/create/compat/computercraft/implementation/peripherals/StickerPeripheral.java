...
public class StickerPeripheral extends SyncedPeripheral<StickerBlockEntity> {
    ...
    public boolean extend() {
        ...
        if (!AllBlocks.STICKER.has(state) || state.getValue(StickerBlock.EXTENDED)) return false;
        blockEntity
                .getLevel()
                .setBlock(
                        blockEntity.getBlockPos(),
                        state.setValue(StickerBlock.EXTENDED, true),
    ...
    public boolean retract() {
        ...
        blockEntity
                ...
                .setBlock(
                        blockEntity.getBlockPos(),
                        state.setValue(StickerBlock.EXTENDED, false),
                        Block.UPDATE_CLIENTS);
        return true;
    }
    ...
    public boolean toggle() {
        BlockState state = blockEntity.getBlockState();
        if (!AllBlocks.STICKER.has(state)) return false;
