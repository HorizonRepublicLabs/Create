...
public class DisplayScenes {
    ...
    public static void link(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showControls(target, Pointing.RIGHT, 60)
        ...
        scene.overlay()
                .showControls(util.vector().topOf(linkPos), Pointing.DOWN, 60)
                .rightClick();
        scene.idle(20);
        scene.overlay()
                .showText(80)
        ...
        scene.world().flashDisplayLink(linkPos);
        scene.idle(5);
        ElementLink<WorldSectionElement> dirtElement =
                scene.world().showIndependentSection(dirt, Direction.SOUTH);
        scene.world().moveSection(dirtElement, util.vector().of(0, -4, 0), 0);

        scene.idle(25);
        scene.overlay()
                .showOutlineWithText(depot, 50)
        ...
        ElementLink<WorldSectionElement> stressElement =
                scene.world().showIndependentSection(stresso, Direction.SOUTH);
        ...
        scene.world()
                .setDisplayBoardText(
                        board,
                        1,
                        Component.literal(1024 + " ")
                                .append(CreateLang.translateDirect("generic.unit.stress")));
        scene.world().flashDisplayLink(linkPos);
        scene.idle(40);
        scene.world().hideIndependentSection(stressElement, Direction.SOUTH);
        scene.idle(10);

        ElementLink<WorldSectionElement> chestElement =
                scene.world().showIndependentSection(content, Direction.SOUTH);
        ...
        scene.world()
                .setDisplayBoardText(
                        board,
                        1,
                        Component.literal(418 + " ")
                                .append(new ItemStack(Items.DEEPSLATE).getHoverName()));
        scene.world()
                .setDisplayBoardText(
                        board,
                        2,
                        Component.literal(14 + " ")
                                .append(AllBlocks.COGWHEEL.asStack().getHoverName()));
        scene.world().flashDisplayLink(linkPos);
        scene.idle(40);
        ...
        ElementLink<WorldSectionElement> cuckooElement =
                scene.world().showIndependentSection(cuckoo, Direction.SOUTH);
        ...
        scene.world()
                .setDisplayBoardText(
                        board,
                        1,
                        Component.literal("6:00 ")
                                .append(CreateLang.translateDirect("generic.daytime.pm")));
        ...
        ElementLink<WorldSectionElement> signElement =
                scene.world().showIndependentSection(sign, Direction.SOUTH);
        ...
        ElementLink<WorldSectionElement> lecternElement =
                scene.world().showIndependentSection(lectern, Direction.SOUTH);
        ...
        ElementLink<WorldSectionElement> nixieElement =
                scene.world().showIndependentSection(nixies, Direction.SOUTH);
    ...
    public static void board(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        clipboard.set(
                ...
                ClipboardContent.EMPTY.setType(ClipboardType.WRITTEN));
        scene.overlay()
                .showControls(target, Pointing.RIGHT, 40)
                .withItem(clipboard)
                .rightClick();
        scene.idle(6);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.INPUT, depot, new AABB(linkPos).contract(-.5f, 0, 0), 60);
        scene.idle(5);
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.OUTPUT,
        ...
        scene.overlay()
                .showControls(target, Pointing.RIGHT, 40)
                .withItem(new ItemStack(Items.PINK_DYE))
                .rightClick();
        scene.idle(6);
        ...
        scene.overlay()
                .showControls(target.add(0, -.5f, 0), Pointing.RIGHT, 40)
                .withItem(new ItemStack(Items.LIME_DYE))
                .rightClick();
        scene.idle(6);
    ...
    public static void redstone(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .setBlock(
                        util.grid().at(4, 1, 0), Blocks.REDSTONE_BLOCK.defaultBlockState(), false);
        scene.idle(10);
