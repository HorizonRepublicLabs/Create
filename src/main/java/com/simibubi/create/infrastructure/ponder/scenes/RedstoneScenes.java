...
public class RedstoneScenes {
    ...
    public static void sticker(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .showSection(
                        util.select().fromTo(2, 1, 2, 0, 2, 2).substract(stickerSelect),
                        Direction.DOWN);
        scene.idle(10);
        ElementLink<WorldSectionElement> sticker =
                scene.world().showIndependentSection(stickerSelect, Direction.DOWN);
        scene.idle(10);
    ...
    public static void contact(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink<WorldSectionElement> contact =
                scene.world().showIndependentSection(topContact, Direction.DOWN);
        scene.idle(10);
        scene.world().toggleRedstonePower(topContact);
        scene.world().toggleRedstonePower(contactAndRedstone);
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(2, 2, 2, 4, 2, 2), Direction.DOWN, contact);
        scene.idle(10);
    ...
    public static void pulseExtender(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world()
                .showSection(
                        util.select().layersFrom(1).substract(util.select().position(circuitPos)),
                        Direction.UP);
        scene.idle(10);
    ...
    public static void analogLever(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world()
                .showSection(
                        util.select().layersFrom(0).substract(lamp).substract(leverSelection),
                        Direction.UP);
        scene.idle(5);
    ...
    public static void nixieTube(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world()
                .showSection(
                        util.select().layer(0).add(util.select().fromTo(2, 1, 1, 2, 1, 2)),
                        Direction.UP);
        scene.idle(10);
        ...
        scene.world()
                .modifyBlock(
                        util.grid().at(2, 1, 2),
                        s -> s.setValue(RedStoneWireBlock.POWER, 11),
                        false);
        scene.world()
                .modifyBlockEntityNBT(
                        tubes,
        ...
        scene.overlay()
                .showControls(centerTube.add(1, .35, 0), Pointing.DOWN, 40)
                .rightClick()
                .withItem(clipboard);
        scene.idle(7);
        ...
        scene.special()
                .createBirb(
                        util.vector().topOf(util.grid().at(0, 0, 3)), ParrotPose.DancePose::new);
    ...
    public static void redstoneLink(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world()
                .showSection(
                        util.select().layer(0).add(util.select().fromTo(3, 1, 1, 2, 1, 1)),
                        Direction.UP);
        scene.idle(5);
        ...
        scene.overlay()
                .showControls(link3Vec, Pointing.UP, 40)
                .rightClick()
        ...
        scene.world()
                .modifyBlockEntityNBT(
                        ...
                        nbt -> nbt.put(
                                "FrequencyLast",
                                gold.saveOptional(scene.world().getHolderLookupProvider())));
        scene.idle(7);
        scene.world()
                .modifyBlockEntityNBT(
                        link3Select,
        ...
        scene.idle(30);
        for (int i = 0; i < 4; i++) {
            if (i % 2 == 1) scene.effects().indicateRedstone(leverPos);
            scene.world().toggleRedstonePower(redstone);
            scene.idle(2);
            scene.world().toggleRedstonePower(util.select().fromTo(1, 2, 2, 1, 2, 3));
            scene.idle(20);
