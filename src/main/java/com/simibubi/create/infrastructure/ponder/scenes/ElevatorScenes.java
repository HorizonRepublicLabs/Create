...
public class ElevatorScenes {
    ...
    public static void elevator(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection pole =
                util.select().fromTo(6, 0, 3, 6, 17, 3).add(util.select().position(5, 17, 3));
        ...
        ElementLink<WorldSectionElement> camLink =
                scene.world().showIndependentSection(topFloor, Direction.UP);
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(4, 14, 1, 4, 16, 1), Direction.DOWN, elevatorLink);
        scene.idle(2);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(2, 14, 1, 2, 16, 1), Direction.DOWN, elevatorLink);
        scene.idle(2);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(4, 14, 3, 4, 16, 3), Direction.DOWN, elevatorLink);
        scene.idle(2);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(2, 14, 3, 2, 16, 3), Direction.DOWN, elevatorLink);
        scene.idle(10);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(4, 17, 1, 2, 17, 3), Direction.DOWN, elevatorLink);
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().position(2, 14, 2), Direction.WEST, elevatorLink);
        scene.idle(2);
        scene.world()
                .showSectionAndMerge(util.select().position(1, 13, 2), Direction.EAST, camLink);
        scene.idle(15);
        ...
        scene.overlay()
                .showControls(util.vector().centerOf(4, 3, 1), Pointing.RIGHT, 60)
        ...
        scene.overlay()
                .showOutlineWithText(util.select().position(2, 1, 2), 80)
                .placeNearTarget()
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(3, 6, 2), Direction.NORTH),
                        Pointing.RIGHT,
                        60)
                .rightClick();
        scene.idle(7);
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(1, 1, 2), Direction.UP),
                        Pointing.DOWN,
                        60)
                .rightClick();
        scene.idle(7);
        scene.overlay()
                .showOutlineWithText(util.select().position(1, 1, 2), 60)
                .placeNearTarget()
        ...
        scene.idle(5);
        scene.world()
                .showSectionAndMerge(util.select().position(midContact), Direction.DOWN, camLink);
        scene.idle(10);
        ...
        scene.idle(1);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.WHITE, bb, bb.expandTowards(0, -6, 0), 90);
        scene.idle(10);
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(4, 2, 2), Direction.UP),
                        Pointing.DOWN,
                        60)
                .scroll();
        scene.idle(15);
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(doorPos, doorPos.above()),
                        Direction.DOWN,
                        elevatorLink);
        scene.idle(20);
        ...
        scene.idle(5);
        scene.world()
                .showSectionAndMerge(util.select().position(botContact), Direction.DOWN, camLink);
        scene.idle(10);
        scene.effects().indicateSuccess(util.grid().at(1, 2, 2));
        scene.world()
                .setBlock(
        ...
        scene.world()
                .setBlock(
                        nixiePos,
                        AllBlocks.NIXIE_TUBES
                                .get(DyeColor.GREEN)
                                .getDefaultState()
                                .setValue(NixieTubeBlock.FACING, Direction.WEST),
                        false);
        ...
        scene.idle(30);
        scene.world()
                .showSectionAndMerge(util.select().position(nixiePos), Direction.DOWN, camLink);
        scene.idle(15);
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(4, 1, 0), Direction.UP),
                        Pointing.DOWN,
                        15)
                .rightClick()
                        ...
                        util.select().position(nixiePos), NixieTubeBlockEntity.class, nbt -> {
                            ...
                            nbt.putString(
                                    ...
                                    Component.Serializer.toJson(
                                            component, scene.world().getHolderLookupProvider()));
                        });
        ...
        scene.overlay()
                ...
                .text("Display Links on any of the contacts can show the current floor of the"
                        + " elevator");
        scene.idle(90);
    ...
    public static void multiRope(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection mainPulley =
                util.select().fromTo(5, 0, 1, 5, 4, 1).add(util.select().fromTo(4, 4, 1, 3, 4, 1));
        ...
        ElementLink<WorldSectionElement> planksLink =
