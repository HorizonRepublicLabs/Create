...
public class TrainStationScenes {
    ...
    public static void assembly(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection train1 =
                util.select().fromTo(12, 2, 5, 8, 2, 7).substract(util.select().position(10, 2, 6));
        ...
        AABB bb = new AABB(util.vector().topOf(11, 0, 6), util.vector().topOf(11, 0, 6))
                .move(0, 2 / 16f, 0);

        scene.overlay()
                .showControls(marker, Pointing.DOWN, 40)
                .rightClick()
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, bb, bb.inflate(.45f, 1 / 16f, .45f), 100);
        scene.idle(10);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(11, 0, 6), Pointing.RIGHT, 80)
                .rightClick()
                .withItem(casing);
        scene.idle(6);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(4, 0, 6), Pointing.RIGHT, 15)
                .rightClick()
                .withItem(casing);
        scene.idle(6);
        scene.world()
                .setBlock(util.grid().at(3, 2, 6), AllBlocks.SMALL_BOGEY.getDefaultState(), false);
        ...
        scene.idle(20);
        scene.overlay()
                .showControls(util.vector().topOf(7, 0, 6), Pointing.RIGHT, 15)
                .rightClick()
                .withItem(casing);
        scene.idle(6);
        scene.world()
                .setBlock(util.grid().at(6, 2, 6), AllBlocks.SMALL_BOGEY.getDefaultState(), false);
        scene.world()
                .showSectionAndMerge(
                        util.select().position(6, 2, 6), Direction.DOWN, trainElement2);
        scene.idle(30);
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(6, 4, 5, 6, 3, 7), Direction.WEST, trainElement2);
        scene.idle(3);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(5, 3, 6, 4, 4, 7), Direction.NORTH, trainElement2);
        scene.idle(3);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(3, 3, 6, 3, 5, 6), Direction.DOWN, trainElement2);
        scene.idle(3);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(3, 5, 5, 3, 6, 5), Direction.SOUTH, trainElement2);
        scene.idle(3);
        scene.world()
                .showSectionAndMerge(
                        util.select().position(3, 3, 5), Direction.EAST, trainElement2);
        scene.idle(3);
        scene.world()
                .showSectionAndMerge(
                        util.select().position(5, 3, 5), Direction.SOUTH, trainElement2);
        scene.idle(10);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN,
                        glue2,
                        glue2.inflate(2, 0, 1).expandTowards(1, 3, 0),
                        60);
        scene.idle(5);
        ...
        scene.idle(15);
        scene.overlay()
                .showControls(util.vector().topOf(util.grid().at(4, 2, 6)), Pointing.UP, 40)
                .withItem(AllItems.SUPER_GLUE.asStack());
        scene.idle(5);
        scene.overlay()
                .showControls(util.vector().topOf(util.grid().at(10, 2, 6)), Pointing.UP, 40)
                .withItem(AllItems.SUPER_GLUE.asStack());
        scene.idle(55);

        scene.overlay()
                .showControls(util.vector().topOf(util.grid().at(5, 3, 5)), Pointing.DOWN, 40)
        ...
        scene.overlay()
                ...
                .attachKeyFrame()
                .colored(PonderPalette.BLUE)
                .text("Assembled Trains will move faster if they can find fuel in assembled"
                        + " chests or barrels");
        scene.idle(100);
        scene.overlay()
                .showOutlineWithText(util.select().fromTo(4, 3, 6, 5, 4, 7), 60)
        ...
        ElementLink<WorldSectionElement> controlsElement =
                scene.world().showIndependentSection(controls, Direction.DOWN);
        scene.idle(15);
        scene.overlay()
                .showText(60)
        ...
        ElementLink<ParrotElement> birb = scene.special()
                .createBirb(
                        util.vector().centerOf(10, 3, 6), ParrotPose.FacePointOfInterestPose::new);
        scene.idle(15);
        ...
        scene.overlay()
                .showControls(stationTop, Pointing.DOWN, 75)
                .rightClick()
        ...
        scene.idle(10);
        ElementLink<WorldSectionElement> trainElement3 =
                scene.world().showIndependentSection(train3, Direction.DOWN);
        scene.world().moveSection(trainElement3, util.vector().of(0, 0, 4), 0);
        scene.idle(15);

        Vec3 target = util.vector().topOf(util.grid().at(5, 3, 6));
        scene.overlay()
                .showControls(target, Pointing.DOWN, 75)
                .rightClick()
        ...
        scene.overlay()
                .showControls(util.vector().topOf(util.grid().at(6, 0, 2)), Pointing.DOWN, 15)
                .rightClick()
                .withItem(AllItems.WRENCH.asStack());
        scene.idle(15);
    ...
    public static void autoSchedule(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink<ParrotElement> birb =
                scene.special().createBirb(target, ParrotPose.FacePointOfInterestPose::new);
        scene.idle(10);
        ...
        scene.idle(70);
        scene.overlay()
                .showControls(target.add(0, 0.5, 0), Pointing.DOWN, 40)
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb, bb.inflate(.45f, 0, .45f), 40);
        scene.idle(15);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.OUTPUT, bb2, bb2.expandTowards(-4, 0, 0), 20);
        scene.idle(15);

        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.GREEN, bb, bb.inflate(.45f, 0, .45f), 25);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.GREEN, bb2, bb2.expandTowards(-4, 0, 0), 25);
        scene.idle(20);
        ...
        scene.overlay()
                .showText(80)
                .pointAt(util.vector().topOf(stationPos.north()).subtract(0, 14 / 16f, 0))
                .placeNearTarget()
                .attachKeyFrame()
        ...
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb2, bb2.move(4, 0, 0), 1);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb2, bb2.expandTowards(4, 0, 0), 20);
        scene.idle(15);

        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.RED, bb, bb.inflate(.45f, 0, .45f), 45);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.RED, bb2, bb2.expandTowards(4, 0, 0), 45);
        scene.idle(20);
        ...
        scene.overlay()
                .showText(70)
                .pointAt(util.vector().topOf(stationPos).add(-.5, 0, 0))
                .placeNearTarget()
                .attachKeyFrame()
        ...
        scene.world()
                .createItemOnBelt(
                        util.grid().at(11, 1, 3), Direction.DOWN, AllItems.SCHEDULE.asStack());
        scene.idle(10);
        scene.world().animateTrainStation(stationPos, true);
        scene.idle(10);
        scene.overlay()
                .showControls(util.vector().topOf(stationPos), Pointing.DOWN, 20)
                .withItem(AllItems.SCHEDULE.asStack());
        scene.idle(30);
        scene.effects().indicateSuccess(stationPos);
        scene.idle(10);
        ...
        scene.overlay()
                ...
                .placeNearTarget()
                .attachKeyFrame()
                .text("The Schedule placed on a station will automatically copy itself to"
                        + " present trains");
        scene.idle(90);
