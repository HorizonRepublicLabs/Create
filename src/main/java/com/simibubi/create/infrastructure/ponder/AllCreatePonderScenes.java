...
public class AllCreatePonderScenes {
    ...
    public static void register(PonderSceneRegistrationHelper<ResourceLocation> helper) {
        ...
        HELPER.forComponents(AllBlocks.COGWHEEL)
                .addStoryBoard(
                        "cog/small", KineticsScenes::cogAsRelay, AllCreatePonderTags.KINETIC_RELAYS)
        ...
        HELPER.forComponents(AllItems.BELT_CONNECTOR)
                .addStoryBoard(
                        "belt/connect",
                        BeltScenes::beltConnector,
                        AllCreatePonderTags.KINETIC_RELAYS)
                .addStoryBoard("belt/directions", BeltScenes::directions)
                .addStoryBoard(
                        "belt/transport", BeltScenes::transport, AllCreatePonderTags.LOGISTICS)
        ...
        HELPER.forComponents(AllBlocks.GEARBOX, AllItems.VERTICAL_GEARBOX)
                .addStoryBoard(
                        "gearbox", KineticsScenes::gearbox, AllCreatePonderTags.KINETIC_RELAYS);

        HELPER.addStoryBoard(
                AllBlocks.CLUTCH,
                "clutch",
                KineticsScenes::clutch,
                AllCreatePonderTags.KINETIC_RELAYS);
        HELPER.addStoryBoard(
                AllBlocks.GEARSHIFT,
                "gearshift",
        ...
        HELPER.addStoryBoard(
                AllBlocks.CRUSHING_WHEEL, "crushing_wheel", ProcessingScenes::crushingWheels);
        HELPER.addStoryBoard(
                AllBlocks.MECHANICAL_MIXER, "mechanical_mixer/mixing", ProcessingScenes::mixing);
        ...
        HELPER.forComponents(AllBlocks.CHUTE)
                .addStoryBoard(
                        "chute/downward", ChuteScenes::downward, AllCreatePonderTags.LOGISTICS)
        ...
        HELPER.forComponents(AllBlocks.LINEAR_CHASSIS, AllBlocks.SECONDARY_LINEAR_CHASSIS)
                .addStoryBoard(
                        "chassis/linear_group",
                        ChassisScenes::linearGroup,
        ...
        HELPER.forComponents(AllBlocks.RADIAL_CHASSIS)
                .addStoryBoard(
                        "chassis/radial",
                        ChassisScenes::radial,
                        AllCreatePonderTags.CONTRAPTION_ASSEMBLY);
        HELPER.forComponents(AllItems.SUPER_GLUE)
                .addStoryBoard(
                        "super_glue",
                        ChassisScenes::superGlue,
                        AllCreatePonderTags.CONTRAPTION_ASSEMBLY);
        HELPER.forComponents(AllBlocks.STICKER)
                .addStoryBoard(
                        "sticker",
                        RedstoneScenes::sticker,
                        AllCreatePonderTags.CONTRAPTION_ASSEMBLY);

        // Mechanical Arm
        HELPER.forComponents(AllBlocks.MECHANICAL_ARM)
                .addStoryBoard(
                        "mechanical_arm/setup", ArmScenes::setup, AllCreatePonderTags.ARM_TARGETS)
        ...
        HELPER.forComponents(AllBlocks.CART_ASSEMBLER)
                .addStoryBoard(
                        "cart_assembler/anchor",
                        CartAssemblerScenes::anchor,
                        AllCreatePonderTags.MOVEMENT_ANCHOR)
        ...
        HELPER.forComponents(AllBlocks.FLUID_TANK)
                .addStoryBoard(
                        "fluid_tank/storage", FluidTankScenes::storage, AllCreatePonderTags.FLUIDS)
        ...
        HELPER.forComponents(AllBlocks.PORTABLE_FLUID_INTERFACE)
                .addStoryBoard(
                        ...
                        AllCreatePonderTags.CONTRAPTION_ACTOR)
                .addStoryBoard(
                        "portable_interface/redstone_fluid", MovementActorScenes::psiRedstone);
        ...
        HELPER.forComponents(AllBlocks.STOCK_TICKER)
                ...
                .addStoryBoard(
                        "high_logistics/stock_ticker_address",
                        StockTickerScenes::stockTickerAddress);
        HELPER.forComponents(AllBlocks.REDSTONE_REQUESTER)
                .addStoryBoard(
                        "high_logistics/redstone_requester", RequesterAndShopScenes::requester);
        ...
        HELPER.forComponents(AllBlocks.FACTORY_GAUGE)
                .addStoryBoard(
                        "high_logistics/factory_gauge_restocker", FactoryGaugeScenes::restocker)
                .addStoryBoard("high_logistics/factory_gauge_recipe", FactoryGaugeScenes::recipe)
                .addStoryBoard(
                        "high_logistics/factory_gauge_crafting", FactoryGaugeScenes::crafting)
        ...
        HELPER.forComponents(TrackMaterial.allBlocks().stream()
                        .map((trackSupplier) -> new BlockEntry<TrackBlock>(
                                // note: these blocks probably WON'T be in the Create Registrate,
                                // but a simple
