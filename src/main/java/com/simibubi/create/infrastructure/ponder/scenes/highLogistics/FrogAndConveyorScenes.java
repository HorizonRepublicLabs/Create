...
public class FrogAndConveyorScenes {
    ...
    public static void conveyor(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink<WorldSectionElement> poleE =
                scene.world().showIndependentSection(pole, Direction.DOWN);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(conv1), Pointing.DOWN, 117)
                .rightClick()
                .withItem(chainItem);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(conv2), Pointing.DOWN, 100)
                .rightClick()
                .withItem(chainItem);
        ...
        scene.idle(15);
        ElementLink<WorldSectionElement> poleE2 =
                scene.world().showIndependentSection(pole, Direction.EAST);
        ...
        ChainConveyorParrotElement element = new ChainConveyorParrotElement(
                parrotStart, ParrotPose.FacePointOfInterestPose::new);
    ...
    private static void connection(
            SceneBuilder builder, BlockPos p1, BlockPos p2, boolean connect) {
        builder.world().modifyBlockEntity(p1, ChainConveyorBlockEntity.class, be -> {
            if (connect) be.connections.add(p2.subtract(p1));
            else be.connections.remove(p2.subtract(p1));
        });
        builder.world().modifyBlockEntity(p2, ChainConveyorBlockEntity.class, be -> {
            if (connect) be.connections.add(p1.subtract(p2));
            else be.connections.remove(p1.subtract(p2));
        });
    }
    ...
    public static class ChainConveyorParrotElement extends ParrotElementImpl {
        ...
        protected void renderLast(
            ...
            poseStack.mulPose(Axis.ZP.rotationDegrees(
                    Mth.sin((world.scene.getCurrentTime() + pt) * 0.2f) * 10));
            poseStack.translate(0, -1.5f, 0);
            ...
            entityrenderermanager.render(
                    entity, 0, 0, 0, 0, pt, poseStack, buffer, lightCoordsFromFade(fade));
            poseStack.popPose();
        }
    }
    ...
    public static void frogPort(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.WHITE, conv1, bb1.inflate(0.025, 0.025, 0.025), 50);
        scene.idle(26);
        ...
        ElementLink<WorldSectionElement> fromFrogE =
                scene.world().showIndependentSection(fromFrogS, Direction.DOWN);
        scene.world().moveSection(fromFrogE, util.vector().of(0, -1, 0), 0);

        scene.idle(15);
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, conv1, bb1.inflate(0.025, 0.025, 0.025), 50);
        ...
        scene.overlay()
                .showLine(
                        PonderPalette.GREEN, util.vector().topOf(fromFrog.below()), fromTarget, 40);
        scene.idle(45);

        scene.overlay()
                .showControls(util.vector().topOf(fromFrog.below()), Pointing.DOWN, 40)
                .rightClick();
        scene.idle(7);
        scene.overlay()
                .showOutlineWithText(util.select().position(fromFrog.below()), 70)
                .attachKeyFrame()
                .colored(PonderPalette.BLUE)
                .text("Assign it an address in the inventory UI")
                .pointAt(util.vector().topOf(fromFrog.below()))
                .placeNearTarget();
        scene.idle(80);

        scene.world().moveSection(fromFrogE, util.vector().of(0, 1, 0), 10);
        scene.idle(10);
        ElementLink<WorldSectionElement> casingE =
                scene.world().showIndependentSection(casing, Direction.NORTH);
        ...
        scene.overlay()
                ...
                .pointAt(util.vector().topOf(5, 0, 3))
                .placeNearTarget();
        ...
        scene.overlay()
                ...
                .colored(PonderPalette.BLUE)
                .text("Albert")
                .pointAt(util.vector().topOf(fromFrog))
                .placeNearTarget();
        scene.idle(5);
        scene.overlay()
                .showText(40)
                ...
                .text("\u2192 Peter")
                .pointAt(util.vector().centerOf(util.grid().at(5, 2, 0)))
                .placeNearTarget();
        ...
        scene.world()
                .modifyBlockEntity(
                        fromFrog, FrogportBlockEntity.class, be -> be.startAnimation(box, true));
        scene.idle(15);
        ...
        scene.overlay()
                ...
                .pointAt(util.vector().of(6.5, 4.25, 7.5))
                .placeNearTarget();
        scene.idle(60);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, conv3, bb3.inflate(0.025, 0.025, 0.025), 80);
        ...
        scene.overlay()
                ...
                .colored(PonderPalette.BLUE)
                .text("Peter")
                .pointAt(util.vector().topOf(toFrog))
                .placeNearTarget();
        scene.idle(30);

        scene.world()
                .modifyBlockEntity(
                        conv2, ChainConveyorBlockEntity.class, be -> boxTransfer(conv1, conv2, be));
        ...
        scene.world()
                .hideSection(
                        util.select().fromTo(0, 1, 6, 0, 1, 9).add(util.select().position(1, 1, 9)),
                        Direction.SOUTH);
        ...
        scene.overlay()
                ...
                .colored(PonderPalette.OUTPUT)
                .text("\u2192 Peter")
                .pointAt(util.vector().centerOf(util.grid().at(0, 2, 5)))
                .placeNearTarget();
        ...
        scene.world()
                .hideSection(
                        util.select()
                                .fromTo(5, 2, 1, 5, 1, 0)
                                .add(util.select().fromTo(6, 1, 0, 9, 1, 0)),
                        Direction.NORTH);
        ...
        scene.idle(15);
        ElementLink<WorldSectionElement> fromBarrelE =
                scene.world().showIndependentSection(fromBarrel, Direction.WEST);
        scene.world().moveSection(fromBarrelE, util.vector().of(0, 0, -1), 0);
        ElementLink<WorldSectionElement> toBarrelE =
                scene.world().showIndependentSection(toBarrel, Direction.WEST);
        scene.world().moveSection(toBarrelE, util.vector().of(-1, 0, 0), 0);
        scene.idle(20);

        scene.overlay()
                .showOutlineWithText(util.select().position(fromFrog.below()).add(fromFrogS), 70)
                .attachKeyFrame()
                .colored(PonderPalette.BLUE)
        ...
        ElementLink<WorldSectionElement> toPackagerE =
                scene.world().showIndependentSection(toPackager, Direction.EAST);
        scene.world().moveSection(toPackagerE, util.vector().of(0, 0, 1), 0);
        ElementLink<WorldSectionElement> leverE =
                scene.world().showIndependentSection(util.select().position(lever), Direction.DOWN);
        ...
        scene.overlay()
                ...
                .pointAt(util.vector().blockSurface(fromFrog.below(), Direction.WEST))
                .placeNearTarget();
        scene.idle(100);
        ...
        scene.overlay()
                .showOutlineWithText(
                        util.select()
                                ...
                                .add(util.select().position(fromFrog.below().west())),
                        70)
                .colored(PonderPalette.OUTPUT)
                .text("Addresses packages to 'Peter'")
                .pointAt(util.vector().blockSurface(fromFrog.below().west(), Direction.NORTH))
                .placeNearTarget();
        scene.idle(80);
        ...
        scene.overlay()
                .showControls(
                        util.vector()
                                .blockSurface(util.grid().at(6, 1, 2), Direction.UP)
                                .add(0.5, 0, 0),
                        Pointing.DOWN,
                        40)
        ...
        scene.overlay()
                .showControls(
                        util.vector()
                                .blockSurface(util.grid().at(0, 1, 5), Direction.UP)
                                .add(0.5, 0, 0),
                        Pointing.DOWN,
                        40)
                .withItem(new ItemStack(Items.DIAMOND));
        ...
        scene.overlay()
                .showControls(util.vector().centerOf(util.grid().at(2, 2, 5)), Pointing.RIGHT, 40)
                .rightClick()
        ...
        scene.overlay()
                ...
                .pointAt(util.vector().blockSurface(toFrog, Direction.WEST))
                .placeNearTarget();
        scene.idle(70);
        ...
        scene.overlay()
                .showText(120)
                .text("Clipboards with collected names can help auto-complete address inputs in"
                        + " other UIs")
    ...
    public static void boxTransfer(BlockPos to, BlockPos from, ChainConveyorBlockEntity be) {
        for (Iterator<ChainConveyorPackage> iterator = be.getLoopingPackages().iterator();
                iterator.hasNext(); ) {
