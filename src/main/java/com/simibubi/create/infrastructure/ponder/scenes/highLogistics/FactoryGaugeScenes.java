...
public class FactoryGaugeScenes {
    ...
    public static void restocker(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection belt1 =
                util.select().fromTo(1, 1, 2, 1, 1, 6).add(util.select().fromTo(2, 1, 6, 2, 1, 7));
        ...
        ElementLink<WorldSectionElement> linkL =
                scene.world().showIndependentSection(linkS, Direction.DOWN);
        scene.world().moveSection(linkL, util.vector().of(0, -2, 0), 0);

        ElementLink<WorldSectionElement> chestL =
                scene.world().showIndependentSection(chest, Direction.DOWN);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(link.below(2)), Pointing.DOWN, 50)
                .rightClick()
                .withItem(linkItem);
        scene.idle(5);
        ...
        scene.overlay()
                .showText(100)
                .text("When placed on a packager, factory gauges can monitor items inside the"
                        + " inventory")
                .attachKeyFrame()
                .placeNearTarget()
                .pointAt(gaugeMiddle);
        ...
        scene.overlay()
                .showOutline(PonderPalette.BLUE, gauge, util.select().fromTo(3, 1, 1, 2, 1, 1), 70);
        scene.idle(80);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, gauge, boundingBox.move(0, 1, 0), 100);
        scene.overlay()
                .showText(100)
                .text("The target amount to maintain can now be set by holding Right-click on"
                        + " the gauge")
                .attachKeyFrame()
    ...
    public static void recipe(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection mixer =
                util.select().fromTo(7, 3, 1, 9, 3, 1).add(util.select().fromTo(9, 2, 1, 9, 0, 1));
        ...
        ElementLink<WorldSectionElement> floorL =
                scene.world().showIndependentSection(fakeFloor, Direction.UP);
        ...
        scene.overlay()
                ...
                .attachKeyFrame()
                .placeNearTarget()
                .pointAt(util.vector().blockSurface(util.grid().at(7, 1, 1), Direction.WEST));
        scene.idle(120);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, nuggG, boundingBox.move(1, -.5, 0), 40);
        ...
        scene.overlay()
                .showText(110)
                .text("In the UI, review the inputs and specify how much of the output gets made"
                        + " per batch")
                .attachKeyFrame()
                .placeNearTarget()
                .pointAt(panelM);
        ...
        scene.world()
                .setBlocks(
                        util.select().fromTo(1, 6, 7, 1, 6, 2),
        ...
        scene.world()
                .setBlocks(
                        util.select().fromTo(1, 6, 1, 3, 6, 1),
                        Blocks.AIR.defaultBlockState(),
                        false);
        scene.idle(3);
        ...
        scene.idle(1);
        scene.world()
                .setBlocks(util.select().position(4, 6, 1), Blocks.AIR.defaultBlockState(), false);
        scene.idle(3);
        scene.world().showSection(belt3, Direction.DOWN);
        scene.idle(1);
        scene.world()
                .setBlocks(
                        util.select().fromTo(5, 6, 1, 6, 6, 1),
                        Blocks.AIR.defaultBlockState(),
                        false);
        scene.idle(20);
        ...
        scene.world()
                .modifyBlockEntity(
                        util.grid().at(7, 3, 1), type, pte -> pte.startProcessingBasin());
        ...
        scene.world()
                .setBlocks(
                        util.select().fromTo(7, 6, 2, 7, 6, 3),
                        Blocks.AIR.defaultBlockState(),
                        false);
        ...
        scene.world().modifyBlockEntityNBT(basin, BasinBlockEntity.class, nbt -> {
            nbt.put(
                    ...
                    NBTHelper.writeCompoundList(
                            ImmutableList.of(
                                    IntAttached.with(1, AllItems.ANDESITE_ALLOY.asStack())),
                            ia -> (CompoundTag) ia.getValue()
                                    .saveOptional(builder.world().getHolderLookupProvider())));
        });
        scene.idle(4);
        ...
        scene.world()
                .setBlocks(
                        util.select().fromTo(7, 6, 5, 7, 6, 7),
                        Blocks.AIR.defaultBlockState(),
                        false);
        ...
        ElementLink<WorldSectionElement> scaffL =
                scene.world().showIndependentSection(scaff2, Direction.DOWN);
    ...
    public static void crafting(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        FactoryPanelPosition pickG =
                new FactoryPanelPosition(util.grid().at(1, 3, 4), PanelSlot.BOTTOM_LEFT);
        FactoryPanelPosition stickG =
                new FactoryPanelPosition(util.grid().at(2, 2, 4), PanelSlot.TOP_LEFT);
        FactoryPanelPosition diaG =
                new FactoryPanelPosition(util.grid().at(3, 3, 4), PanelSlot.BOTTOM_RIGHT);
        ...
        Selection outPacker =
                util.select().fromTo(6, 1, 6, 6, 3, 6).add(util.select().position(5, 2, 6));
        ...
        scene.overlay()
                .showText(120)
                .text("With auto-arrangement active, the boxes can be unwrapped into crafters"
                        + " directly")
                .attachKeyFrame()
                .placeNearTarget()
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(6, 3, 4), Direction.EAST),
                        Pointing.RIGHT,
                        120)
                .rightClick()
                .withItem(AllItems.WRENCH.asStack());
        ...
        scene.overlay()
                .showOutlineWithText(util.select().fromTo(6, 2, 2, 6, 4, 4), 100)
        ...
        scene.world()
                .setCraftingResult(util.grid().at(6, 2, 4), new ItemStack(Items.DIAMOND_PICKAXE));
        scene.world()
                .modifyBlockEntity(
                        util.grid().at(6, 3, 2),
        ...
        scene.overlay()
                .showText(120)
                .text("This crafter can now be used universally, by more gauges with different"
                        + " recipes")
                .attachKeyFrame()
                .placeNearTarget()
                .pointAt(util.vector().blockSurface(util.grid().at(6, 3, 4), Direction.WEST));
        ...
        scene.overlay()
                .showText(120)
                .text("Using a Re-packager is recommended to prevent fragmentation of input"
                        + " packages")
                .attachKeyFrame()
                .colored(PonderPalette.BLUE)
                .placeNearTarget()
    ...
    public static void links(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(30);
        scene.overlay()
                .showControls(util.vector().of(4, 2.5, 2), Pointing.RIGHT, 60)
                .rightClick();
        ...
        scene.overlay()
                .showText(120)
                .text("Redstone links will be powered when the stock level is at or above the"
                        + " target amount")
                .attachKeyFrame()
                .placeNearTarget()
                .pointAt(midl);
        ...
        scene.overlay()
                ...
                .colored(PonderPalette.BLUE)
                .placeNearTarget()
                .pointAt(util.vector().of(1, 3, 1));
        scene.idle(100);
    }

    private static void setPanelItem(
            SceneBuilder builder, BlockPos gauge, PanelSlot slot, ItemStack item) {
        withGaugeDo(builder, gauge, slot, pb -> pb.setFilter(item));
    }

    private static void setPanelPowered(
            SceneBuilder builder, BlockPos gauge, PanelSlot slot, boolean power) {
        withGaugeDo(builder, gauge, slot, pb -> pb.redstonePowered = power);
    }

    private static void setPanelVisible(
            SceneBuilder builder, BlockPos gauge, PanelSlot slot, boolean visible) {
    ...
    private static void removePanelConnections(
            SceneBuilder builder, BlockPos gauge, PanelSlot slot) {
    ...
    private static void setArrowMode(
        ...
        withGaugeDo(builder, gauge, slot, pb -> {
            FactoryPanelConnection connection =
                    pb.targetedBy.get(new FactoryPanelPosition(fromGauge, fromSlot));
            if (connection == null) {
    ...
    private static void addPanelConnection(
        ...
        withGaugeDo(
                ...
                gauge,
                slot,
                pb -> pb.addConnection(new FactoryPanelPosition(fromGauge, fromSlot)));
    }

    private static void insertItemsIntoCrafter(
            CreateSceneBuilder scene, BlockPos pos, ItemStack stack) {
        scene.world()
    ...
    private static void withGaugeDo(
        ...
        builder.world()
                .modifyBlockEntity(
                        gauge,
                        FactoryPanelBlockEntity.class,
                        be -> call.accept(be.panels.get(slot)));
    }
}
