...
public class TrainSignalScenes {
    ...
    public static void placement(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(6);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.GREEN, bb, bb.move(0, -1 / 16f, 0), 1);
        scene.overlay()
        ...
        ElementLink<WorldSectionElement> signalElement =
                scene.world().showIndependentSection(fakeSignal, Direction.DOWN);
        ...
        ElementLink<ParrotElement> birb =
                scene.special().createBirb(birbVec, ParrotPose.FacePointOfInterestPose::new);
        ...
        scene.overlay()
                .showControls(birbVec.add(0, 0.5, 0), Pointing.DOWN, 40)
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb3, bb3.inflate(.45f, 0, .45f), 40);
        scene.idle(15);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.RED, bb, bb.inflate(.45f, 0, .45f), 40);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.RED, bb3, bb3.inflate(.45f, 0, .45f), 45);
        scene.overlay()
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, bb, new AABB(util.grid().at(8, 1, 9)), 40);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.OUTPUT, bb2, bb2.expandTowards(-4, 0, 0), 40);
        scene.idle(5);

        scene.overlay().chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb, bb, 1);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb, bb.inflate(.45f, 0, .45f), 30);
        scene.idle(5);

        AABB bb4 = new AABB(marker, marker).move(.45, 0, 0);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb4, bb4, 1);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb4, bb4.expandTowards(2, 0, 0), 20);
        scene.idle(15);

        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.GREEN, bb4, bb4.expandTowards(2, 0, 0), 25);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.GREEN, bb3, bb3.inflate(.45f, 0, .45f), 25);
        scene.overlay()
    ...
    public static void signaling(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showBigLine(PonderPalette.RED, m4.add(.45, 0, -.45), m3.add(-.45, 0, .45), 50);
        scene.overlay().showBigLine(PonderPalette.GREEN, m3.add(.45, 0, -.45), xz2, 50);
        scene.idle(40);

        ElementLink<WorldSectionElement> trainElement =
                scene.world().showIndependentSection(train1, null);
        ElementLink<ParrotElement> birb1 = scene.special()
                .createBirb(
                        util.vector().centerOf(18, 3, 7), ParrotPose.FacePointOfInterestPose::new);
        ...
        scene.overlay()
                .showBigLine(PonderPalette.RED, m4.add(.45, 0, -.45), m3.add(-.45, 0, .45), 220);
        scene.idle(25);
        ...
        ElementLink<WorldSectionElement> trainElement2 =
                scene.world().showIndependentSection(train3, null);
        ...
        scene.overlay()
                .showControls(util.vector().blockSurface(s1Pos, Direction.EAST), Pointing.RIGHT, 80)
                .rightClick()
        ...
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb, bb, 1);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb, bb.inflate(.45f, 0, .45f), 140);
        scene.idle(10);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.OUTPUT, bb2, bb2.expandTowards(-5, 0, 0), 130);
        scene.idle(10);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.OUTPUT, bb3, bb3.inflate(.45f, 0, .45f), 120);
        scene.idle(10);
        ...
        birb1 = scene.special()
                .createBirb(
                        util.vector().centerOf(3, 3, 7).add(.5, 0, 0), ParrotPose.DancePose::new);
        scene.idle(10);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.RED, bb, bb.inflate(.45f, 0, .45f), 140);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.RED, bb2, bb2.expandTowards(-5, 0, 0), 130);
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.RED, bb3, bb3, 1);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.RED, bb3, bb3.inflate(.45f, 0, .45f), 120);
        scene.idle(5);
        scene.world().changeSignalState(s1Pos, SignalState.RED);
        scene.effects().indicateRedstone(s1Pos.above());
        scene.idle(15);
        ...
        ElementLink<WorldSectionElement> trainElement3a =
                scene.world().showIndependentSection(train2a, null);
        ...
        ElementLink<WorldSectionElement> trainElement3b =
                scene.world().showIndependentSection(train2b, null);
        ...
        scene.overlay()
                .showBigLine(PonderPalette.GREEN, m2.add(.45, 0, 0), m1.add(-.45, 0, 0), 100);
        scene.overlay()
                .showBigLine(PonderPalette.GREEN, m4.add(.45, 0, -.45), m3.add(-.45, 0, .45), 100);
        scene.idle(15);
        scene.overlay()
                .showText(80)
                .pointAt(util.vector().topOf(util.grid().at(9, 0, 6)))
    ...
    public static void redstone(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.special()
                .createBirb(
                        util.vector().centerOf(util.grid().at(6, 3, 4)), ParrotPose.DancePose::new);
        scene.idle(10);
