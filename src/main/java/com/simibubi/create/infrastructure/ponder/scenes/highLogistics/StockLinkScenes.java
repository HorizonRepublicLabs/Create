...
public class StockLinkScenes {
    ...
    public static void stockLink(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink<WorldSectionElement> linkL =
                scene.world().showIndependentSection(link2S, Direction.DOWN);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(link2.below()), Pointing.DOWN, 50)
                .rightClick()
                .withItem(linkItem);
        scene.idle(5);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, link1, bb1.move(util.vector().of(2, 0, 0)), 40);
        ...
        scene.overlay()
                .showText(100)
                .text("Stock Link signals have unlimited range, but packages require"
                        + " transportation")
                .attachKeyFrame()
                .colored(PonderPalette.BLUE)
                .placeNearTarget()
        ...
        scene.idle(10);
        scene.overlay()
                .showControls(util.vector().centerOf(link2), Pointing.DOWN, 40)
