...
public class TrainScenes {
    ...
    public static void controls(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showControls(util.vector().topOf(initialControlsPos), Pointing.DOWN, 70)
                .rightClick();
        scene.idle(20);
    ...
    public static void schedule(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink<WorldSectionElement> trainElement1 =
                scene.world().showIndependentSection(train1, Direction.DOWN);
        scene.idle(10);
        scene.world().animateTrainStation(stationPos, true);
        scene.idle(10);
        ...
        scene.overlay()
                .showControls(target, Pointing.RIGHT, 80)
                .rightClick()
        ...
        scene.overlay()
                .showControls(util.vector().topOf(util.grid().at(3, 3, 4)), Pointing.DOWN, 80)
                .rightClick()
                .withItem(AllItems.SCHEDULE.asStack());
        scene.idle(6);
        ...
        ElementLink<WorldSectionElement> trainElement2 =
                scene.world().showIndependentSection(train2, Direction.DOWN);
        ...
        scene.overlay()
                ...
                .placeNearTarget()
                .attachKeyFrame()
                .text("Any mob or blaze burner sitting in front of Train Controls is an eligible"
                        + " conductor");
        scene.idle(80);

        scene.overlay()
                .showControls(util.vector().centerOf(util.grid().at(3, 1, 7)), Pointing.DOWN, 30)
                .withItem(new ItemStack(Items.LEAD));
        scene.idle(40);
        target = util.vector().centerOf(util.grid().at(3, 3, 4));
        scene.overlay()
                .showControls(target.add(0.5, 0, 0), Pointing.RIGHT, 30)
                .rightClick()
                .withItem(new ItemStack(Items.LEAD));
        scene.idle(6);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(util.grid().at(3, 3, 4)), Pointing.DOWN, 15)
                .withItem(AllItems.SCHEDULE.asStack());
        scene.idle(6);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(util.grid().at(6, 3, 4)), Pointing.DOWN, 70)
                .rightClick();
        scene.idle(6);
