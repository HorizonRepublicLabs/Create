...
public class AllCreatePonderTags {
    ...
    public static void register(PonderTagRegistrationHelper<ResourceLocation> helper) {
        ...
        helper.registerTag(HIGH_LOGISTICS)
                ...
                .description("Components which help manage distributed item storage and automated"
                        + " requests around your factory")
                .register();
        ...
        helper.registerTag(MOVEMENT_ANCHOR)
                ...
                .description(
                        "Components which allow the creation of moving contraptions, animating an"
                                + " attached structure in a variety of ways")
                .register();
        ...
        helper.registerTag(CONTRAPTION_ACTOR)
                ...
                .description("Components which expose special behaviour when attached to a moving"
                        + " contraption")
                .register();
        ...
        helper.registerTag(CONTRAPTION_ASSEMBLY)
                ...
                .description("Tools and Components used to assemble structures moved as an animated"
                        + " Contraption")
                .register();
        ...
        helper.registerTag(SAILS)
                ...
                .description("Blocks that count towards the strength of a Windmill Contraption when"
                        + " assembled. Each of these have equal efficiency in doing so.")
                .register();
        ...
        helper.registerTag(ARM_TARGETS)
                ...
                .description(
                        "Components which can be selected as inputs or outputs to the Mechanical"
                                + " Arm")
                .register();
        ...
        //				.description("Components that have been added or changed significantly in the latest
        // versions of Create")
        //				.register();
        ...
        helper.registerTag(DISPLAY_SOURCES)
                ...
                .description("Components or Blocks which offer some data that can be read with a"
                        + " Display Link")
                .register();
        ...
        helper.registerTag(DISPLAY_TARGETS)
                ...
                .description(
                        "Components or Blocks which can process and display the data received from"
                                + " a Display Link")
                .register();
        ...
        helper.registerTag(THRESHOLD_SWITCH_TARGETS)
                ...
                .description(
                        "Threshold Switches can read from these blocks, as well as most item and"
                                + " fluid containers.")
                .register();
        ...
        Mods.COMPUTERCRAFT.executeIfInstalled(() -> () -> {
            Block computer =
                    BuiltInRegistries.BLOCK.get(Mods.COMPUTERCRAFT.rl("computer_advanced"));
            if (computer != Blocks.AIR) itemHelper.addToTag(DISPLAY_SOURCES).add(computer);
        });
