...
public class MovementActorScenes {
    ...
    public static void psiTransfer(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                ...
                .placeNearTarget()
                .attachKeyFrame()
                .text("This component can interact with storage without the need to stop the"
                        + " contraption.");
        scene.idle(90);
        ...
        scene.overlay()
                .showOutlineWithText(util.select().position(psi.west()), 50)
                .colored(PonderPalette.RED)
                .placeNearTarget()
                .attachKeyFrame()
        ...
        scene.idle(17);
        scene.overlay()
                .showOutline(PonderPalette.GREEN, psi, util.select().fromTo(5, 3, 2, 6, 3, 2), 80);
        scene.idle(10);

        scene.overlay()
                .showOutlineWithText(util.select().position(psi2), 70)
                .placeNearTarget()
                .colored(PonderPalette.GREEN)
                .attachKeyFrame()
                .text("While engaged, the stationary interface will represent ALL inventories on"
                        + " the contraption");
        ...
        scene.overlay()
                .showControls(util.vector().topOf(5, 3, 2), Pointing.DOWN, 40)
                .withItem(itemStack);
        ...
        scene.overlay()
                ...
                .text("After no items have been exchanged for a while, the contraption will"
                        + " continue on its way");
    ...
    public static void psiRedstone(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Class<PortableStorageInterfaceBlockEntity> psiClass =
                PortableStorageInterfaceBlockEntity.class;
        ...
        scene.overlay()
                .showOutlineWithText(util.select().position(1, 1, 3), 120)
                .colored(PonderPalette.RED)
    ...
    public static void harvester(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .setBlocks(
                        crops, Blocks.WHEAT.defaultBlockState().setValue(CropBlock.AGE, 7), false);
        scene.world().showSection(util.select().layer(0), Direction.UP);
        ...
        ElementLink<WorldSectionElement> contraption = scene.world()
                .showIndependentSection(
                        util.select()
                                .fromTo(4, 2, 4, 2, 2, 5)
                                .add(util.select().fromTo(2, 1, 5, 0, 1, 5)),
                        Direction.DOWN);
        ...
        for (int i = 0; i < 3; i++) {
            scene.world()
                    .showSectionAndMerge(
                            util.select().position(i, 1, 4), Direction.SOUTH, contraption);
            scene.idle(5);
        }
        ...
        scene.world()
                .createItemEntity(
                        util.vector().centerOf(current), util.vector().of(0, 0.3, -.2), wheatItem);
        scene.idle(5);
        ...
        scene.world()
                .createItemEntity(
                        util.vector().centerOf(current), util.vector().of(.1, 0.3, -.1), wheatItem);
        ...
        scene.world()
                .createItemEntity(
                        util.vector().centerOf(current), util.vector().of(.2, 0.3, 0), wheatItem);
        ...
        scene.idle(116);
        scene.overlay()
                .showControls(util.vector().topOf(1, 2, 5), Pointing.DOWN, 50)
                .withItem(wheatItem);
        for (int i = 0; i < 3; i++)
            scene.world()
                    .modifyBlockEntity(
    ...
    public static void plough(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(10);
        scene.world()
                .showSectionAndMerge(util.select().position(3, 1, 3), Direction.EAST, contraption);
        scene.idle(5);
        scene.world()
                .showSectionAndMerge(util.select().position(3, 1, 2), Direction.EAST, contraption);
        scene.idle(20);
        ...
        scene.world()
                .createItemEntity(util.vector().centerOf(2, 1, 3), m, new ItemStack(Items.LEVER));
        scene.world().destroyBlock(util.grid().at(2, 1, 2));
        scene.world()
                .createItemEntity(util.vector().centerOf(2, 1, 2), m, new ItemStack(Items.TORCH));

        scene.idle(30);

        scene.world().destroyBlock(util.grid().at(1, 1, 3));
        scene.world()
                .createItemEntity(util.vector().centerOf(1, 1, 3), m, new ItemStack(Items.RAIL));
        scene.world().destroyBlock(util.grid().at(1, 1, 2));
        scene.world()
                .createItemEntity(
                        util.vector().centerOf(1, 1, 2), m, new ItemStack(Items.REDSTONE));
        ...
        scene.overlay()
                .showControls(util.vector().topOf(2, 2, 2), Pointing.DOWN, 40)
        ...
        scene.world()
                .setBlocks(
                        util.select().fromTo(2, 0, 2, 2, 0, 3),
                        Blocks.FARMLAND.defaultBlockState(),
                        true);
        scene.idle(30);
        scene.world()
                .setBlocks(
                        util.select().fromTo(1, 0, 2, 1, 0, 3),
                        Blocks.FARMLAND.defaultBlockState(),
                        true);
        scene.idle(20);
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(4, 3, 3, 4, 2, 3), Direction.DOWN, contraption);
        scene.idle(15);
        ...
        ElementLink<ParrotElement> birb = scene.special()
                .createBirb(
                        util.vector().topOf(3, 0, 2).add(0, 0, 0.5), ParrotPose.FlappyPose::new);
        scene.idle(11);
    ...
    public static void contraptionControls(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection contraption =
                util.select().fromTo(5, 2, 4, 3, 2, 5).add(util.select().fromTo(3, 1, 5, 1, 1, 4));
        ...
        scene.world()
                .configureCenterOfRotation(contraptionLink, util.vector().centerOf(bearingPos));
        scene.idle(10);
        ...
        ItemStack wheatItem = new ItemStack(Items.WHEAT);
        ElementLink<EntityElement> item1 =
                scene.world().createItemEntity(util.vector().centerOf(cobblePos), m, cobbleItem);
        ...
        ElementLink<EntityElement> item2 =
                scene.world().createItemEntity(util.vector().centerOf(wheatPos), m, wheatItem);
        scene.idle(35);

        scene.world()
                .modifyBlockEntity(
                        harvesterPos, HarvesterBlockEntity.class, hte -> hte.setAnimatedSpeed(0));
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().position(controlsPos1), Direction.DOWN, contraptionLink);
        scene.idle(15);
        ...
        scene.overlay()
                .showText(60)
                .placeNearTarget()
                .pointAt(util.vector().topOf(controlsPos1).add(0, -4 / 16f, 0))
                .attachKeyFrame()
        ...
        scene.world().setKineticSpeed(util.select().position(drillPos), 0);
        scene.overlay()
                .showControls(util.vector().of(1.5, 2.75, 4.5), Pointing.DOWN, 15)
                .rightClick();
        scene.idle(7);
        scene.world()
                .modifyBlockEntity(
        ...
        scene.overlay()
                .showControls(util.vector().of(3.5, 2.75, 1), Pointing.DOWN, 15)
                .rightClick();
        scene.idle(7);
        scene.world()
                .modifyBlockEntity(
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().position(controlsPos2), Direction.DOWN, contraptionLink);
        scene.idle(15);
        ...
        scene.overlay()
                .showText(60)
                .placeNearTarget()
                .pointAt(util.vector().topOf(controlsPos2).add(0, -4 / 16f, 0))
                .attachKeyFrame()
                .text("They can be attached anywhere on the contraption");
        scene.idle(75);

        scene.overlay()
                .showControls(util.vector().topOf(controlsPos2), Pointing.DOWN, 30)
                .rightClick()
                .withItem(AllBlocks.MECHANICAL_DRILL.asStack());
        scene.idle(5);
        scene.overlay()
                .showControls(util.vector().centerOf(controlsPos1), Pointing.UP, 25)
                .rightClick()
        ...
        scene.overlay()
                ...
                .independent(80)
                .attachKeyFrame()
                .text("While disassembled, the filter can be changed to target specific types of"
                        + " actors");
        scene.idle(90);

        scene.overlay()
                .showControls(util.vector().topOf(controlsPos2), Pointing.RIGHT, 15)
                .rightClick();
        scene.idle(7);
        scene.world()
                .modifyBlockEntity(
        ...
        scene.idle(25);
        scene.world().setBlock(wheatPos, harvested, true);
        ElementLink<EntityElement> item3 =
                scene.world().createItemEntity(util.vector().centerOf(wheatPos), m, wheatItem);
        scene.idle(35);
        scene.world()
                .modifyBlockEntity(
        ...
        ElementLink<EntityElement> item4 =
                scene.world().createItemEntity(util.vector().centerOf(cobblePos), m, cobbleItem);
