...
public class TableClothScenes {
    ...
    public static void tableCloth(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showControls(util.vector().centerOf(3, 2, 3), Pointing.DOWN, 50)
                .rightClick()
                .withItem(grass);
        ...
        scene.effects().indicateSuccess(util.grid().at(3, 2, 3));
        scene.world()
                .modifyBlockEntity(util.grid().at(3, 2, 3), TableClothBlockEntity.class, be -> {
        ...
        scene.overlay()
                ...
                .attachKeyFrame()
                .pointAt(util.vector().of(3, 1.75, 3))
                .placeNearTarget();
        scene.idle(110);
        ...
        scene.overlay()
                .showOutlineWithText(util.select().fromTo(3, 2, 4, 4, 3, 5), 100)
        ...
        scene.overlay()
                .showControls(util.vector().centerOf(2, 3, 4), Pointing.DOWN, 80)
                .rightClick()
                .withItem(tickerItem);
        scene.idle(5);
        ...
        scene.special()
                .createBirb(
                        util.vector().centerOf(util.grid().at(3, 1, 2)),
        ...
        scene.overlay()
                ...
                .attachKeyFrame()
                .pointAt(util.vector().of(2.5, 2.75, 1.5))
                .placeNearTarget();
        scene.idle(100);
        ...
        scene.overlay()
                .showControls(util.vector().of(5, 3.5, 4), Pointing.RIGHT, 80)
                .withItem(logItem1);
        scene.overlay()
                .showControls(util.vector().of(5, 2, 4), Pointing.RIGHT, 80)
                .withItem(logItem2);
        scene.idle(10);
        ...
        scene.overlay()
                ...
                .attachKeyFrame()
                .pointAt(util.vector().of(4, 3, 4))
                .placeNearTarget();
        scene.idle(80);

        ItemStack clothItem = AllBlocks.TABLE_CLOTHS.get(DyeColor.LIGHT_GRAY).asStack();
        scene.overlay()
                .showControls(util.vector().of(3, 3, 1.75), Pointing.DOWN, 120)
                .rightClick()
                .withItem(clothItem);
        scene.idle(30);
        ...
        scene.overlay()
                .showText(100)
                .text("To create a new trade, interact with the shop keeper while holding a"
                        + " table cloth")
                .attachKeyFrame()
                .pointAt(util.vector().of(2.5, 2.75, 1.5))
                .placeNearTarget();
        ...
        scene.world()
                .modifyBlockEntity(util.grid().at(5, 2, 1), TableClothBlockEntity.class, be -> {
                    AutoRequestData.Mutable mutable = new Mutable();
                    mutable.encodedRequest =
                            PackageOrderWithCrafts.simple(List.of(new BigItemStack(logItem1)));
                    mutable.isValid = true;
                    be.requestData = mutable.toImmutable();
                    be.facing = Direction.NORTH;
                });
        ...
        scene.world()
                .setFilterData(
                        util.select().position(5, 2, 1), TableClothBlockEntity.class, diamondItem);
        scene.idle(15);
        ...
        scene.overlay()
                .showControls(util.vector().centerOf(util.grid().at(5, 2, 1)), Pointing.DOWN, 90)
                .rightClick();
        scene.idle(10);
        ...
        scene.overlay()
                ...
                .attachKeyFrame()
                .pointAt(util.vector().of(5, 2, 1.5))
                .placeNearTarget();
        scene.idle(100);

        ItemStack listItem = AllItems.SHOPPING_LIST.asStack();
        scene.overlay()
                .showControls(util.vector().of(3, 3, 1.75), Pointing.DOWN, 90)
                .rightClick()
                .withItem(listItem);
        scene.idle(5);
        ...
        scene.overlay()
                .showText(120)
                .text("When checking out at the cashier, the bought items will be placed into a"
                        + " package")
                .attachKeyFrame()
        ...
        scene.overlay()
                ...
                .attachKeyFrame()
                .pointAt(util.vector().of(1, 2.5, 1.5))
                .placeNearTarget();
        scene.idle(100);

        scene.overlay()
                .showControls(util.vector().topOf(util.grid().at(3, 1, 1)), Pointing.DOWN, 100)
                .rightClick()
                .withItem(diamondItem);
        scene.idle(10);
