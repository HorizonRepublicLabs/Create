...
public class RollerScenes {
    ...
    public static void clearAndPave(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection someRubble = util.select()
                .fromTo(2, 1, 3, 3, 2, 5)
        ...
        ElementLink<ParrotElement> birbLink = scene.special()
                .createBirb(
                        util.vector().centerOf(8, 3, 4), ParrotPose.FacePointOfInterestPose::new);
        ElementLink<WorldSectionElement> trainLink =
        ...
        scene.overlay()
                .showControls(util.vector().topOf(util.grid().at(2, 2, 4)), Pointing.DOWN, 70)
        ...
        scene.overlay()
                ...
                .attachKeyFrame()
                .text("In its default mode, without a material set, it will simply clear blocks"
                        + " like a Drill")
                .placeNearTarget();
        ...
        scene.world()
                .replaceBlocks(
                        util.select().fromTo(5, 0, 3, 5, 0, 5),
                        paveMaterial.defaultBlockState(),
                        true);
        scene.idle(20);
        scene.world()
                .replaceBlocks(
                        util.select().fromTo(4, 0, 3, 4, 0, 5),
                        paveMaterial.defaultBlockState(),
                        true);
        scene.idle(10);
        ...
        scene.world()
                .replaceBlocks(
                        util.select().fromTo(3, 0, 3, 3, 0, 5),
                        paveMaterial.defaultBlockState(),
                        true);
        scene.idle(10);
        for (int i = 0; i < 3; i++)
        ...
        scene.world()
                .replaceBlocks(
                        util.select().fromTo(2, 0, 3, 2, 0, 5),
                        paveMaterial.defaultBlockState(),
                        true);
        scene.idle(20);
        scene.world()
                .replaceBlocks(
                        util.select().fromTo(1, 0, 3, 1, 0, 5),
                        paveMaterial.defaultBlockState(),
                        true);
        scene.idle(20);
        scene.world()
                .replaceBlocks(
                        util.select().fromTo(0, 0, 3, 0, 0, 5),
                        paveMaterial.defaultBlockState(),
                        true);
        scene.idle(10);
        for (int i = 0; i < 3; i++)
        ...
        scene.overlay()
                .showOutlineWithText(util.select().fromTo(5, 0, 3, 0, 0, 5), 90)
        ...
        scene.idle(10);
        ElementLink<WorldSectionElement> gantryLink =
                scene.world().showIndependentSection(gantryCar, Direction.UP);
        scene.world().moveSection(gantryLink, util.vector().of(0, 0, -4), 0);
        scene.idle(10);
        ElementLink<WorldSectionElement> gantryLink2 =
                scene.world().showIndependentSection(rollers, Direction.EAST);
        scene.idle(5);
        ElementLink<WorldSectionElement> gantryLink3 =
                scene.world().showIndependentSection(chest, Direction.SOUTH);
        ...
        for (int i = 0; i < 5; i++) {
            scene.world()
                    .replaceBlocks(
                            util.select().fromTo(5 - i, 0, 3, 5 - i, 0, 5),
                            paveMaterial.defaultBlockState(),
                            true);
            scene.idle(20);
        }
    ...
    public static void fill(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink<ParrotElement> birbLink = scene.special()
                .createBirb(
                        util.vector().centerOf(8, 7, 4), ParrotPose.FacePointOfInterestPose::new);
        scene.idle(5);
        scene.world().showSectionAndMerge(rollers, Direction.EAST, trainLink);
        scene.idle(15);
        ...
        scene.overlay()
                .showOutlineWithText(util.select().fromTo(5, 3, 3, 0, 1, 5), 90)
                .attachKeyFrame()
        ...
        ItemStack paveItem = new ItemStack(paveMaterial);
        scene.overlay()
                .showControls(filterSlot.add(0, 0, -6 / 16f), Pointing.UP, 35)
                .withItem(paveItem);
        scene.idle(7);
        scene.world().setFilterData(rollers, RollerBlockEntity.class, paveItem);
        scene.idle(10);
        ...
        for (int j = 0; j < 5; j++) {
            for (int i = 0; i < 3; i++) {
                scene.world()
                        .showSection(util.select().fromTo(5 - j, 3 - i, 3, 5 - j, 3 - i, 5), null);
                scene.idle(2);
            }
            ...
            if (j == 2)
                scene.overlay()
                        ...
                        .text("On 'straight fill', they will place simple columns down to the"
                                + " surface")
                        .placeNearTarget();
        ...
        scene.overlay()
                .showControls(filterSlot, Pointing.DOWN, 40)
                .showing(AllIcons.I_ROLLER_WIDE_FILL);
        scene.idle(45);
        ...
        for (int j = 0; j < 5; j++) {
            for (int i = 0; i < 3; i++) {
                scene.world()
                        .showSection(util.select().fromTo(5 - j, 3 - i, 1, 5 - j, 3 - i, 7), null);
                scene.idle(2);
            }
        ...
        scene.world()
                .replaceBlocks(
                        util.select().fromTo(5, 1, 3, 0, 3, 5),
        ...
        scene.overlay()
                ...
                .attachKeyFrame()
                .independent()
                .text("As opposed to 'clear & pave', neither of these modes will cause the"
                        + " rollers to break existing blocks")
                .placeNearTarget();
