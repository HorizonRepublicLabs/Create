...
public class KineticsScenes {
    ...
    public static void shaftsCanBeEncased(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showControls(util.vector().topOf(3, 1, 2), Pointing.DOWN, 60)
                .rightClick()
        ...
        scene.world()
                .setBlocks(
                        andesite,
                        andesiteEncased.getDefaultState().setValue(EncasedShaftBlock.AXIS, Axis.X),
                        true);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(1, 0, 2), Pointing.UP, 60)
                .rightClick()
        ...
        scene.world()
                .setBlocks(
                        brass,
                        brassEncased.getDefaultState().setValue(EncasedShaftBlock.AXIS, Axis.X),
                        true);
        scene.world().setKineticSpeed(shaft, 32);
    ...
    public static void cogAsRelay(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        for (int i = 1; i <= 4; i++) {
            scene.idle(5);
            if (i == 2) scene.world().showSection(util.select().position(0, 1, 2), Direction.DOWN);
            scene.world().showSection(util.select().position(i, 1, 2), Direction.DOWN);
        }
    ...
    public static void largeCogAsRelay(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        for (int i = 3; i >= 1; i--) {
            scene.idle(5);
            if (i == 3) scene.world().showSection(util.select().position(3, 2, 5), Direction.DOWN);
        ...
        scene.world()
                .modifyBlock(
                        util.grid().at(3, 2, 3), s -> s.setValue(ShaftBlock.AXIS, Axis.X), false);
        ...
        for (int i = 3; i >= 1; i--) {
            scene.idle(5);
            if (i == 3) scene.world().showSection(util.select().position(5, 2, 3), Direction.DOWN);
    ...
    public static void cogsSpeedUp(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        BlockState largeCogState =
                AllBlocks.LARGE_COGWHEEL.getDefaultState().setValue(CogWheelBlock.AXIS, Axis.X);
        BlockState smallCogState =
                AllBlocks.COGWHEEL.getDefaultState().setValue(CogWheelBlock.AXIS, Axis.X);
    ...
    public static void cogwheelsCanBeEncased(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showControls(util.vector().topOf(3, 0, 2), Pointing.UP, 100)
                .rightClick()
                .withItem(andesiteCasingItem);
        scene.idle(7);
        scene.world()
        ...
        scene.overlay()
                .showControls(util.vector().topOf(2, 1, 2), Pointing.DOWN, 30)
                .rightClick()
                .withItem(andesiteCasingItem);
        scene.idle(7);
        scene.world()
        ...
        scene.overlay()
                .showControls(util.vector().topOf(1, 0, 3), Pointing.UP, 60)
                .rightClick()
                .withItem(brassCasingItem);
        scene.idle(7);
        scene.world()
                .setBlocks(
                        ...
                        brassEncased.getDefaultState().setValue(EncasedCogwheelBlock.AXIS, Axis.Y),
                        true);
        ...
        ElementLink<WorldSectionElement> shaftLink =
                scene.world().showIndependentSection(shaft2, Direction.DOWN);
        scene.idle(15);
        scene.overlay()
                .showText(90)
                .placeNearTarget()
        ...
        scene.overlay()
                .showControls(wrenchHere, Pointing.RIGHT, 25)
                .rightClick()
    ...
    public static void gearbox(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .hideSection(
                        util.select().fromTo(4, 2, 2, 2, 2, 4).substract(gearbox), Direction.UP);
        scene.idle(20);

        BlockState defaultState = AllBlocks.SHAFT.getDefaultState();
        BlockState cogState = AllBlocks.COGWHEEL.getDefaultState();
        scene.world()
                .setBlock(largeCogBack, defaultState.setValue(CogWheelBlock.AXIS, Axis.Z), false);
        scene.world()
                .setBlock(largeCogFront, defaultState.setValue(CogWheelBlock.AXIS, Axis.Z), false);
        scene.world()
                .setBlock(largeCogRight, defaultState.setValue(CogWheelBlock.AXIS, Axis.X), false);
        scene.world()
                .setBlock(largeCogLeft, defaultState.setValue(CogWheelBlock.AXIS, Axis.X), false);
        ...
        scene.world()
                .setBlock(
                        largeCogFront.north(), cogState.setValue(CogWheelBlock.AXIS, Axis.Z), true);
        scene.world()
                .setBlock(
                        largeCogRight.west(), cogState.setValue(CogWheelBlock.AXIS, Axis.X), true);
        scene.idle(10);
        ...
        scene.world()
                .setBlock(
                        largeCogBack.south(), cogState.setValue(CogWheelBlock.AXIS, Axis.Z), true);
        scene.idle(10);
    ...
    public static void creativeMotor(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Vec3 blockSurface =
                util.vector().blockSurface(motor, Direction.NORTH).add(1 / 16f, 0, 3 / 16f);
    ...
    public static void waterWheel(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            scene.world()
                    .showSection(
                            util.select().fromTo(gaugePos.east(i).below(), gaugePos.east(i)),
                            Direction.DOWN);
        }
        ...
        ElementLink<WorldSectionElement> water = scene.world()
                .makeSectionIndependent(util.select()
                        .fromTo(3, 1, 1, 3, 3, 1)
        ...
        scene.overlay()
                .showControls(util.vector().topOf(wheel), Pointing.DOWN, 20)
                .rightClick()
        ...
        scene.world()
                .modifyBlockEntity(
                        wheel,
                        WaterWheelBlockEntity.class,
                        be -> be.applyMaterialIfValid(crimsonPlanks));
        scene.overlay()
                .showText(50)
        ...
        scene.world()
                .modifyBlockEntity(
                        wheel,
                        WaterWheelBlockEntity.class,
                        be -> be.applyMaterialIfValid(birchPlanks));
        scene.idle(40);
        ...
        scene.world()
                .modifyBlockEntity(
                        wheel,
                        WaterWheelBlockEntity.class,
                        be -> be.applyMaterialIfValid(junglePlanks));
        scene.idle(20);
    ...
    public static void largeWaterWheel(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .showSection(
                        util.select().layer(0).substract(util.select().position(3, 0, 0)),
                        Direction.UP);
        ...
        for (int i = 0; i < 4; i++) {
            scene.idle(5);
            if (i == 0) scene.world().hideIndependentSection(strip, Direction.DOWN);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.MEDIUM,
                        new Object(),
                        bb.move(0, 3, 0).contract(0, 2.75, 0),
                        80);
        scene.idle(5);
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.MEDIUM,
                        new Object(),
                        bb.move(0, 0, -3).contract(0, 0, -2.75),
                        75);
        scene.idle(5);
        scene.overlay()
                .chaseBoundingBoxOutline(
        ...
        ItemStack crimsonPlanks = new ItemStack(Items.CRIMSON_PLANKS);
        scene.overlay()
                .showControls(util.vector().topOf(target), Pointing.DOWN, 20)
                .rightClick()
                .withItem(crimsonPlanks);
        scene.idle(7);
        scene.world()
    ...
    public static void handCrank(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .showSection(util.select().layersFrom(1).substract(handleSelect), Direction.DOWN);
        scene.idle(10);
    ...
    public static void valveHandle(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.addKeyframe();
        scene.overlay()
                .showControls(topOf, Pointing.DOWN, 40)
                .rightClick()
        ...
        scene.world()
                .modifyBlock(
                        valvePos,
                        s -> AllBlocks.DYED_VALVE_HANDLES
                                .get(DyeColor.BLUE)
                                .getDefaultState()
    ...
    public static void sequencedGearshift(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
        scene.title(
                "sequenced_gearshift", "Controlling Rotational Speed using Sequenced Gearshifts");
        ...
        scene.idle(7);
        scene.overlay()
                .showOutlineWithText(gearshiftSelection, 50)
                .colored(PonderPalette.BLUE)
        ...
        scene.overlay()
                .showText(80)
                .text("Upon receiving a Redstone Signal, it will start running its configured"
                        + " sequence")
                .attachKeyFrame()
                .pointAt(top);
        ...
        scene.world()
                .modifyBlockEntityNBT(
                        nixie,
                        NixieTubeBlockEntity.class,
                        nbt -> nbt.putInt("RedstoneStrength", 2));
        scene.idle(40);
        ...
        scene.world()
                .modifyBlockEntityNBT(
                        nixie,
                        NixieTubeBlockEntity.class,
                        nbt -> nbt.putInt("RedstoneStrength", 3));
        scene.idle(20);
    ...
    public static void speedController(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                ...
                .text("Rot. Speed Controllers relay rotation from their axis to a Large Cogwheel"
                        + " above them");
        scene.idle(100);
    ...
    private static void gauge(SceneBuilder builder, SceneBuildingUtil util, boolean speed) {
        ...
        scene.world()
                .setBlock(
                        gaugePos,
                        (speed ? AllBlocks.SPEEDOMETER : AllBlocks.STRESSOMETER)
                                .getDefaultState()
        ...
        scene.overlay()
                .showText(80)
                .text("The " + component + " displays the current "
                        + (speed ? "Speed" : "Stress Capacity")
        ...
        if (speed) {
            ...
            BlockState state = AllBlocks.CRUSHING_WHEEL
                    .getDefaultState()
        ...
        scene.overlay()
                .showControls(blockSurface, Pointing.RIGHT, 80)
                .withItem(AllItems.GOGGLES.asStack());
        scene.idle(7);
        scene.overlay()
                .showText(80)
                .text("When wearing Engineers' Goggles, the player can get more detailed"
        ...
        scene.overlay()
                .showText(120)
                .text("Comparators can emit analog Restone Signals relative to the " + component
                        + "'s measurements")
                .attachKeyFrame()
                .colored(PonderPalette.RED)
        ...
        scene.world()
                .showSection(
                        util.select()
                                ...
                                .add(util.select().fromTo(9, 3, 7, 9, 3, 9)),
                        Direction.DOWN);
        scene.idle(3);
