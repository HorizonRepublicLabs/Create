...
public class PistonScenes {
    ...
    public static void movement(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .showSection(
                        util.select().layer(0).add(util.select().position(0, 1, 2)), Direction.UP);
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().position(piston.north().east()), Direction.DOWN, contraption);
        scene.idle(5);
        scene.world()
                .showSectionAndMerge(
                        util.select().position(piston.north().east(2)),
                        Direction.DOWN,
                        contraption);
        scene.world()
                .showSectionAndMerge(
                        util.select().position(piston.north().west()), Direction.DOWN, contraption);
        scene.idle(15);
        ...
        scene.world()
                .setBlock(util.grid().at(0, 1, 2), Blocks.OAK_PLANKS.defaultBlockState(), false);
        scene.effects().indicateRedstone(leverPos);
        scene.world().toggleRedstonePower(util.select().fromTo(leverPos, leverPos.below()));
        scene.world().modifyKineticSpeed(kinetics, f -> -f);
        scene.effects().rotationDirectionIndicator(shaft);
        ...
        scene.overlay()
                .showControls(util.vector().blockSurface(piston, Direction.WEST), Pointing.DOWN, 30)
                .rightClick()
        ...
        scene.world()
                .modifyBlock(
                        piston.north(),
                        s -> s.setValue(MechanicalPistonHeadBlock.TYPE, PistonType.STICKY),
                        false);
        ...
        scene.idle(20);
        scene.world()
                .setBlock(util.grid().at(2, 1, 1), Blocks.OAK_PLANKS.defaultBlockState(), false);
        ...
        scene.world()
                .replaceBlocks(
                        util.select().fromTo(2, 3, 2, 2, 2, 0),
        ...
        scene.overlay()
                .showOutline(
                        ...
                        40);
        scene.overlay()
                .showControls(util.vector().centerOf(util.grid().at(2, 2, 0)), Pointing.RIGHT, 40)
    ...
    public static void poles(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showOutlineWithText(util.select().position(piston), 50)
        ...
        scene.overlay()
                .showOutline(
                        PonderPalette.RED,
                        new Object(),
                        util.select().fromTo(piston.east(), piston.east(2)),
                        100);
        scene.overlay()
                .showOutlineWithText(util.select().fromTo(piston.west(), piston.west(2)), 100)
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().position(piston.north().west()), Direction.EAST, contraption);
        scene.idle(10);
    ...
    public static void movementModes(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().position(piston.north().west().above()),
                        Direction.DOWN,
                        contraption);
        scene.idle(15);
        ...
        scene.world()
                .setBlock(util.grid().at(0, 1, 2), Blocks.ROSE_BUSH.defaultBlockState(), false);
        scene.world()
                .setBlock(
                        util.grid().at(0, 2, 2),
                        Blocks.ROSE_BUSH
        ...
        scene.overlay()
                ...
                .placeNearTarget()
                .text("It can be configured never to revert to solid blocks, or only at the"
