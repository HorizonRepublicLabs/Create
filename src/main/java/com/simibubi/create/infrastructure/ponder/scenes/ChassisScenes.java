...
public class ChassisScenes {
    ...
    public static void linearGroup(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().position(centralChassis.west()), Direction.EAST, chassis);
        scene.idle(5);
        scene.world()
                .showSectionAndMerge(
                        util.select().position(centralChassis.east()), Direction.WEST, chassis);
        scene.idle(4);
        scene.world()
                .showSectionAndMerge(
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().position(centralChassis.above()), Direction.DOWN, chassis);
        scene.idle(2);
        scene.world()
                .showSectionAndMerge(
                        util.select().position(centralChassis.above().east()),
                        Direction.DOWN,
                        chassis);
        scene.idle(10);
    ...
    public static void linearAttachement(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(chassisPos, Direction.WEST), Pointing.LEFT, 30)
                .rightClick()
                .withItem(new ItemStack(Items.SLIME_BALL));
        scene.idle(7);
        scene.world()
                .modifyBlock(
                        chassisPos, s -> s.setValue(LinearChassisBlock.STICKY_BOTTOM, true), false);
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(chassisPos, Direction.WEST), Pointing.LEFT, 15)
                .rightClick()
                .withItem(new ItemStack(Items.SLIME_BALL));
        scene.idle(7);
        scene.world()
                .modifyBlock(
                        chassisPos, s -> s.setValue(LinearChassisBlock.STICKY_TOP, true), false);
        ...
        scene.world()
                .modifyBlock(
                        chassisPos,
                        s -> s.setValue(LinearChassisBlock.STICKY_BOTTOM, false),
                        false);
        scene.effects().superGlue(chassisPos, Direction.WEST, false);
        scene.idle(30);
        ...
        scene.overlay()
                .showOutlineWithText(column3, 80)
                .colored(PonderPalette.GREEN)
                .text("Stickied faces of the Linear Chassis will attach a line of blocks in"
                        + " front of it")
                .placeNearTarget();
        scene.idle(90);
        ...
        scene.overlay()
                .showControls(blockSurface, Pointing.UP, 50)
                .rightClick()
        ...
        scene.world()
                .showSectionAndMerge(util.select().position(1, 3, 2), Direction.UP, glassSection);
        scene.world()
                .showSectionAndMerge(util.select().position(3, 3, 2), Direction.UP, glassSection);
        scene.world()
                .showSectionAndMerge(
        ...
        scene.idle(90);
        scene.overlay()
                .showControls(glueSurface, Pointing.DOWN, 30)
                .rightClick()
        ...
        scene.idle(10);
        scene.world()
                .showSectionAndMerge(util.select().fromTo(2, 8, 2, 3, 9, 2), Direction.DOWN, chain);
        scene.idle(10);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(3, 9, 1, 3, 9, 0), Direction.SOUTH, chain);
        scene.idle(10);
        scene.world()
                .showSectionAndMerge(util.select().fromTo(2, 9, 0, 1, 9, 0), Direction.EAST, chain);
        scene.idle(20);
    ...
    public static void radial(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink<WorldSectionElement> contraption =
                scene.world().showIndependentSection(chassis, Direction.DOWN);
        scene.idle(5);
        ...
        scene.world()
                .modifyBlock(
                        chassisPos, s -> s.setValue(RadialChassisBlock.STICKY_WEST, true), false);
        scene.effects().superGlue(chassisPos, Direction.WEST, false);
        scene.idle(30);
        ...
        scene.world()
                .modifyBlock(
                        chassisPos,
                        s -> s.setValue(RadialChassisBlock.STICKY_EAST, true)
        ...
        scene.world()
                .modifyBlock(
                        chassisPos, s -> s.setValue(RadialChassisBlock.STICKY_WEST, false), false);
        scene.effects().superGlue(chassisPos, Direction.WEST, false);
        scene.idle(30);
        ...
        ElementLink<WorldSectionElement> outer = scene.world()
                .showIndependentSection(
                        util.select().layer(2).substract(chassis).substract(r1), Direction.DOWN);
        ...
        scene.overlay()
                .showOutlineWithText(obj.getValue(), 60)
                .colored(PonderPalette.GREEN)
        ...
        scene.overlay()
                .showControls(blockSurface, Pointing.DOWN, 50)
                .rightClick()
                .withItem(AllItems.WRENCH.asStack());
        ...
        Selection ignored =
                util.select().fromTo(0, 2, 1, 0, 2, 3).add(util.select().position(1, 2, 2));
        scene.overlay()
                .showOutline(
                        PonderPalette.GREEN,
                        r2,
                        r2.copy().substract(util.select().fromTo(0, 2, 0, 1, 2, 4)),
                        80);
        scene.markAsFinished();
        scene.overlay()
                .showOutlineWithText(ignored, 80)
                .colored(PonderPalette.RED)
    ...
    public static void superGlue(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .setBlocks(
                        util.select().fromTo(2, 2, 2, 2, 3, 2),
        ...
        scene.overlay()
                .showControls(util.vector().topOf(2, 2, 3), Pointing.DOWN, 40)
                .withItem(AllItems.SUPER_GLUE.asStack())
                .rightClick();
        scene.idle(6);
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(1, 1, 2), Direction.DOWN),
                        Pointing.UP,
                        40)
                .withItem(AllItems.SUPER_GLUE.asStack())
                .rightClick();
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, lever, bb.expandTowards(-1, -1, -1), 285);
        scene.idle(25);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, crankPos, bb.expandTowards(0, 0, -2), 66);
        scene.idle(20);
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(3, 1, 1), Direction.UP),
                        Pointing.DOWN,
                        40)
                .withItem(AllItems.SUPER_GLUE.asStack())
                .leftClick();
        ...
        Selection toMove =
                util.select().fromTo(1, 1, 2, 2, 1, 2).add(util.select().fromTo(2, 2, 3, 2, 1, 3));
        scene.overlay()
                .showOutlineWithText(toMove, 70)
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, "0", bb.expandTowards(-1, -1, -1), 70);
        scene.idle(15);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.GREEN, "1", bb.expandTowards(2, 0, 0), 55);
        scene.idle(15);
        bb = new AABB(util.grid().at(1, 2, 2));
        scene.overlay().chaseBoundingBoxOutline(PonderPalette.GREEN, "2", bb, 1);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.GREEN, "2", bb.expandTowards(-1, 0, 0), 40);
        ...
        scene.overlay()
                .showOutline(
                        ...
                        70);
        ElementLink<WorldSectionElement> brittles =
                scene.world().showIndependentSection(lever, Direction.SOUTH);
