...
public class RedstoneScenes2 {
    ...
    public static void roseQuartzLamp(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(10);
        ElementLink<WorldSectionElement> outputElement =
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().position(centerLamp.west()), Direction.EAST, rowElement);
        scene.idle(3);
        scene.world()
                .showSectionAndMerge(
                        util.select().position(centerLamp.east()), Direction.WEST, rowElement);
        scene.idle(25);
        ...
        ElementLink<WorldSectionElement> inputElement =
        ...
        scene.overlay()
                .showControls(util.vector().topOf(centerLamp.east(2)), Pointing.DOWN, 20)
                .rightClick()
        ...
        scene.overlay()
                .showControls(util.vector().topOf(centerLamp), Pointing.DOWN, 20)
                .rightClick()
                .withItem(AllItems.WRENCH.asStack());
        scene.idle(6);
    ...
    public static void pulseTimer(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink<WorldSectionElement> link =
                world.showIndependentSection(select.position(0, 1, 4), Direction.EAST);
