...
public class TrackScenes {
    ...
    public static void placement(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        for (int i = 11; i >= 2; i--) {
            scene.world()
                    .showSectionAndMerge(util.select().position(i, 3, 9), Direction.DOWN, bgTrack);
            if (i == 5)
                scene.world()
                        .showSectionAndMerge(
                                util.select().position(7, 4, 9), Direction.DOWN, bgTrack);
            scene.idle(2);
        }
        ...
        scene.overlay()
                .showControls(startTrack, Pointing.DOWN, 40)
                .rightClick()
                .withItem(trackStack);
        ...
        scene.overlay()
                .showControls(startTrack.add(9, 0, 0), Pointing.DOWN, 40)
                .rightClick()
                .withItem(trackStack);
        scene.idle(6);
        scene.overlay()
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, startTrack, bb.expandTowards(9, 0, 0), 30);

        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(12, 3, 5, 4, 3, 5), Direction.WEST, fgTrack);
        scene.idle(55);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(8, 0, 2), Pointing.DOWN, 15)
                .rightClick()
                .withItem(trackStack);
        scene.idle(15);
        scene.overlay()
                .showControls(util.vector().topOf(2, 0, 8), Pointing.DOWN, 15)
                .rightClick()
                .withItem(trackStack);
        scene.idle(7);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(12, 0, 2), Pointing.DOWN, 10)
                .rightClick()
                .withItem(trackStack);
        scene.idle(15);
        scene.overlay()
                .showControls(util.vector().topOf(2, 0, 12), Pointing.DOWN, 10)
                .rightClick()
                .withItem(trackStack);
        scene.idle(7);
        ...
        bb = new AABB(util.grid().at(5, 1, 5))
                .contract(0, .75f, 0)
                .inflate(3, 0, 3)
        ...
        scene.idle(20);
        scene.overlay()
                .chaseBoundingBoxOutline(PonderPalette.GREEN, startTrack, bb.move(4, 0, 4), 32);
        scene.idle(30);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(2, 0, 12), Pointing.DOWN, 60)
                .rightClick()
                .withItem(trackStack)
                .whileCTRL();
        scene.idle(10);
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(2, 6, 2, 2, 7, 4), Direction.DOWN, slopeStart);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(2, 6, 6, 2, 9, 8), Direction.DOWN, slopeStart);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(2, 6, 10, 2, 11, 12), Direction.DOWN, slopeStart);
        scene.idle(20);

        scene.overlay()
                .showControls(util.vector().topOf(12, 3, 11), Pointing.LEFT, 30)
                .withItem(trackStack);
        scene.idle(4);
        ItemStack smoothStone = new ItemStack(Blocks.SMOOTH_STONE);
        scene.overlay()
                .showControls(util.vector().topOf(12, 3, 11), Pointing.RIGHT, 26)
                .withItem(smoothStone);
        scene.idle(30);

        scene.overlay()
                .showControls(util.vector().topOf(2, 6, 11), Pointing.LEFT, 30)
                .withItem(trackStack);
        scene.idle(4);
        scene.overlay()
                .showControls(util.vector().topOf(2, 6, 11), Pointing.RIGHT, 26)
                .withItem(smoothStone);
        scene.idle(10);

        scene.world()
                .showSectionAndMerge(util.select().position(2, 12, 11), Direction.DOWN, slopeStart);
        scene.idle(2);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(11, 8, 10, 3, 11, 12), Direction.UP, slopeStart);
        scene.idle(20);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(12, 2, 7), Pointing.LEFT, 30)
                .withItem(trackStack);
        scene.idle(4);
        smoothStone = new ItemStack(Blocks.SMOOTH_STONE_SLAB);
        scene.overlay()
                .showControls(util.vector().topOf(12, 2, 7), Pointing.RIGHT, 26)
                .withItem(smoothStone);
        scene.idle(30);

        scene.overlay()
                .showControls(util.vector().topOf(2, 4, 7), Pointing.LEFT, 30)
                .withItem(trackStack);
        scene.idle(4);
        scene.overlay()
                .showControls(util.vector().topOf(2, 4, 7), Pointing.RIGHT, 26)
                .withItem(smoothStone);
        scene.idle(10);

        scene.world()
                .showSectionAndMerge(util.select().position(2, 10, 7), Direction.DOWN, slopeStart);
        scene.idle(2);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(11, 7, 6, 3, 11, 8), Direction.UP, slopeStart);
        scene.idle(20);

        scene.overlay()
                .showControls(util.vector().topOf(12, 1, 3), Pointing.LEFT, 30)
                .withItem(trackStack);
        scene.idle(4);
        smoothStone = AllBlocks.METAL_GIRDER.asStack();
        scene.overlay()
                .showControls(util.vector().topOf(12, 1, 3), Pointing.RIGHT, 26)
                .withItem(smoothStone);
        scene.idle(30);

        scene.overlay()
                .showControls(util.vector().topOf(2, 2, 3), Pointing.LEFT, 30)
                .withItem(trackStack);
        scene.idle(4);
        scene.overlay()
                .showControls(util.vector().topOf(2, 2, 3), Pointing.RIGHT, 26)
                .withItem(smoothStone);
        scene.idle(10);

        scene.world()
                .showSectionAndMerge(util.select().position(2, 8, 3), Direction.DOWN, slopeStart);
    }
    ...
    public static void portal(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink<ParrotElement> birb = scene.special()
                .createBirb(
                        util.vector().centerOf(4, 3, 2), ParrotPose.FacePointOfInterestPose::new);
    ...
    public static void chunks(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        for (int i = 6; i >= 2; i--) {
            scene.world()
                    .showSectionAndMerge(
                            util.select().position(i, 1, 4), Direction.DOWN, stationTrackElement);
            scene.idle(2);
        }
        ...
        ElementLink<ParrotElement> birb = scene.special()
                .createBirb(
                        util.vector().centerOf(2, 2, 7), ParrotPose.FacePointOfInterestPose::new);
        ...
        scene.idle(10);
        ElementLink<WorldSectionElement> trackElement =
                scene.world().showIndependentSection(track, Direction.EAST);
