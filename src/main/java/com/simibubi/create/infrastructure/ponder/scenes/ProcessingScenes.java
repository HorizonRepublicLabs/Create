...
public class ProcessingScenes {
    ...
    public static void millstone(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection belt =
                util.select().fromTo(1, 1, 5, 0, 1, 2).add(util.select().position(1, 2, 2));
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(millstone, Direction.NORTH), Pointing.RIGHT, 40)
                .rightClick()
                .withItem(flour);
        scene.idle(50);
        ...
        scene.overlay()
                ...
                .pointAt(util.vector().blockSurface(millstone, Direction.WEST).add(-.5, .4, 0))
                .placeNearTarget();
        scene.idle(60);
    }
    ...
    public static void crushingWheels(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection bottomBelt =
                util.select().fromTo(5, 1, 0, 2, 1, 0).add(util.select().fromTo(2, 1, 2, 2, 1, 1));
        ...
        scene.effects()
                .emitParticles(util.vector().centerOf(center).add(0, -0.2, 0), blockSpace, 3, 40);
        scene.idle(10);
        ...
        scene.world()
                .createItemEntity(centerTop.add(0, -1.4, 0), util.vector().of(0, 0, 0), output);
        scene.idle(10);
        scene.world()
                .createItemEntity(centerTop.add(0, -1.4, 0), util.vector().of(0, 0, 0), output);
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i < 4)
                scene.effects()
                        .emitParticles(
                                util.vector().centerOf(center).add(0, -0.2, 0), blockSpace, 3, 28);
            if (i == 0) scene.markAsFinished();
        }
    }
    ...
    public static void pressing(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink<BeltItemElement> ingot =
                scene.world().createItemOnBelt(beltPos, Direction.SOUTH, copper);
        scene.idle(15);
        ElementLink<BeltItemElement> ingot2 =
                scene.world().createItemOnBelt(beltPos, Direction.SOUTH, copper);
        scene.idle(15);
    ...
    public static void mixing(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showControls(util.vector().topOf(basin), Pointing.LEFT, 30)
                .withItem(blue);
        scene.overlay()
                .showControls(util.vector().topOf(basin), Pointing.RIGHT, 30)
                .withItem(red);
        scene.idle(30);
                        ...
                        util.select().position(basin), BasinBlockEntity.class, nbt -> {
                            nbt.put(
                                    ...
                                    NBTHelper.writeCompoundList(
                                            ImmutableList.of(IntAttached.with(1, purple)),
                                            ia -> (CompoundTag) ia.getValue()
                                                    .saveOptional(scene.world()
        ...
        scene.overlay()
                ...
                .placeNearTarget()
                .attachKeyFrame()
                .text("Available recipes include any Shapeless Crafting Recipe, plus a couple"
                        + " extra ones");
        scene.idle(80);
    ...
    public static void compacting(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showControls(util.vector().topOf(basin), Pointing.DOWN, 30)
                .withItem(copper);
        scene.idle(30);
        Class<MechanicalPressBlockEntity> type = MechanicalPressBlockEntity.class;
        scene.world().modifyBlockEntity(pressPos, type, pte -> pte.getPressingBehaviour()
                ...
                .modifyBlockEntityNBT(
                        util.select().position(basin), BasinBlockEntity.class, nbt -> {
                            nbt.put(
                                    "VisualizedItems",
                                    NBTHelper.writeCompoundList(
                                            ImmutableList.of(IntAttached.with(1, copperBlock)),
                                            ia -> (CompoundTag) ia.getValue()
                                                    .saveOptional(scene.world()
                                                            .getHolderLookupProvider())));
                        });
        ...
        scene.overlay()
                ...
                .placeNearTarget()
                .attachKeyFrame()
                .text("Compacting includes any filled 2x2 or 3x3 Crafting Recipe, plus a couple"
                        + " extra ones");
                ...
                .modifyBlockEntityNBT(
                        util.select().position(basin), BasinBlockEntity.class, nbt -> {
                            nbt.put(
                                    "VisualizedItems",
                                    NBTHelper.writeCompoundList(
                                            ImmutableList.of(IntAttached.with(1, bark)),
                                            ia -> (CompoundTag) ia.getValue()
                                                    .saveOptional(scene.world()
                                                            .getHolderLookupProvider())));
                        });
    ...
    public static void emptyBlazeBurner(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        scene.overlay()
                .showControls(util.vector().centerOf(center.above(2)), Pointing.DOWN, 40)
                .rightClick()
        ...
        scene.idle(20);
        scene.overlay()
                .showControls(util.vector().topOf(center.above()), Pointing.DOWN, 40)
                .rightClick()
                .withItem(AllItems.EMPTY_BLAZE_BURNER.asStack());
        scene.idle(10);
        scene.overlay()
        ...
        scene.overlay()
                ...
                .attachKeyFrame()
                .pointAt(util.vector().blockSurface(center.west().above(), Direction.WEST))
                .placeNearTarget();
        scene.idle(80);
        ...
        scene.idle(20);
        scene.overlay()
                .showControls(util.vector().topOf(center.east().above()), Pointing.DOWN, 40)
                .rightClick()
        ...
        scene.world()
                .setBlock(
                        util.grid().at(3, 1, 2),
                        AllBlocks.LIT_BLAZE_BURNER.getDefaultState(),
                        false);
        scene.idle(10);
        scene.overlay()
                .showText(70)
                .text("For Aesthetic purposes, Empty Blaze Burners can also be lit using Flint"
                        + " and Steel")
                .attachKeyFrame()
                .pointAt(util.vector().blockSurface(center.east().above(), Direction.UP))
                .placeNearTarget();
        scene.idle(80);
        scene.overlay()
                .showControls(util.vector().topOf(center.east().above()), Pointing.DOWN, 40)
    ...
    public static void blazeBurner(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showControls(util.vector().topOf(burner), Pointing.DOWN, 15)
                .rightClick()
        ...
        scene.idle(20);
        scene.overlay()
                .showControls(util.vector().topOf(burner), Pointing.DOWN, 30)
                .rightClick()
        ...
        scene.world()
                .modifyBlock(
                        burner,
                        s -> s.setValue(BlazeBurnerBlock.HEAT_LEVEL, HeatLevel.SEETHING),
                        false);
        scene.idle(20);
    ...
    public static void basin(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .modifyBlock(basinPos, s -> s.setValue(BasinBlock.FACING, Direction.DOWN), false);
        ...
        for (int i = 0; i < 4; i++) {
            scene.world()
                    .createItemEntity(
                            util.vector().centerOf(basinPos.above(3)),
                            util.vector().of(0, 0, 0),
                            stack);
            scene.idle(10);
        }
        scene.idle(10);
        scene.overlay()
                .showControls(util.vector().topOf(basinPos), Pointing.DOWN, 30)
                .withItem(stack);
        scene.idle(30);
        ...
        scene.idle(10);
        scene.world()
                .modifyBlock(basinPos, s -> s.setValue(BasinBlock.FACING, Direction.NORTH), false);
        scene.idle(10);
        ...
        scene.idle(15);
        depot = scene.world()
                .showIndependentSection(util.select().position(0, 1, 1), Direction.EAST);
        ...
        scene.idle(15);
        depot = scene.world()
                .showIndependentSection(util.select().position(1, 1, 0), Direction.EAST);
        scene.world().moveSection(depot, util.vector().of(0, 0, 1), 0);
        scene.idle(20);
        scene.world().hideIndependentSection(depot, Direction.EAST);
        scene.idle(15);
        depot = scene.world()
                .showIndependentSection(util.select().position(1, 1, 1), Direction.EAST);
        scene.idle(20);
        scene.world().hideIndependentSection(depot, Direction.EAST);
        scene.idle(15);
        depot = scene.world()
                .showIndependentSection(util.select().fromTo(3, 1, 0, 2, 1, 0), Direction.EAST);
        scene.world().moveSection(depot, util.vector().of(-2, 0, 1), 0);
        scene.idle(20);
        scene.world().hideIndependentSection(depot, Direction.EAST);
        scene.idle(15);
        depot = scene.world()
                .showIndependentSection(util.select().position(2, 1, 1), Direction.EAST);
        scene.world().moveSection(depot, util.vector().of(-1, 0, 0), 0);
                ...
                .modifyBlockEntityNBT(
                        util.select().position(basinPos), BasinBlockEntity.class, nbt -> {
                            nbt.put(
                                    "VisualizedItems",
                                    NBTHelper.writeCompoundList(
                                            ImmutableList.of(IntAttached.with(
                                                    1, new ItemStack(Blocks.BRICKS))),
                                            ia -> (CompoundTag) ia.getValue()
                                                    .saveOptional(scene.world()
                                                            .getHolderLookupProvider())));
                        });
        scene.idle(4);
        scene.overlay()
                .showControls(util.vector().topOf(basinPos.below().north()), Pointing.RIGHT, 30)
        ...
        scene.overlay()
                .showText(80)
                .attachKeyFrame()
                .text("Without output faucet, the Basin will retain items created in its"
                        + " processing")
                .pointAt(basinSide)
                .placeNearTarget();
        scene.idle(50);
        ...
        scene.overlay()
                .showControls(util.vector().topOf(basinPos), Pointing.RIGHT, 30)
                .withItem(nugget);
        scene.idle(30);
        scene.world().modifyBlockEntity(pressPos, type, pte -> pte.getPressingBehaviour()
                .start(Mode.BASIN));
        ...
        scene.overlay()
                ...
                .pointAt(util.vector().topOf(util.grid().at(3, 1, 2)).subtract(0, 3 / 16f, 0))
                .placeNearTarget();
        scene.idle(80);
