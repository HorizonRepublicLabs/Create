...
public class TrackObserverScenes {
    ...
    public static void observe(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay()
                .showControls(target, Pointing.DOWN, 40)
                .rightClick()
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, bb, bb.inflate(.45f, 1 / 16f, .45f), 60);
        scene.idle(10);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.GREEN, bb, new AABB(util.grid().at(5, 1, 4)), 20);
        scene.idle(25);
        ...
        ElementLink<WorldSectionElement> trainInstance1 =
                scene.world().showIndependentSection(train1, Direction.WEST);
        ...
        ElementLink<ParrotElement> birb = scene.special()
                .createBirb(
                        util.vector().centerOf(12, 3, 7), ParrotPose.FacePointOfInterestPose::new);
        scene.special().moveParrot(birb, util.vector().of(-16, 0, 0), 80);
        scene.idle(10);

        ElementLink<WorldSectionElement> trainInstance2 =
                scene.world().showIndependentSection(train2, Direction.WEST);
