...
public class SteamScenes {
    ...
    public static void whistle(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        ElementLink<WorldSectionElement> boilerElement =
                scene.world().showIndependentSectionImmediately(boiler);
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(2, 3, 1), Direction.EAST),
                        Pointing.RIGHT,
                        50)
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(2, 3, 1), Direction.DOWN),
                        Pointing.UP,
                        80)
    ...
    public static void engine(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world()
                .modifyBlock(
                        util.grid().at(4, 2, 7),
                        s -> s.setValue(PumpBlock.FACING, Direction.SOUTH),
                        false);
        scene.world()
                .modifyBlock(
                        util.grid().at(1, 2, 7),
        ...
        ElementLink<WorldSectionElement> engineElement =
                scene.world().showIndependentSection(engine, Direction.EAST);
        scene.world().moveSection(engineElement, util.vector().of(1, -1, 0), 0);
        scene.idle(15);
        scene.world().moveSection(tankElement, util.vector().of(0, -1000, 0), 0);
        scene.world().hideIndependentSection(tankElement, null);
        ElementLink<WorldSectionElement> boilerElement =
                scene.world().showIndependentSectionImmediately(boiler1);
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(3, 1, 3), Direction.UP),
                        Pointing.DOWN,
                        60)
        ...
        scene.world()
                .setBlock(
                        engine1ShaftPos,
                        AllBlocks.SHAFT.getDefaultState().setValue(ShaftBlock.AXIS, Axis.Z),
                        false);
        ElementLink<WorldSectionElement> engineShaftElement =
                scene.world().showIndependentSection(engine1Shaft, null);
        ...
        scene.world()
                .setBlock(
                        engine1ShaftPos,
                        AllBlocks.POWERED_SHAFT.getDefaultState().setValue(ShaftBlock.AXIS, Axis.Z),
                        false);
        ...
        scene.overlay()
                .showOutlineWithText(util.select().fromTo(5, 2, 3, 4, 2, 4), 50)
                .attachKeyFrame()
        ...
        scene.idle(15);
        ElementLink<WorldSectionElement> burnersElement =
                scene.world().showIndependentSection(burners, Direction.SOUTH);
        scene.world().moveSection(burnersElement, util.vector().of(2, 0, 0), 0);
        scene.idle(25);

        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(4, 1, 3), Direction.EAST),
                        Pointing.RIGHT,
                        60)
        ...
        scene.idle(10);
        ElementLink<WorldSectionElement> pumpElement =
                scene.world().showIndependentSection(pump2, Direction.DOWN);
        ...
        scene.overlay()
                .showControls(target.add(0, 0, 0.5), Pointing.DOWN, 60)
                .withItem(AllItems.GOGGLES.asStack());
        scene.idle(6);
        scene.overlay()
                .showText(80)
        ...
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(3, 4, 6, 1, 4, 6), Direction.EAST, boilerElement);
        scene.idle(5);
        scene.world().setKineticSpeed(util.select().position(1, 4, 6), 64);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(3, 5, 6, 1, 5, 6), Direction.EAST, boilerElement);
        scene.idle(5);
        scene.world().setKineticSpeed(util.select().position(1, 5, 6), -64);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(3, 5, 5, 1, 5, 5), Direction.EAST, boilerElement);
        scene.idle(5);
        scene.world().setKineticSpeed(util.select().position(1, 5, 5), -64);
        scene.world()
                .showSectionAndMerge(
                        util.select().fromTo(1, 4, 7, 1, 5, 7), Direction.NORTH, boilerElement);
        scene.idle(5);
        ...
        scene.overlay()
                .showText(100)
                .text("With each added power level, an additional Engine can output at full"
                        + " capacity")
                .attachKeyFrame()
        ...
        scene.idle(40);
        scene.overlay()
                .showOutlineWithText(util.select().fromTo(3, 2, 3, 3, 3, 4), 30)
                .text("4 Engines")
                .colored(PonderPalette.BLUE)
        ...
        scene.overlay()
                .showControls(util.vector().of(5, 2, 4), Pointing.DOWN, 10)
        ...
        scene.world()
                .setBlocks(
                        ...
                        AllBlocks.BLAZE_BURNER
                                .getDefaultState()
                                .setValue(BlazeBurnerBlock.HEAT_LEVEL, HeatLevel.SEETHING),
                        false);
        scene.idle(15);
        ...
        for (int y = 4; y < 9; y++) {
            ...
            scene.world()
                    .showSectionAndMerge(
                            util.select().position(1, y, 7), Direction.NORTH, cogsElement);
        ...
        scene.idle(40);
        scene.overlay()
                .showOutlineWithText(util.select().fromTo(3, 2, 3, 3, 6, 4), 30)
                .text("8 Engines")
                .colored(PonderPalette.BLUE)
                .pointAt(util.vector().blockSurface(util.grid().at(3, 3, 4), Direction.UP))
                .placeNearTarget();
