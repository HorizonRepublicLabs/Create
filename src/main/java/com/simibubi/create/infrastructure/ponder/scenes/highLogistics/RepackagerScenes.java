...
public class RepackagerScenes {
    ...
    public static void repackager(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        Selection belt3 =
                util.select().fromTo(5, 1, 1, 5, 1, 6).add(util.select().fromTo(6, 1, 5, 6, 1, 6));
        ...
        scene.overlay()
                .showText(120)
                .text("Sometimes, it is crucial for logistical requests to arrive as a single"
                        + " package")
                .attachKeyFrame()
                .placeNearTarget()
                .independent(130);
        ...
        AABB bb1 = new AABB(util.grid().at(2, 2, 1))
                .deflate(0.125, 0.5, 0.125)
                .inflate(0.65, 0, 0)
                .move(1.05, -.5, 0);
        ...
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.INPUT, pack, new AABB(bb1.getCenter(), bb1.getCenter()), 1);
        scene.overlay()
                .chaseBoundingBoxOutline(
                        PonderPalette.OUTPUT,
                        repack,
                        new AABB(bb2.getCenter(), bb2.getCenter()),
                        1);
        scene.idle(1);
        ...
        scene.overlay()
                ...
                .pointAt(util.vector().of(7, 2, 1.5))
                .placeNearTarget();
        scene.idle(60);
        ...
        scene.overlay()
                ...
                .pointAt(util.vector().of(5.5, 2, 3))
                .placeNearTarget();
        scene.idle(60);
        ...
        scene.overlay()
                .showControls(
                        util.vector().blockSurface(util.grid().at(2, 3, 5), Direction.NORTH),
                        Pointing.DOWN,
                        40)
        ...
        scene.overlay()
                ...
                .attachKeyFrame()
                .pointAt(util.vector().blockSurface(util.grid().at(5, 2, 1), Direction.WEST))
                .placeNearTarget();
        scene.idle(90);
        ...
        scene.overlay()
                ...
                .pointAt(util.vector().blockSurface(util.grid().at(2, 3, 5), Direction.NORTH))
                .placeNearTarget();
    ...
    private static void insertItemsIntoCrafter(
            SceneBuildingUtil util, CreateSceneBuilder scene, ItemStack stack) {
