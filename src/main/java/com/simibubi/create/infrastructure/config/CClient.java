...
public class CClient extends ConfigBase {
    ...
    public final ConfigBool enableOverstressedTooltip =
            b(true, "enableOverstressedTooltip", Comments.enableOverstressedTooltip);
    public final ConfigBool explainRenderErrors =
            b(false, "explainRenderErrors", Comments.explainRenderErrors);
    public final ConfigFloat fanParticleDensity =
    ...
    public final ConfigInt ingameMenuConfigButtonRow =
            i(3, 0, 5, "ingameMenuConfigButtonRow", Comments.ingameMenuConfigButtonRow);
    ...
    public final ConfigBool ignoreFabulousWarning =
            b(false, "ignoreFabulousWarning", Comments.ignoreFabulousWarning);
    public final ConfigBool rotateWhenSeated =
            b(true, "rotateWhenSeated", Comments.rotatewhenSeated);
    ...
    public final ConfigInt overlayOffsetX =
            i(20, Integer.MIN_VALUE, Integer.MAX_VALUE, "overlayOffsetX", Comments.overlayOffset);
    public final ConfigInt overlayOffsetY =
            i(0, Integer.MIN_VALUE, Integer.MAX_VALUE, "overlayOffsetY", Comments.overlayOffset);
    public final ConfigBool overlayCustomColor =
            b(false, "customColorsOverlay", Comments.overlayCustomColor);
    ...
    public final ConfigBool enableAmbientSounds =
            b(true, "enableAmbientSounds", Comments.enableAmbientSounds);
    ...
    public final ConfigFloat mountedZoomMultiplier =
            f(3, 0, "mountedZoomMultiplier", Comments.mountedZoomMultiplier);
    public final ConfigBool showTrackGraphOnF3 =
            b(false, "showTrackGraphOnF3", Comments.showTrackGraphOnF3);
    public final ConfigBool showExtendedTrackGraphOnF3 =
            b(false, "showExtendedTrackGraphOnF3", Comments.showExtendedTrackGraphOnF3);
    public final ConfigBool showTrainMapOverlay =
            b(true, "showTrainMapOverlay", Comments.showTrainMapOverlay);
    ...
    private static class Comments {
        static String client =
                "Client-only settings - If you're looking for general settings, look inside your"
                        + " worlds serverconfig folder!";
        static String tooltips = "Show item descriptions on Shift and controls on Ctrl.";
        static String enableOverstressedTooltip =
                "Display a tooltip when looking at overstressed components.";
        static String explainRenderErrors =
        ...
        static String[] mainMenuConfigButtonOffsetX = new String[] {
            ...
            "The sign (-/+) of this value determines what side of the row the button appears on"
                    + " (left/right)"
        };
        ...
        static String ignoreFabulousWarning =
                "Setting this to true will prevent Create from sending you a warning when playing"
                        + " with Fabulous graphics enabled";
        static String rotatewhenSeated =
        ...
        static String overlayOffset =
                "Offset the overlay from goggle- and hover- information by this many pixels on the"
                        + " respective axis; Use /create overlay";
        static String overlayCustomColor =
        ...
        static String[] overlayBorderColorTop = new String[] {
            "The custom top color of the border gradient to use for the Goggle- and Hover-"
                    + " Overlays, if enabled",
            "[in Hex: #AaRrGgBb]",
            ConfigAnnotations.IntDisplay.HEX.asComment()
        };
        static String[] overlayBorderColorBot = new String[] {
            "The custom bot color of the border gradient to use for the Goggle- and Hover-"
                    + " Overlays, if enabled",
            "[in Hex: #AaRrGgBb]",
            ConfigAnnotations.IntDisplay.HEX.asComment()
        };
        ...
        static String honeyTransparencyMultiplier =
