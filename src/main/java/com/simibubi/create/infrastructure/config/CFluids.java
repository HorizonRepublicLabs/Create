...
public class CFluids extends ConfigBase {
    ...
    public final ConfigInt fluidTankCapacity =
            i(8, 1, "fluidTankCapacity", Comments.buckets, Comments.fluidTankCapacity);
    public final ConfigInt fluidTankMaxHeight =
            i(32, 1, "fluidTankMaxHeight", Comments.blocks, Comments.fluidTankMaxHeight);
    public final ConfigInt mechanicalPumpRange =
            i(16, 1, "mechanicalPumpRange", Comments.blocks, Comments.mechanicalPumpRange);

    public final ConfigInt hosePulleyRange =
            i(128, 1, "hosePulleyRange", Comments.blocks, Comments.hosePulleyRange);
    ...
    public final ConfigEnum<BottomlessFluidMode> bottomlessFluidMode = e(
            BottomlessFluidMode.ALLOW_BY_TAG, "bottomlessFluidMode", Comments.bottomlessFluidMode);

    public ConfigBool fluidFillPlaceFluidSourceBlocks =
            b(true, "fluidFillPlaceFluidSourceBlocks", Comments.fluidFillPlaceFluidSourceBlocks);
    public ConfigBool pipesPlaceFluidSourceBlocks =
            b(true, "pipesPlaceFluidSourceBlocks", Comments.pipesPlaceFluidSourceBlocks);
    ...
    private static class Comments {
        ...
        static String hosePulleyRange =
                "The maximum distance a hose pulley can draw fluid blocks from.";
        static String hosePulleyBlockThreshold =
                "The minimum amount of fluid blocks the hose pulley needs to find before deeming"
                        + " it an infinite source.";
        static String fillInfinite =
        ...
        static String fluidFillPlaceFluidSourceBlocks =
                "Whether hose pulleys should be allowed to place fluid sources.";
        static String pipesPlaceFluidSourceBlocks =
