...
public class CRecipes extends ConfigBase {
    ...
    public final ConfigBool allowBrewingInMixer =
            b(true, "allowBrewingInMixer", Comments.allowBrewingInMixer);
    public final ConfigBool allowShapelessInMixer =
            b(true, "allowShapelessInMixer", Comments.allowShapelessInMixer);
    public final ConfigBool allowShapedSquareInPress =
            b(true, "allowShapedSquareInPress", Comments.allowShapedSquareInPress);
    ...
    public final ConfigBool allowStonecuttingOnSaw =
            b(true, "allowStonecuttingOnSaw", Comments.allowStonecuttingOnSaw);
    public final ConfigBool allowCastingBySpout =
            b(true, "allowCastingBySpout", Comments.allowCastingBySpout);
    public final ConfigBool displayLogStrippingRecipes =
            b(true, "displayLogStrippingRecipes", Comments.displayLogStrippingRecipes);
    ...
    public final ConfigBool enableShadowSteelRecipe =
            b(true, "enableShadowSteelRecipe", Comments.shadowSteelRecipe);
    ...
    private static class Comments {
        ...
        static String allowBrewingInMixer =
                "Allow supported potions to be brewed by a Mechanical Mixer + Basin.";
        static String allowShapelessInMixer =
                "Allow any shapeless crafting recipes to be processed by a Mechanical Mixer +"
                        + " Basin.";
        static String allowShapedSquareInPress =
                "Allow any single-ingredient 2x2 or 3x3 crafting recipes to be processed by a"
        ...
        static String maxFireworkIngredientsInCrafter =
                "The Maximum amount of ingredients that can be used to craft Firework Rockets using"
                        + " Mechanical Crafters.";
        ...
        static String refinedRadiance =
                "The amount of Light sources destroyed before Chromatic Compound turns into Refined"
                        + " Radiance.";
        static String refinedRadianceRecipe =
                "Allow the standard in-world Refined Radiance recipes.";
        static String shadowSteelRecipe = "Allow the standard in-world Shadow Steel recipe.";
        static String displayLogStrippingRecipes =
