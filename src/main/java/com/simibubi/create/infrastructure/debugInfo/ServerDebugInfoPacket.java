...
public record ServerDebugInfoPacket(String serverInfo) implements ClientboundPacketPayload {
    public static final StreamCodec<ByteBuf, ServerDebugInfoPacket> STREAM_CODEC =
    ...
    public void handle(LocalPlayer player) {
        ...
        CreateLang.translate("command.debuginfo.saved_to_clipboard")
                .color(DyeHelper.getDyeColors(DyeColor.LIME).getFirst())
                .sendChat(player);
    }
    ...
    private static void printInfo(
            String side, Player player, List<DebugInfoSection> sections, StringBuilder output) {
