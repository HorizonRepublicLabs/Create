...
public class DebugInformation {
            ...
            DebugInfoSection.builder("Graphics")
                    .put(
                            ...
                            ModList.get()
                                    ...
                                    .orElse("None"))
                    .put("Flywheel Backend", () -> Backend.REGISTRY
                            .getIdOrThrow(BackendManager.currentBackend())
                            .toString())
                    .put("OpenGL Renderer", GlUtil::getRenderer)
                    .put("OpenGL Version", GlUtil::getOpenGLVersion)
                    .put("Graphics Mode", () -> Minecraft.getInstance()
                            .options
                            .graphicsMode()
                            .get()
                            .name()
    ...
    public static String getCpuInfo() {
        ...
        return String.format(
                "%s @ %s GHz; %s cores / %s threads on %s socket(s)",
                name, freq, cores, threads, sockets);
    }
