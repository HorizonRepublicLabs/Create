...
public class TagLangGenerator {
    ...
    public void generate() {
        ...
        translate(
                AllBlockTags.FAN_PROCESSING_CATALYSTS_BLASTING,
                AllFluidTags.FAN_PROCESSING_CATALYSTS_BLASTING,
                "Blasting Catalysts");
        translate(
                AllBlockTags.FAN_PROCESSING_CATALYSTS_HAUNTING,
                AllFluidTags.FAN_PROCESSING_CATALYSTS_HAUNTING,
                "Haunting Catalysts");
        translate(
                AllBlockTags.FAN_PROCESSING_CATALYSTS_SMOKING,
                AllFluidTags.FAN_PROCESSING_CATALYSTS_SMOKING,
                "Smoking Catalysts");
        translate(
                AllBlockTags.FAN_PROCESSING_CATALYSTS_SPLASHING,
                AllFluidTags.FAN_PROCESSING_CATALYSTS_SPLASHING,
                "Splashing Catalysts");
        ...
        translate(
                AllBlockTags.CARDBOARD_STORAGE_BLOCKS,
                AllItemTags.CARDBOARD_STORAGE_BLOCKS,
                "Cardboard Storage Blocks");
        translate(
                AllBlockTags.ANDESITE_ALLOY_STORAGE_BLOCKS,
                AllItemTags.ANDESITE_ALLOY_STORAGE_BLOCKS,
                "Andesite Alloy Storage Blocks");
        ...
        translate(
                AllContraptionTypeTags.REQUIRES_VEHICLE_FOR_RENDER.tag,
                "Requires a Vehicle to Render");
    ...
    protected static String keyFor(TagKey<?> tag) {
        ...
        String registry = sanitize(
                registryId.getNamespace().equals("minecraft")
                        ? registryId.getPath()
                        : registryId.toLanguageKey());
