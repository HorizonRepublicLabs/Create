...
public class CreateRegistrateTags {
	...
	private static final Block[] SHULKER_BOXES = {
		Blocks.SHULKER_BOX,
		Blocks.DYED_SHULKER_BOX.white(), Blocks.DYED_SHULKER_BOX.orange(), Blocks.DYED_SHULKER_BOX.magenta(), Blocks.DYED_SHULKER_BOX.lightBlue(),
		Blocks.DYED_SHULKER_BOX.yellow(), Blocks.DYED_SHULKER_BOX.lime(), Blocks.DYED_SHULKER_BOX.pink(), Blocks.DYED_SHULKER_BOX.gray(),
		Blocks.DYED_SHULKER_BOX.lightGray(), Blocks.DYED_SHULKER_BOX.cyan(), Blocks.DYED_SHULKER_BOX.purple(), Blocks.DYED_SHULKER_BOX.blue(),
		Blocks.DYED_SHULKER_BOX.brown(), Blocks.DYED_SHULKER_BOX.green(), Blocks.DYED_SHULKER_BOX.red(), Blocks.DYED_SHULKER_BOX.black()
	};
