...
public class CreateRegistrateTags {
    ...
    private static void genBlockTags(RegistrateTagsProvider<Block> provIn) {
        CreateTagsProvider<Block> prov =
                new CreateTagsProvider<>(provIn, Block::builtInRegistryHolder);
        ...
        prov.tag(AllBlockTags.SAFE_NBT.tag).addTag(BlockTags.BANNERS).addTag(BlockTags.ALL_SIGNS);
        ...
        prov.tag(AllBlockTags.SUGAR_CANE_VARIANTS.tag).add(Blocks.SUGAR_CANE);

        prov.tag(AllBlockTags.NON_HARVESTABLE.tag).add(Blocks.FIRE);
        ...
        TagGen.addOptional(
                prov.tag(AllBlockTags.NON_MOVABLE.tag),
                Mods.IE,
                List.of(
                        "connector_lv",
                        "connector_lv_relay",
    ...
    private static void genItemTags(RegistrateTagsProvider<Item> provIn) {
        ...
        TagGen.addOptional(
                prov.tag(AllItemTags.UA_CORAL.tag),
                Mods.UA,
                List.of(
                        "acan_coral",
                        "finger_coral",
    ...
    private static void genFluidTags(RegistrateTagsProvider<Fluid> provIn) {
        CreateTagsProvider<Fluid> prov =
                new CreateTagsProvider<>(provIn, Fluid::builtInRegistryHolder);
    ...
    private static void genEntityTags(RegistrateTagsProvider<EntityType<?>> provIn) {
        CreateTagsProvider<EntityType<?>> prov =
                new CreateTagsProvider<>(provIn, EntityType::builtInRegistryHolder);
