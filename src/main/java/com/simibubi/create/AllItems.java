...
public class AllItems {
    ...
    public static final ItemEntry<Item>
            ...
            STURDY_SHEET =
                    taggedIngredient("sturdy_sheet", AllItemTags.OBSIDIAN_PLATES.tag, PLATES.tag),
    ...
    public static final ItemEntry<Item> CARDBOARD = REGISTRATE
    ...
    public static final ItemEntry<Item> BLAZE_CAKE_BASE = REGISTRATE
            .item("blaze_cake_base", Item::new)
            .tag(AllItemTags.UPRIGHT_ON_BELT.tag)
            .register();

    public static final ItemEntry<Item> BLAZE_CAKE = REGISTRATE
    ...
    public static final ItemEntry<Item> CREATIVE_BLAZE_CAKE = REGISTRATE
    ...
    public static final ItemEntry<Item> BAR_OF_CHOCOLATE = REGISTRATE
            .item("bar_of_chocolate", Item::new)
    ...
    public static final ItemEntry<Item> SWEET_ROLL = REGISTRATE
            .item("sweet_roll", Item::new)
            .tag(Items.FOODS)
            .properties(p -> p.food(new FoodProperties.Builder()
                    .nutrition(6)
    ...
    public static final ItemEntry<Item> CHOCOLATE_BERRIES = REGISTRATE
            .item("chocolate_glazed_berries", Item::new)
    ...
    public static final ItemEntry<Item> HONEYED_APPLE = REGISTRATE
            .item("honeyed_apple", Item::new)
    ...
    public static final ItemEntry<BuildersTeaItem> BUILDERS_TEA = REGISTRATE
            .item("builders_tea", BuildersTeaItem::new)
            .tag(
                    AllItemTags.UPRIGHT_ON_BELT.tag,
                    Items.FOODS,
                    Items.DRINKS,
                    AllItemTags.DRINKS_TEA.tag)
    ...
    public static final ItemEntry<CardboardSwordItem> CARDBOARD_SWORD = REGISTRATE
            .item("cardboard_sword", CardboardSwordItem::new)
            .burnTime(1000)
            .properties(p -> p.stacksTo(1))
            .properties(
                    p -> p.attributes(SwordItem.createAttributes(AllToolMaterials.CARDBOARD, 3, 1)))
    ...
    public static final ItemEntry<Item>
            ...
            BRASS_INGOT =
                    taggedIngredient("brass_ingot", CommonMetal.BRASS.ingots, CREATE_INGOTS.tag);

    public static final ItemEntry<ChromaticCompoundItem> CHROMATIC_COMPOUND = REGISTRATE
            .item("chromatic_compound", ChromaticCompoundItem::new)
            .properties(p -> p.rarity(Rarity.UNCOMMON))
            .model(AssetLookup.existingItemModel())
            .color(() -> ChromaticCompoundColor::new)
            .register();

    public static final ItemEntry<ShadowSteelItem> SHADOW_STEEL = REGISTRATE
            .item("shadow_steel", ShadowSteelItem::new)
            .properties(p -> p.rarity(Rarity.UNCOMMON))
            .register();

    public static final ItemEntry<RefinedRadianceItem> REFINED_RADIANCE = REGISTRATE
            .item("refined_radiance", RefinedRadianceItem::new)
            .properties(p -> p.rarity(Rarity.UNCOMMON))
            .register();
    ...
    public static final ItemEntry<Item>
            COPPER_NUGGET =
                    taggedIngredient(
                            "copper_nugget", CommonMetal.COPPER.nuggets, Tags.Items.NUGGETS),
            ZINC_NUGGET =
                    taggedIngredient("zinc_nugget", CommonMetal.ZINC.nuggets, Tags.Items.NUGGETS),
            BRASS_NUGGET =
                    taggedIngredient("brass_nugget", CommonMetal.BRASS.nuggets, Tags.Items.NUGGETS);

    public static final ItemEntry<ExperienceNuggetItem> EXP_NUGGET = REGISTRATE
            .item("experience_nugget", ExperienceNuggetItem::new)
    ...
    public static final ItemEntry<Item>
            COPPER_SHEET = taggedIngredient("copper_sheet", CommonMetal.COPPER.plates, PLATES.tag),
            ...
            CRUSHED_GOLD =
                    taggedIngredient(
                            "crushed_raw_gold", CRUSHED_RAW_MATERIALS.tag, ItemTags.PIGLIN_LOVED),
    ...
    public static final ItemEntry<BeltConnectorItem> BELT_CONNECTOR = REGISTRATE
            .item("belt_connector", BeltConnectorItem::new)
            .lang("Mechanical Belt")
            .register();

    public static final ItemEntry<VerticalGearboxItem> VERTICAL_GEARBOX = REGISTRATE
            .item("vertical_gearbox", VerticalGearboxItem::new)
            .model(AssetLookup.customBlockItemModel("gearbox", "item_vertical"))
            .register();

    public static final ItemEntry<BlazeBurnerBlockItem> EMPTY_BLAZE_BURNER = REGISTRATE
            .item("empty_blaze_burner", BlazeBurnerBlockItem::empty)
            .model(AssetLookup.customBlockItemModel("blaze_burner", "block"))
            .register();

    public static final ItemEntry<GogglesItem> GOGGLES = REGISTRATE
            .item("goggles", GogglesItem::new)
            .properties(p -> p.stacksTo(1))
            .onRegister(CreateRegistrate.itemModel(() -> GogglesModel::new))
            .lang("Engineer's Goggles")
            .register();

    public static final ItemEntry<SuperGlueItem> SUPER_GLUE = REGISTRATE
    ...
    public static final ItemEntry<MinecartCouplingItem> MINECART_COUPLING =
            REGISTRATE.item("minecart_coupling", MinecartCouplingItem::new).register();

    public static final ItemEntry<BlueprintItem> CRAFTING_BLUEPRINT =
            REGISTRATE.item("crafting_blueprint", BlueprintItem::new).register();
    ...
    public static final ItemEntry<BacktankBlockItem> COPPER_BACKTANK_PLACEABLE = REGISTRATE
            .item(
                    ...
                    p -> new BacktankBlockItem(
                            AllBlocks.COPPER_BACKTANK.get(), AllItems.COPPER_BACKTANK::get, p))
                    ...
                    REGISTRATE
                            .item(
                                    ...
                                    p -> new DivingHelmetItem(
                                            ...
                                            Create.asResource("netherite_diving")))
                            .properties(p ->
                                    p.fireResistant().durability(Type.HELMET.getDurability(37)))
                            .tag(ItemTags.HEAD_ARMOR)
                            .register();
                    ...
                    REGISTRATE
                            .item(
                                    ...
                                    p -> new DivingBootsItem(
                                            ...
                                            Create.asResource("netherite_diving")))
                            .properties(
                                    p -> p.fireResistant().durability(Type.BOOTS.getDurability(37)))
                            .tag(ItemTags.FOOT_ARMOR)
                            .register();
    ...
    public static final ItemEntry<SandPaperItem> SAND_PAPER = REGISTRATE
            .item("sand_paper", SandPaperItem::new)
            .tag(AllTags.AllItemTags.SANDPAPER.tag)
            .register();

    public static final ItemEntry<SandPaperItem> RED_SAND_PAPER = REGISTRATE
            .item("red_sand_paper", SandPaperItem::new)
            .tag(AllTags.AllItemTags.SANDPAPER.tag)
            .onRegister(s -> ItemDescription.referKey(s, SAND_PAPER))
            .register();

    public static final ItemEntry<WrenchItem> WRENCH = REGISTRATE
            .item("wrench", WrenchItem::new)
            .properties(p -> p.stacksTo(1))
            .model(AssetLookup.itemModelWithPartials())
            .tag(Items.TOOLS_WRENCH)
            .register();

    public static final ItemEntry<MinecartContraptionItem> MINECART_CONTRAPTION = REGISTRATE
            .item("minecart_contraption", MinecartContraptionItem::rideable)
            .register();

    public static final ItemEntry<MinecartContraptionItem> FURNACE_MINECART_CONTRAPTION = REGISTRATE
            .item("furnace_minecart_contraption", MinecartContraptionItem::furnace)
            .register();

    public static final ItemEntry<MinecartContraptionItem> CHEST_MINECART_CONTRAPTION = REGISTRATE
            .item("chest_minecart_contraption", MinecartContraptionItem::chest)
            .register();

    // Curiosities

    public static final ItemEntry<LinkedControllerItem> LINKED_CONTROLLER = REGISTRATE
            .item("linked_controller", LinkedControllerItem::new)
            .properties(p -> p.stacksTo(1))
            .model(AssetLookup.itemModelWithPartials())
            .register();

    public static final ItemEntry<PotatoCannonItem> POTATO_CANNON = REGISTRATE
            .item("potato_cannon", PotatoCannonItem::new)
            .properties(p -> p.durability(100))
            .model(AssetLookup.itemModelWithPartials())
            .tag(Tags.Items.ENCHANTABLES, ItemTags.DURABILITY_ENCHANTABLE, ItemTags.BOW_ENCHANTABLE)
            .register();

    public static final ItemEntry<ExtendoGripItem> EXTENDO_GRIP = REGISTRATE
            .item("extendo_grip", ExtendoGripItem::new)
            .properties(p -> p.rarity(Rarity.UNCOMMON))
            .tag(ItemTags.DURABILITY_ENCHANTABLE)
            .model(AssetLookup.itemModelWithPartials())
            .register();

    public static final ItemEntry<SymmetryWandItem> WAND_OF_SYMMETRY = REGISTRATE
            .item("wand_of_symmetry", SymmetryWandItem::new)
            .properties(p -> p.stacksTo(1).rarity(Rarity.UNCOMMON))
            .model(AssetLookup.itemModelWithPartials())
            .register();

    public static final ItemEntry<WorldshaperItem> WORLDSHAPER = REGISTRATE
            .item("handheld_worldshaper", WorldshaperItem::new)
            .properties(p -> p.rarity(Rarity.EPIC))
    ...
    public static final ItemEntry<TreeFertilizerItem> TREE_FERTILIZER =
            REGISTRATE.item("tree_fertilizer", TreeFertilizerItem::new).register();
    ...
    static {
        ...
        for (PackageStyle style : PackageStyles.STYLES) {
            ItemBuilder<PackageItem, CreateRegistrate> packageItem =
    ...
    public static final ItemEntry<ListFilterItem> FILTER =
            REGISTRATE.item("filter", FilterItem::regular).lang("List Filter").register();

    public static final ItemEntry<AttributeFilterItem> ATTRIBUTE_FILTER =
            REGISTRATE.item("attribute_filter", FilterItem::attribute).register();

    public static final ItemEntry<PackageFilterItem> PACKAGE_FILTER =
            REGISTRATE.item("package_filter", FilterItem::address).register();

    public static final ItemEntry<ScheduleItem> SCHEDULE = REGISTRATE
            .item("schedule", ScheduleItem::new)
            .lang("Train Schedule")
            .register();

    public static final ItemEntry<ShoppingListItem> SHOPPING_LIST = REGISTRATE
            .item("shopping_list", ShoppingListItem::new)
            .properties(p -> p.stacksTo(1))
            .register();

    // Schematics

    public static final ItemEntry<Item> EMPTY_SCHEMATIC = REGISTRATE
            .item("empty_schematic", Item::new)
            .properties(p -> p.stacksTo(1))
            .register();

    public static final ItemEntry<SchematicAndQuillItem> SCHEMATIC_AND_QUILL = REGISTRATE
            .item("schematic_and_quill", SchematicAndQuillItem::new)
            .properties(p -> p.stacksTo(1))
            .register();

    public static final ItemEntry<SchematicItem> SCHEMATIC = REGISTRATE
            .item("schematic", SchematicItem::new)
            .properties(p -> p.stacksTo(1))
            .register();
