...
public enum AllParticleTypes {
    ...
    <D extends ParticleOptions> AllParticleTypes(
    ...
    public static void registerFactories(RegisterParticleProvidersEvent event) {
        for (AllParticleTypes particle : values()) particle.entry.registerFactory(event);
    }
    ...
    private static class ParticleEntry<D extends ParticleOptions> {
        private static final DeferredRegister<ParticleType<?>> REGISTER =
                DeferredRegister.create(Registries.PARTICLE_TYPE, Create.ID);
