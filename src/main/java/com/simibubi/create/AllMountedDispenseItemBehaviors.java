...
public class AllMountedDispenseItemBehaviors {
    ...
    private static final MountedDispenseBehavior FIREWORK = new DefaultMountedDispenseBehavior() {
        ...
        protected ItemStack execute(
            ...
            FireworkRocketEntity firework =
                    new FireworkRocketEntity(context.world, stack, x, y, z, true);
    ...
    private static final MountedDispenseBehavior FIRE_CHARGE =
            new DefaultMountedDispenseBehavior() {
                @Override
                protected ItemStack execute(
                        ItemStack stack, MovementContext context, BlockPos pos, Vec3 facing) {
    ...
    private static final MountedDispenseBehavior BUCKET = new DefaultMountedDispenseBehavior() {
        ...
        protected ItemStack execute(
            ...
            BlockPos interactionPos =
                    pos.relative(MountedDispenseBehavior.getClosestFacingDirection(facing));
    ...
    private static final MountedDispenseBehavior POTIONS = new MountedProjectileDispenseBehavior() {
        ...
        protected Projectile getProjectile(
                Level level, double x, double y, double z, ItemStack stack, Direction facing) {
    ...
    private static final MountedDispenseBehavior BOTTLE = new OptionalMountedDispenseBehavior() {
        ...
        protected ItemStack doExecute(
            ...
            if (block instanceof BeehiveBlock hive
                ...
                MountedDispenseBehavior.placeItemInInventory(
                        new ItemStack(Items.HONEY_BOTTLE), context, pos);
                stack.shrink(1);
                return stack;
    ...
    public static void registerDefaults() {
        MountedDispenseBehavior.REGISTRY.registerProvider(
                item -> item instanceof SpawnEggItem ? SPAWN_EGG : null);
