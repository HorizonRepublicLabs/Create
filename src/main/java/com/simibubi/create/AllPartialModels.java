...
public class AllPartialModels {
    ...
    public static final PartialModel SCHEMATICANNON_CONNECTOR = block("schematicannon/connector"),
            ...
            SHAFTLESS_LARGE_COGWHEEL = block("large_cogwheel_shaftless"),
            COGWHEEL_SHAFT = block("cogwheel_shaft"),
            SHAFT_HALF = block("shaft_half"),
            SHAFT = block("shaft"),
            COGWHEEL = block("cogwheel"),
            BELT_PULLEY = block("belt_pulley"),
            BELT_START = block("belt/start"),
            BELT_MIDDLE = block("belt/middle"),
            BELT_END = block("belt/end"),
            BELT_START_BOTTOM = block("belt/start_bottom"),
            BELT_MIDDLE_BOTTOM = block("belt/middle_bottom"),
            BELT_END_BOTTOM = block("belt/end_bottom"),
            BELT_DIAGONAL_START = block("belt/diagonal_start"),
            BELT_DIAGONAL_MIDDLE = block("belt/diagonal_middle"),
            ...
            ENCASED_FAN_INNER = block("encased_fan/propeller"),
            HAND_CRANK_HANDLE = block("hand_crank/handle"),
            ...
            GAUGE_HEAD_SPEED = block("gauge/speedometer/head"),
            GAUGE_HEAD_STRESS = block("gauge/stressometer/head"),
            BEARING_TOP = block("bearing/top"),
            BEARING_TOP_WOODEN = block("bearing/top_wooden"),
            DRILL_HEAD = block("mechanical_drill/head"),
            HARVESTER_BLADE = block("mechanical_harvester/blade"),
            DEPLOYER_POLE = block("deployer/pole"),
            DEPLOYER_HAND_POINTING = block("deployer/hand_pointing"),
            DEPLOYER_HAND_PUNCHING = block("deployer/hand_punching"),
            DEPLOYER_HAND_HOLDING = block("deployer/hand_holding"),
            ANALOG_LEVER_HANDLE = block("analog_lever/handle"),
            ANALOG_LEVER_INDICATOR = block("analog_lever/indicator"),
            FUNNEL_FLAP = block("funnel/flap"),
            BELT_FUNNEL_FLAP = block("belt_funnel/flap"),
            BELT_TUNNEL_FLAP = block("belt_tunnel/flap"),
            ...
            CUCKOO_MINUTE_HAND = block("cuckoo_clock/minute_hand"),
            CUCKOO_HOUR_HAND = block("cuckoo_clock/hour_hand"),
            CUCKOO_LEFT_DOOR = block("cuckoo_clock/left_door"),
            CUCKOO_RIGHT_DOOR = block("cuckoo_clock/right_door"),
            CUCKOO_PIG = block("cuckoo_clock/pig"),
            CUCKOO_CREEPER = block("cuckoo_clock/creeper"),
            GANTRY_COGS = block("gantry_carriage/wheels"),
            ROPE_COIL = block("rope_pulley/rope_coil"),
            ROPE_HALF = block("rope_pulley/rope_half"),
            ...
            ELEVATOR_MAGNET = block("elevator_pulley/pulley_magnet"),
            ELEVATOR_BELT = block("elevator_pulley/rope"),
            ELEVATOR_BELT_HALF = block("elevator_pulley/rope_half"),
            MILLSTONE_COG = block("millstone/inner"),
            SYMMETRY_PLANE = block("symmetry_effect/plane"),
            SYMMETRY_CROSSPLANE = block("symmetry_effect/crossplane"),
            ...
            PORTABLE_STORAGE_INTERFACE_MIDDLE_POWERED =
                    block("portable_storage_interface/block_middle_powered"),
            ...
            PORTABLE_FLUID_INTERFACE_MIDDLE_POWERED =
                    block("portable_fluid_interface/block_middle_powered"),
            PORTABLE_FLUID_INTERFACE_TOP = block("portable_fluid_interface/block_top"),
            ARM_COG = block("mechanical_arm/cog"),
            ARM_BASE = block("mechanical_arm/base"),
            ARM_LOWER_BODY = block("mechanical_arm/lower_body"),
            ARM_UPPER_BODY = block("mechanical_arm/upper_body"),
            ...
            FLUID_PIPE_CASING = block("fluid_pipe/casing"),
            ...
            PECULIAR_BELL = block("peculiar_bell"),
            HAUNTED_BELL = block("haunted_bell"),
            ...
            FROGPORT_BODY = block("package_frogport/body"),
            FROGPORT_HEAD = block("package_frogport/head"),
            ...
            PACKAGER_TRAY_REGULAR = block("packager/tray"),
            PACKAGER_TRAY_DEFRAG = block("repackager/tray"),
            ...
            DISPLAY_LINK_TUBE = block("display_link/tube"),
            DISPLAY_LINK_GLOW = block("display_link/glow"),
            STATION_ON = block("track_station/flag_on"),
            STATION_OFF = block("track_station/flag_off"),
    ...
    public static final Map<Direction, PartialModel> FACTORY_PANEL_ARROWS =
            new EnumMap<>(Direction.class);
    public static final Map<Direction, PartialModel> FACTORY_PANEL_LINES =
            new EnumMap<>(Direction.class);
    public static final Map<Direction, PartialModel> FACTORY_PANEL_DOTTED =
            new EnumMap<>(Direction.class);
    ...
    public static final Map<DyeColor, PartialModel> DYED_VALVE_HANDLES =
    ...
    static {
        ...
        for (Direction d : Iterate.horizontalDirections) {
            ...
            FACTORY_PANEL_ARROWS.put(
                    d, block("factory_gauge/connections/arrow_" + Lang.asId(d.name())));
            FACTORY_PANEL_LINES.put(
                    d, block("factory_gauge/connections/line_" + Lang.asId(d.name())));
            FACTORY_PANEL_DOTTED.put(
                    d, block("factory_gauge/connections/dotted_" + Lang.asId(d.name())));
        }
        for (int i = 0; i < 8; i++)
        ...
        for (PackageStyle style : PackageStyles.STYLES) {
            ...
            if (!style.rare()) PACKAGES_TO_HIDE_AS.add(model);
