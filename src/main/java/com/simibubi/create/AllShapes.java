...
public class AllShapes {
    ...
    public static final VoxelShaper CASING_14PX = shape(0, 0, 0, 16, 14, 16).forDirectional(),
            ...
            TEN_VOXEL_POLE = shape(3, 0, 3, 13, 16, 13).forAxis(),
            FURNACE_ENGINE =
                    shape(1, 1, 0, 15, 15, 16).add(0, 0, 9, 16, 16, 14).forHorizontal(SOUTH),
            ...
            ELEVATOR_PULLEY =
                    shape(0, 0, 0, 16, 16, 2)
                            ...
                            .add(2, 0, 2, 14, 14, 14)
                            .forHorizontal(EAST),
            SAIL_FRAME_COLLISION =
                    shape(0, 5, 0, 16, 9, 16).erase(2, 0, 2, 14, 16, 14).forDirectional(),
            ...
            NOZZLE =
                    shape(2, 0, 2, 14, 14, 14)
                            .add(1, 13, 1, 15, 15, 15)
                            .erase(3, 13, 3, 13, 15, 13)
                            .forDirectional(),
            CRANK = shape(5, 0, 5, 11, 6, 11).add(1, 3, 1, 15, 8, 15).forDirectional(),
            VALVE_HANDLE = shape(5, 0, 5, 11, 4, 11).add(1, 3, 1, 15, 8, 15).forDirectional(),
            CART_ASSEMBLER =
                    shape(0, 12, 0, 16, 16, 16).add(-2, 0, 1, 18, 14, 15).forHorizontalAxis(),
            ...
            BELT_FUNNEL_RETRACTED =
                    shape(2, -2, 14, 14, 14, 18).add(0, -5, 8, 16, 16, 14).forHorizontal(NORTH),
            ...
            FUNNEL_WALL =
                    shape(2, 2, 14, 14, 14, 18)
                            ...
                            .forHorizontal(NORTH),
            FLUID_VALVE = shape(3, 0, 3, 13, 16, 13).add(2, 2, 2, 14, 14, 14).forAxis(),
            TOOLBOX = shape(1, 0, 4, 15, 9, 12).forHorizontal(NORTH),
            SMART_FLUID_PIPE_FLOOR =
                    shape(4, 4, 0, 12, 12, 16)
                            .add(3, 3, 3, 13, 13, 13)
                            .add(5, 13, 3, 11, 14, 11)
                            .add(5, 14, 4, 11, 15, 10)
                            .add(5, 15, 5, 11, 16, 9)
            ...
            CRUSHING_WHEEL_CONTROLLER_COLLISION =
                    shape(0, 0, 0, 16, 13, 16).forDirectional(Direction.DOWN),
            BELL_FLOOR = shape(0, 0, 5, 16, 11, 11).add(3, 1, 3, 13, 13, 13).forHorizontal(SOUTH),
            BELL_WALL = shape(5, 5, 8, 11, 11, 16).add(3, 1, 3, 13, 13, 13).forHorizontal(SOUTH),
            BELL_DOUBLE_WALL =
                    shape(5, 5, 0, 11, 11, 16).add(3, 1, 3, 13, 13, 13).forHorizontal(SOUTH),
            BELL_CEILING = shape(0, 5, 5, 16, 16, 11).add(3, 1, 3, 13, 13, 13).forHorizontal(SOUTH),
            GIRDER_BEAM = shape(4, 2, 0, 12, 14, 16).forHorizontalAxis(),
            GIRDER_BEAM_SHAFT =
                    shape(GIRDER_BEAM.get(Axis.X))
                            .add(SIX_VOXEL_POLE.get(Axis.Z))
                            .forHorizontalAxis(),
            STEP_BOTTOM = shape(0, 0, 8, 16, 8, 16).forHorizontal(SOUTH),
            STEP_TOP = shape(0, 8, 8, 16, 16, 16).forHorizontal(SOUTH),
            CONTROLS = shape(0, 0, 6, 16, 16, 16).add(0, 0, 4, 16, 2, 16).forHorizontal(NORTH),
            ...
            CONTRAPTION_CONTROLS =
                    shape(0, 0, 6, 2, 16, 16)
                            ...
                            .add(0, 0, 4, 16, 2, 16)
                            .forHorizontal(NORTH),
            CONTRAPTION_CONTROLS_COLLISION =
                    shape(0, 0, 6, 2, 16, 16)
                            .add(14, 0, 6, 16, 16, 16)
                            .add(0, 0, 14, 16, 16, 16)
                            .add(0, 0, 7, 16, 12, 16)
                            .forHorizontal(NORTH),
            NIXIE_TUBE = shape(9, 0, 5, 15, 12, 11).add(1, 0, 5, 7, 12, 11).forHorizontalAxis(),
            NIXIE_TUBE_CEILING =
                    shape(9, 4, 5, 15, 16, 11).add(1, 4, 5, 7, 16, 11).forHorizontalAxis(),
            NIXIE_TUBE_WALL =
                    shape(5, 9, 0, 11, 15, 12).add(5, 1, 0, 11, 7, 12).forHorizontal(SOUTH),
            FLAP_DISPLAY = shape(0, 0, 3, 16, 16, 13).forHorizontal(SOUTH),
            DATA_GATHERER = shape(1, 0, 1, 15, 6, 15).add(3, 5, 3, 13, 9, 13).forDirectional(),
            ...
            STEAM_ENGINE =
                    shape(1, 0, 1, 15, 3, 15)
                            ...
                            .add(1, 5, 4, 15, 13, 12)
                            .forHorizontalAxis(),
            STEAM_ENGINE_CEILING =
                    shape(1, 13, 1, 15, 16, 15)
                            .add(3, 1, 3, 13, 16, 13)
                            .add(1, 3, 4, 15, 11, 12)
                            .forHorizontalAxis(),
            STEAM_ENGINE_WALL =
            ...
            DEPLOYER_INTERACTION =
                    shape(CASING_12PX.get(UP)).add(SIX_VOXEL_POLE.get(Axis.Y)).forDirectional(UP),
            WHISTLE_BASE = shape(1, 0, 1, 15, 3, 15).add(5, 0, 5, 11, 8, 11).forDirectional(UP),
            DESK_BELL = shape(3, 0, 3, 13, 3, 13).add(4, 0, 4, 12, 9, 12).forDirectional(UP),
            ITEM_HATCH =
                    shape(1, 0, 0, 15, 16, 2)
                            .add(2, 2, 0, 14, 13, 3.8)
                            .add(2, 4, 0, 14, 11, 5.8)
    ...
    private static final VoxelShape
            PISTON_HEAD =
                    Blocks.PISTON_HEAD
                            ...
                            .getShape(null, null),
            PISTON_EXTENDED =
                    shape(CASING_12PX.get(UP)).add(FOUR_VOXEL_POLE.get(Axis.Y)).build(),
            SMALL_GEAR_SHAPE = cuboid(2, 6, 2, 14, 10, 14),
            LARGE_GEAR_SHAPE = cuboid(0, 6, 0, 16, 10, 16),
            VERTICAL_TABLET_SHAPE = cuboid(3, 1, -1, 13, 15, 3),
            SQUARE_TABLET_SHAPE = cuboid(2, 2, -1, 14, 14, 3),
            LOGISTICS_TABLE_SLOPE =
                    shape(0, 10, 10.667, 16, 14, 15)
                            .add(0, 12, 6.333, 16, 16, 10.667)
                            .add(0, 14, 2, 16, 18, 6.333)
                            .build(),
            TANK_BOTTOM_LID = shape(0, 0, 0, 16, 4, 16).build(),
            TANK_TOP_LID = shape(0, 12, 0, 16, 16, 16).build(),
    ...
    public static final VoxelShape SCAFFOLD_HALF = shape(0, 8, 0, 16, 16, 16).build(),
            SCAFFOLD_FULL =
                    shape(SCAFFOLD_HALF)
                            ...
                            .build(),
            TRACK_CROSS =
                    shape(TRACK_ORTHO.get(SOUTH)).add(TRACK_ORTHO.get(EAST)).build(),
            TRACK_CROSS_DIAG =
                    shape(TRACK_DIAG.get(SOUTH)).add(TRACK_DIAG.get(EAST)).build(),
            ...
            CHAIN_CONVEYOR_INTERACTION =
                    shape(-10, 2, 0, 26, 14, 16)
                            .add(0, 2, -10, 16, 14, 26)
                            .add(-5, 2, -5, 21, 14, 21)
                            .add(Shapes.block())
                            .build(),
            ...
            BASIN_BLOCK_SHAPE =
                    shape(0, 2, 0, 16, 16, 16)
                            .erase(2, 2, 2, 14, 16, 14)
                            .add(2, 0, 2, 14, 2, 14)
                            .build(),
            BASIN_RAYTRACE_SHAPE =
                    shape(0, 2, 0, 16, 16, 16).add(2, 0, 2, 14, 2, 14).build(),
            BASIN_COLLISION_SHAPE =
                    shape(0, 2, 0, 16, 13, 16)
                            .erase(2, 5, 2, 14, 16, 14)
                            .add(2, 0, 2, 14, 2, 14)
                            .build(),
            GIRDER_CROSS =
                    shape(TEN_VOXEL_POLE.get(Axis.Y))
                            .add(GIRDER_BEAM.get(Axis.X))
                            .add(GIRDER_BEAM.get(Axis.Z))
                            .build(),
            BACKTANK =
                    shape(3, 0, 3, 13, 12, 13).add(SIX_VOXEL_POLE.get(Axis.Y)).build(),
            SPEED_CONTROLLER =
                    shape(0, 0, 0, 16, 4, 16)
                            .add(1, 1, 1, 15, 13, 15)
                            .add(0, 8, 0, 16, 14, 16)
            ...
            MECHANICAL_PROCESSOR_SHAPE =
                    shape(Shapes.block()).erase(4, 0, 4, 12, 16, 12).build(),
            TURNTABLE_SHAPE = shape(1, 4, 1, 15, 8, 15).add(5, 0, 5, 11, 4, 11).build(),
            CRATE_BLOCK_SHAPE = cuboid(1, 0, 1, 15, 14, 15),
            TABLE_POLE_SHAPE =
                    shape(4, 0, 4, 12, 2, 12).add(5, 2, 5, 11, 14, 11).build(),
            BELT_COLLISION_MASK = cuboid(0, 0, 0, 16, 19, 16),
            SCHEMATICANNON_SHAPE =
                    shape(1, 0, 1, 15, 8, 15).add(0.5, 8, 0.5, 15.5, 11, 15.5).build(),
            PULLEY_MAGNET =
                    shape(3, -3, 3, 13, 2, 13).add(FOUR_VOXEL_POLE.get(UP)).build(),
            SPOUT = shape(1, 2, 1, 15, 14, 15).add(2, 0, 2, 14, 16, 14).build(),
            MILLSTONE = shape(0, 0, 0, 16, 6, 16).add(2, 6, 2, 14, 16, 14).build(),
            CUCKOO_CLOCK = shape(1, 0, 1, 15, 19, 15).build(),
            GAUGE_SHAPE_UP = shape(1, 0, 0, 15, 2, 16).add(2, 2, 1, 14, 14, 15).build(),
            MECHANICAL_ARM =
                    shape(2, 0, 2, 14, 10, 14)
                            .add(3, 0, 3, 13, 14, 13)
                            .add(0, 0, 0, 16, 6, 16)
                            .build(),
            MECHANICAL_ARM_CEILING =
                    shape(2, 6, 2, 14, 16, 14)
                            .add(3, 2, 3, 13, 16, 13)
                            .add(0, 10, 0, 16, 16, 16)
                            .build(),
            CHUTE = shape(1, 8, 1, 15, 16, 15).add(2, 0, 2, 14, 8, 14).build(),
            TANK = shape(1, 0, 1, 15, 16, 15).build(),
            TANK_TOP = shape(TANK_TOP_LID).add(TANK).build(),
            TANK_BOTTOM = shape(TANK_BOTTOM_LID).add(TANK).build(),
            TANK_TOP_BOTTOM = shape(TANK_BOTTOM_LID).add(TANK_TOP_LID).add(TANK).build(),
            FUNNEL_FLOOR =
                    shape(2, -2, 2, 14, 8, 14)
                            .add(1, 1, 1, 15, 8, 15)
                            .add(0, 4, 0, 16, 10, 16)
                            .build(),
            FUNNEL_CEILING =
                    shape(2, 8, 2, 14, 18, 14)
                            .add(1, 8, 1, 15, 15, 15)
                            .add(0, 6, 0, 16, 12, 16)
                            .build(),
            STATION = shape(0, 0, 0, 16, 2, 16).add(1, 0, 1, 15, 13, 15).build(),
            STOCK_TICKER = shape(1, 0, 1, 15, 4, 15).add(2, 0, 2, 14, 16, 14).build(),
            WHISTLE_SMALL_FLOOR = shape(WHISTLE_SMALL).add(WHISTLE_BASE.get(UP)).build(),
            WHISTLE_MEDIUM_FLOOR =
                    shape(WHISTLE_MEDIUM).add(WHISTLE_BASE.get(UP)).build(),
            WHISTLE_LARGE_FLOOR = shape(WHISTLE_LARGE).add(WHISTLE_BASE.get(UP)).build(),
            ...
            WHISTLE_EXTENDER_MEDIUM_DOUBLE_CONNECTED =
                    shape(3, 0, 3, 13, 16, 13).build(),
            WHISTLE_EXTENDER_LARGE_DOUBLE_CONNECTED = shape(2, 0, 2, 14, 16, 14).build();

    // More Shapers
    public static final VoxelShaper
            TRACK_CROSS_ORTHO_DIAG =
                    shape(TRACK_DIAG.get(SOUTH)).add(TRACK_ORTHO.get(EAST)).forHorizontal(SOUTH),
            TRACK_CROSS_DIAG_ORTHO =
                    shape(TRACK_DIAG.get(SOUTH)).add(TRACK_ORTHO.get(SOUTH)).forHorizontal(SOUTH),
            MECHANICAL_PISTON_HEAD = shape(PISTON_HEAD).forDirectional(),
            MECHANICAL_PISTON = CASING_12PX,
            ...
            REDSTONE_BRIDGE =
                    shape(VERTICAL_TABLET_SHAPE)
                            .forDirectional(SOUTH)
                            .withVerticalShapes(LOGISTICAL_CONTROLLER.get(UP)),
            LOGISTICS_TABLE =
                    shape(TABLE_POLE_SHAPE).add(LOGISTICS_TABLE_SLOPE).forHorizontal(SOUTH),
            SCHEMATICS_TABLE =
                    shape(4, 0, 4, 12, 12, 12).add(0, 11, 2, 16, 14, 14).forDirectional(SOUTH),
            CHUTE_SLOPE = shape(ChuteShapes.createSlope()).forHorizontal(SOUTH),
            WHISTLE_SMALL_WALL =
                    shape(WHISTLE_SMALL).add(WHISTLE_BASE.get(NORTH)).forHorizontal(SOUTH),
            WHISTLE_MEDIUM_WALL =
                    shape(WHISTLE_MEDIUM).add(WHISTLE_BASE.get(NORTH)).forHorizontal(SOUTH),
            WHISTLE_LARGE_WALL =
                    shape(WHISTLE_LARGE).add(WHISTLE_BASE.get(NORTH)).forHorizontal(SOUTH);
    ...
    public static class Builder {
        ...
        public VoxelShaper build(
                BiFunction<VoxelShape, Direction, VoxelShaper> factory, Direction direction) {
