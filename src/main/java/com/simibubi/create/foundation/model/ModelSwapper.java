...
public class ModelSwapper {
    ...
    public void onModelBake(ModelEvent.ModifyBakingResult event) {
        ...
        CustomRenderedItems.forEach(item -> swapModels(
                modelRegistry, getItemModelLocation(item), CustomRenderedItemModel::new));
    }
    ...
    public static <T extends BakedModel> void swapModels(
            Map<ModelResourceLocation, BakedModel> modelRegistry,
