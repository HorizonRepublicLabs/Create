...
public class ProjectileUtilMixin {
    ...
    private static boolean create$interactWithEntitiesOnContraptions(
            Entity instance, Operation<Boolean> original) {
        return original.call(instance)
                || instance.getRootVehicle() instanceof AbstractContraptionEntity;
    }
}
