...
public class PartialItemModelRenderer {
    ...
    public static PartialItemModelRenderer of(
            ItemStack stack,
    ...
    private void renderBakedItemModel(
            BakedModel model, int light, PoseStack ms, VertexConsumer buffer) {
        ...
        for (RenderType renderType : model.getRenderTypes(stack, false)) {
            for (Direction direction : Iterate.directions) {
                ...
                ir.renderQuadList(
                        ms,
                        buffer,
                        model.getQuads(null, direction, random, data, renderType),
                        stack,
                        light,
                        overlay);
            }
            ...
            ir.renderQuadList(
                    ms,
                    buffer,
                    model.getQuads(null, null, random, data, renderType),
                    stack,
                    light,
                    overlay);
        }
