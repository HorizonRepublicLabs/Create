...
public interface LayeredArmorItem extends CustomRenderedArmorItem {
    ...
    default void renderArmorPiece(
        ...
        Map<String, ResourceLocation> locationCache =
                HumanoidArmorLayerAccessor.create$getArmorLocationCache();
        ...
        ResourceLocation location2 =
                locationCache.computeIfAbsent(locationStr2, ResourceLocation::parse);
        ...
        ResourceLocation location1 =
                locationCache.computeIfAbsent(locationStr1, ResourceLocation::parse);
    ...
    String getArmorTextureLocation(
            LivingEntity entity, EquipmentSlot slot, ItemStack stack, int layer);
}
