...
public class CreatePonderPlugin implements PonderPlugin {
    ...
    public void registerSharedText(SharedTextRegistrationHelper helper) {
        ...
        helper.registerSharedText(
                "movement_anchors", "With the help of Super Glue, larger structures can be moved.");
        helper.registerSharedText(
    ...
    public void indexExclusions(IndexExclusionHelper helper) {
        ...
        helper.excludeBlockVariants(
                PostboxBlock.class,
                AllBlocks.PACKAGE_POSTBOXES.get(DyeColor.WHITE).get());
        helper.excludeBlockVariants(
                TableClothBlock.class,
                AllBlocks.TABLE_CLOTHS.get(DyeColor.WHITE).get());
    }
}
