...
public final class CreateItemApplicationRecipeGen extends ItemApplicationRecipeGen {
    ...
    GeneratedRecipe
            BOUND_CARDBOARD_BLOCK =
                    create("bound_cardboard_inworld", b -> b.require(
                                    AllBlocks.CARDBOARD_BLOCK.asItem())
            ...
            ANDESITE =
                    woodCasing(
                            ...
                            CreateRecipeProvider.I::andesiteCasing),
            COPPER =
                    woodCasingTag(
                            "copper",
                            CreateRecipeProvider.I::copper,
                            CreateRecipeProvider.I::copperCasing),
            BRASS =
                    woodCasingTag(
                            "brass",
                            CreateRecipeProvider.I::brass,
                            CreateRecipeProvider.I::brassCasing),
            RAILWAY =
                    create("railway_casing", b -> b.require(CreateRecipeProvider.I.brassCasing())
                            .require(CreateRecipeProvider.I.sturdySheet())
                            .output(CreateRecipeProvider.I.railwayCasing()));

    public CreateItemApplicationRecipeGen(
