...
public final class CreateHauntingRecipeGen extends HauntingRecipeGen {
    ...
    GeneratedRecipe
            BRASS_BELL =
                    convert(
                            () -> Ingredient.of(AllBlocks.PECULIAR_BELL.get()),
                            AllBlocks.HAUNTED_BELL::get),
            ...
            HAUNT_MOSSY_STONE_BRICKS =
                    convert(Items.MOSSY_STONE_BRICKS, Items.INFESTED_MOSSY_STONE_BRICKS),
            HAUNT_CRACKED_STONE_BRICKS =
                    convert(Items.CRACKED_STONE_BRICKS, Items.INFESTED_CRACKED_STONE_BRICKS),
            HAUNT_CHISELED_STONE_BRICKS =
                    convert(Items.CHISELED_STONE_BRICKS, Items.INFESTED_CHISELED_STONE_BRICKS),
            ...
            PRISMARINE =
                    create(Create.asResource("lapis_recycling"), b -> b.require(
            ...
            BLACK_STONE =
                    convert(() -> Ingredient.of(Tags.Items.COBBLESTONES), () -> Blocks.BLACKSTONE),
            ...
            // Haunted Harvest
            HH =
                    create(Mods.HH.recipeId("rotten_apple"), b -> b.require(Items.APPLE)
                            .output(Mods.HH, "rotten_apple")
                            .whenModLoaded(Mods.HH.getId()));

    public CreateHauntingRecipeGen(
