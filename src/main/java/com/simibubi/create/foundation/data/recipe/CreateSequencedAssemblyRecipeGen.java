...
public final class CreateSequencedAssemblyRecipeGen extends SequencedAssemblyRecipeGen {
    ...
    GeneratedRecipe
            PRECISION_MECHANISM =
                    create("precision_mechanism", b -> b.require(I.goldSheet())
                            ...
                            .addStep(
                                    ...
                                    rb -> rb.require(I.ironNugget()))),
            REINFORCED_SHEET =
                    create("sturdy_sheet", b -> b.require(AllItemTags.OBSIDIAN_DUST.tag)
                            ...
                            .addStep(PressingRecipe::new, rb -> rb)),
            TRACK =
                    create("track", b -> b.require(AllItemTags.SLEEPERS.tag)
                            .transitionTo(AllItems.INCOMPLETE_TRACK.get())
                            .addOutput(AllBlocks.TRACK.get(), 1)
                            .loops(1)
                            .addStep(
                                    DeployerApplicationRecipe::new,
                                    rb -> rb.require(Ingredient.fromValues(Stream.of(
                                            new Ingredient.TagValue(I.ironNugget()),
                                            new Ingredient.TagValue(I.zincNugget())))))
                            .addStep(
                                    DeployerApplicationRecipe::new,
                                    rb -> rb.require(Ingredient.fromValues(Stream.of(
                                            new Ingredient.TagValue(I.ironNugget()),
    ...
    public CreateSequencedAssemblyRecipeGen(
