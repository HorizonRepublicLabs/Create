...
public final class CreateMixingRecipeGen extends MixingRecipeGen {
    ...
    GeneratedRecipe
            TEMP_LAVA =
                    create("lava_from_cobble", b -> b.require(Tags.Items.COBBLESTONES)
                            .output(Fluids.LAVA, 50)
                            .requiresHeat(HeatCondition.SUPERHEATED)),
            TEA =
                    create("tea", b -> b.require(Fluids.WATER, 250)
                            .require(Tags.Fluids.MILK, 250)
                            .require(ItemTags.LEAVES)
                            .output(AllFluids.TEA.get(), 500)
                            .requiresHeat(HeatCondition.HEATED)),
            CHOCOLATE =
                    create("chocolate", b -> b.require(Tags.Fluids.MILK, 250)
                            .require(Items.SUGAR)
                            .require(Items.COCOA_BEANS)
                            .output(AllFluids.CHOCOLATE.get(), 250)
                            .requiresHeat(HeatCondition.HEATED)),
            CHOCOLATE_MELTING =
                    create("chocolate_melting", b -> b.require(AllItems.BAR_OF_CHOCOLATE.get())
                            .output(AllFluids.CHOCOLATE.get(), 250)
                            .requiresHeat(HeatCondition.HEATED)),
            HONEY =
                    create("honey", b -> b.require(Items.HONEY_BLOCK)
                            .output(AllFluids.HONEY.get(), 1000)
                            .requiresHeat(HeatCondition.HEATED)),
            DOUGH =
                    create("dough_by_mixing", b -> b.require(CreateRecipeProvider.I.wheatFlour())
                            .require(Fluids.WATER, 1000)
                            .output(AllItems.DOUGH.get(), 1)),
            BRASS_INGOT =
                    create("brass_ingot", b -> b.require(CreateRecipeProvider.I.copper())
                            .require(CreateRecipeProvider.I.zinc())
                            .output(AllItems.BRASS_INGOT.get(), 2)
                            .requiresHeat(HeatCondition.HEATED)),
            ANDESITE_ALLOY =
                    create("andesite_alloy", b -> b.require(Blocks.ANDESITE)
                            .require(CreateRecipeProvider.I.ironNugget())
                            .output(CreateRecipeProvider.I.andesiteAlloy(), 1)),
            ANDESITE_ALLOY_FROM_ZINC =
                    create("andesite_alloy_from_zinc", b -> b.require(Blocks.ANDESITE)
                            .require(CreateRecipeProvider.I.zincNugget())
                            .output(CreateRecipeProvider.I.andesiteAlloy(), 1)),
            MUD =
                    create("mud_by_mixing", b -> b.require(
                                    new BlockTagIngredient(BlockTags.CONVERTABLE_TO_MUD))
                            .require(Fluids.WATER, 250)
                            .output(Blocks.MUD, 1)),
            PULP =
                    create("cardboard_pulp", b -> b.require(AllItemTags.PULPIFIABLE.tag)
            ...
            AE2_FLUIX =
                    create(Mods.AE2.recipeId("fluix_crystal"), b -> b.require(
