...
public class CreateEntityBuilder<T extends Entity, P> extends EntityBuilder<T, P> {
    ...
    public static <T extends Entity, P> EntityBuilder<T, P> create(
        ...
        return (new CreateEntityBuilder<>(owner, parent, name, callback, factory, classification))
                .defaultLang();
    }
    ...
    public CreateEntityBuilder<T, P> visual(
            NonNullSupplier<SimpleEntityVisualizer.Factory<T>> visualFactory) {
