...
public final class CreateFillingRecipeGen extends FillingRecipeGen {
    ...
    GeneratedRecipe
            ...
            VMP_CURSED_GRASS =
                    create(Mods.VMP.recipeId("cursed_grass"), b -> b.require(Fluids.WATER, 500)
            ...
            IE_TREATED_WOOD =
                    create(Mods.IE.recipeId("treated_wood_in_spout"), b -> b.require(
                                    AllFluidTags.CREOSOTE.tag, 125)
