...
public final class CreateCrushingRecipeGen extends CrushingRecipeGen {
    ...
    GeneratedRecipe
            ...
            GOLDEN_HORSE_ARMOR =
                    create(() -> Items.GOLDEN_HORSE_ARMOR, b -> b.duration(200)
            ...
            DEEP_COAL_ORE =
                    deepslateOre(() -> Items.DEEPSLATE_COAL_ORE, () -> Items.COAL, 2.25f, 300),
            DEEP_IRON_ORE =
                    deepslateOre(
                            () -> Items.DEEPSLATE_IRON_ORE, AllItems.CRUSHED_IRON::get, 2.25f, 350),
            DEEP_COPPER_ORE =
                    deepslateOre(
            ...
            DEEP_GOLD_ORE =
                    deepslateOre(
                            () -> Items.DEEPSLATE_GOLD_ORE, AllItems.CRUSHED_GOLD::get, 2.25f, 350),
            DEEP_REDSTONE_ORE =
                    deepslateOre(
                            () -> Items.DEEPSLATE_REDSTONE_ORE, () -> Items.REDSTONE, 7.5f, 350),
            DEEP_EMERALD_ORE =
                    deepslateOre(
                            () -> Items.DEEPSLATE_EMERALD_ORE, () -> Items.EMERALD, 2.25f, 450),
            DEEP_LAPIS_ORE =
                    deepslateOre(
                            () -> Items.DEEPSLATE_LAPIS_ORE, () -> Items.LAPIS_LAZULI, 12.5f, 350),
            DEEP_DIAMOND_ORE =
                    deepslateOre(
                            () -> Items.DEEPSLATE_DIAMOND_ORE, () -> Items.DIAMOND, 2.25f, 450),
            DEEP_ZINC_ORE =
                    deepslateOre(
                            AllBlocks.DEEPSLATE_ZINC_ORE::get,
                            AllItems.CRUSHED_ZINC::get,
                            2.25f,
                            350),
            NETHER_GOLD_ORE =
                    netherOre(() -> Items.NETHER_GOLD_ORE, () -> Items.GOLD_NUGGET, 18, 350),
            NETHER_QUARTZ_ORE =
                    netherOre(() -> Items.NETHER_QUARTZ_ORE, () -> Items.QUARTZ, 2.25f, 350),
            GILDED_BLACKSTONE =
                    ore(
                            Items.BLACKSTONE,
            ...
            QUICKSILVER_RAW_BLOCK =
                    moddedRawOreBlock(QUICKSILVER, AllItems.CRUSHED_QUICKSILVER::get),
            ...
            BWG_AMETRINE_ORE =
                    create(Mods.BWG.recipeId("ametrine_ore"), b -> b.duration(500)
            ...
            BWG_ANTHRACITE_ORE =
                    create(Mods.BWG.recipeId("anthracite_ore"), b -> b.duration(150)
                            ...
                            .whenModLoaded(Mods.BWG.getId())),
            BWG_BLUE_GOLD_ORE =
                    create(Mods.BWG.recipeId("blue_nether_gold_ore"), b -> b.duration(350)
                            ...
                            .whenModLoaded(Mods.BWG.getId())),
            BWG_BLUE_QUARTZ_ORE =
                    create(Mods.BWG.recipeId("blue_nether_quartz_ore"), b -> b.duration(350)
            ...
            BWG_BRIMSTONE_GOLD_ORE =
                    create(Mods.BWG.recipeId("brimstone_nether_gold_ore"), b -> b.duration(350)
            ...
            BWG_BRIMSTONE_QUARTZ_ORE =
                    create(Mods.BWG.recipeId("brimstone_nether_quartz_ore"), b -> b.duration(350)
                            ...
                            .whenModLoaded(Mods.BWG.getId())),
            BWG_REDSTONE_ORE =
                    create(Mods.BWG.recipeId("cryptic_redstone_ore"), b -> b.duration(250)
                            ...
                            .whenModLoaded(Mods.BWG.getId())),
            BWG_EMERALDITE_ORE =
                    create(Mods.BWG.recipeId("emeraldite_ore"), b -> b.duration(500)
                            ...
                            .whenModLoaded(Mods.BWG.getId())),
            BWG_LIGNITE_ORE =
                    create(Mods.BWG.recipeId("lignite_ore"), b -> b.duration(300)
                            ...
                            .whenModLoaded(Mods.BWG.getId())),
            BWG_NETHERRACK_ORE =
                    create(Mods.BWG.recipeId("pervaded_netherrack"), b -> b.duration(150)
                            .require(AllItemTags.EMERALDITE_ORES.tag)
                            ...
                            .whenModLoaded(Mods.BWG.getId())),
            BWG_RED_ROCK_ORE =
                    create(Mods.BWG.recipeId("red_rock"), b -> b.duration(150)
            ...
            DC_AMBER_ORE =
                    create(Mods.DRUIDCRAFT.recipeId("amber_ore"), b -> b.duration(300)
            ...
            DC_FIERY_GLASS_ORE =
                    create(Mods.DRUIDCRAFT.recipeId("fiery_glass_ore"), b -> b.duration(300)
                            ...
                            .whenModLoaded(Mods.DRUIDCRAFT.getId())),
            DC_MOONSTONE_ORE =
                    create(Mods.DRUIDCRAFT.recipeId("moonstone_ore"), b -> b.duration(300)
            ...
            NEA_ICE =
                    create(Mods.NEA.recipeId("ice"), b -> b.duration(100)
                            .require(Items.ICE)
            ...
            Q_MOSS =
                    create(Mods.Q.recipeId("moss_block"), b -> b.duration(50)
            ...
            ENS_DUST =
                    create(Mods.ENS.recipeId("dust"), b -> b.duration(200)
                            .require(Blocks.SAND)
                            .output(Mods.ENS, "dust")
                            .whenModLoaded(Mods.ENS.getId())),
            ENS_NETHERRACK =
                    create(Mods.ENS.recipeId("crushed_netherrack"), b -> b.duration(100)
                            .require(Mods.ENS, "crushed_netherrack")
                            .output(AllItems.CINDER_FLOUR.get())
                            .output(.5f, AllItems.CINDER_FLOUR.get())
                            .whenModLoaded(Mods.ENS.getId())),
            ENS_DIORITE =
                    create(Mods.ENS.recipeId("crushed_diorite"), b -> b.duration(100)
            ...
            AET_ZANITE =
                    create(Mods.AET.recipeId("zanite_ore"), b -> b.duration(350)
            ...
            AET_AMBROSIUM =
                    create(Mods.AET.recipeId("ambrosium_ore"), b -> b.duration(150)
            ...
            IE_COKE_DUST =
                    create(Mods.IE.recipeId("coal_coke"), b -> b.duration(200)
                            .require(Mods.IE, "coal_coke")
                            .output(Mods.IE, "dust_coke")
                            .whenModLoaded(Mods.IE.getId())),
            IE_COKE_BLOCK =
                    create(Mods.IE.recipeId("coke_block"), b -> b.duration(200)
                            .require(Mods.IE, "coke")
                            .output(1, Mods.IE.asResource("dust_coke"), 9)
                            .whenModLoaded(Mods.IE.getId())),
            IE_SLAG_GRAVEL =
                    create(Mods.IE.recipeId("slag"), b -> b.duration(200)
            ...
            // Biomes O Plenty
            BOP_ROSE_QUARTZ =
                    create(Mods.BOP.recipeId("rose_quartz"), b -> b.duration(150)
    ...
    public CreateCrushingRecipeGen(
    ...
    GeneratedRecipe ensMineralRecycling(
        ...
        return create(
                type.getBaseBlock()::get, b -> transform.apply(b.whenModMissing(Mods.ENS.getId())));
    }
}
