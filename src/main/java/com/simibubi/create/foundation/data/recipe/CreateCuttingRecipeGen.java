...
public final class CreateCuttingRecipeGen extends CuttingRecipeGen {
    ...
    GeneratedRecipe
            ANDESITE_ALLOY =
                    create(I::andesiteAlloy, b -> b.duration(200).output(AllBlocks.SHAFT.get(), 6)),
            BAMBOO_PLANKS =
                    create(() -> Blocks.BAMBOO_PLANKS, b -> b.duration(20)
            ...
            // Ars Nouveau (all logs yield the same plank) (blue is covered by RuntimeDataGenerator
            // to
            // handle the planks into other recipes)
            ARS_N_1 =
                    stripAndMakePlanks(
                            Mods.ARS_N, null, "stripped_purple_archwood_log", "archwood_planks"),
            ARS_N_2 =
                    stripAndMakePlanks(
                            Mods.ARS_N, null, "stripped_green_archwood_log", "archwood_planks"),
            ARS_N_3 =
                    stripAndMakePlanks(
                            Mods.ARS_N, null, "stripped_red_archwood_log", "archwood_planks"),
            ARS_N_4 =
                    stripAndMakePlanks(
                            Mods.ARS_N, null, "stripped_purple_archwood_wood", "archwood_planks"),
            ARS_N_5 =
                    stripAndMakePlanks(
                            Mods.ARS_N, null, "stripped_green_archwood_wood", "archwood_planks"),
            ARS_N_6 =
                    stripAndMakePlanks(
            ...
            ENDERGETIC_1 =
                    stripAndMakePlanks(
                            Mods.ENDER, "glowing_poise_stem", "stripped_poise_stem", null),
            ENDERGETIC_2 =
                    stripAndMakePlanks(
                            Mods.ENDER, "glowing_poise_wood", "stripped_poise_wood", null),

            // IE
            IE_WIRES =
                    ieWires(
                            CommonMetal.COPPER,
                            CommonMetal.ELECTRUM,
                            CommonMetal.ALUMINUM,
                            CommonMetal.STEEL,
                            CommonMetal.LEAD),
            ...
            JNE_1 =
                    stripAndMakePlanks(
                            Mods.JNE, "cerebrage_claret_stem", "stripped_claret_stem", null),
            JNE_2 =
                    stripAndMakePlanks(
                            Mods.JNE, "cerebrage_claret_hyphae", "stripped_claret_hyphae", null),
