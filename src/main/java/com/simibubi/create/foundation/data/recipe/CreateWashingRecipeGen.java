...
public final class CreateWashingRecipeGen extends WashingRecipeGen {
    ...
    GeneratedRecipe WOOL = create("wool", b -> b.require(ItemTags.WOOL).output(Items.WHITE_WOOL)),
            STAINED_GLASS =
                    create("stained_glass", b -> b.require(Tags.Items.GLASS_BLOCKS)
                            .output(Items.GLASS)),
            STAINED_GLASS_PANE =
                    create("stained_glass_pane", b -> b.require(Tags.Items.GLASS_PANES)
                            .output(Items.GLASS_PANE)),
            GRAVEL =
                    create(() -> Blocks.GRAVEL, b -> b.output(.25f, Items.FLINT)
                            .output(.125f, Items.IRON_NUGGET)),
            SOUL_SAND =
                    create(() -> Blocks.SOUL_SAND, b -> b.output(.125f, Items.QUARTZ, 4)
                            .output(.02f, Items.GOLD_NUGGET)),
            RED_SAND =
                    create(() -> Blocks.RED_SAND, b -> b.output(.125f, Items.GOLD_NUGGET, 3)
            ...
            WEATHERED_IRON_BLOCK =
                    create(
                            ...
                            b -> b.output(AllBlocks.WEATHERED_IRON_BLOCK)),
            WEATHERED_IRON_WINDOW =
                    create(
                            AllPaletteBlocks.INDUSTRIAL_IRON_WINDOW::get,
                            b -> b.output(AllPaletteBlocks.WEATHERED_IRON_WINDOW)),
            WEATHERED_IRON_WINDOW_PANE =
                    create(
                            AllPaletteBlocks.INDUSTRIAL_IRON_WINDOW_PANE::get,
            ...
            ICE = convert(Blocks.ICE, Blocks.PACKED_ICE),
            MAGMA_BLOCK = convert(Blocks.MAGMA_BLOCK, Blocks.OBSIDIAN),
            FLOUR =
                    create("wheat_flour", b -> b.require(I.wheatFlour())
                            .output(AllItems.DOUGH.get())),

            // Atmospheric
            ATMO_SAND =
                    create("atmospheric/arid_sand", b -> b.require(Mods.ATM, "arid_sand")
                            .output(.25f, Items.CLAY_BALL, 1)
                            .output(0.05f, Mods.ATM, "aloe_kernels", 1)
                            .whenModLoaded(Mods.ATM.getId())),
            ATMO_RED_SAND =
                    create("atmospheric/red_arid_sand", b -> b.require(Mods.ATM, "red_arid_sand")
            ...
            ENDER_END_BLOCK =
                    simpleModded(Mods.ENDER, "end_corrock_block", "petrified_end_corrock_block"),
            ENDER_END_CROWN =
                    simpleModded(Mods.ENDER, "end_corrock_crown", "petrified_end_corrock_crown"),
            ENDER_NETHER = simpleModded(Mods.ENDER, "nether_corrock", "petrified_nether_corrock"),
            ENDER_NETHER_BLOCK =
                    simpleModded(
                            Mods.ENDER, "nether_corrock_block", "petrified_nether_corrock_block"),
            ENDER_NETHER_CROWN =
                    simpleModded(
                            Mods.ENDER, "nether_corrock_crown", "petrified_nether_corrock_crown"),
            ENDER_OVERWORLD =
                    simpleModded(Mods.ENDER, "overworld_corrock", "petrified_overworld_corrock"),
            ENDER_OVERWORLD_BLOCK =
                    simpleModded(
                            Mods.ENDER,
                            "overworld_corrock_block",
                            "petrified_overworld_corrock_block"),
            ENDER_OVERWORLD_CROWN =
                    simpleModded(
                            Mods.ENDER,
                            "overworld_corrock_crown",
                            "petrified_overworld_corrock_crown"),
    ...
    public GeneratedRecipe moddedCrushedOre(ItemEntry<? extends Item> crushed, CommonMetal metal) {
        for (Mods mod : metal.mods) {
            ...
            create(mod.getId() + "/" + crushed.getId().getPath(), b -> b.withItemIngredients(
