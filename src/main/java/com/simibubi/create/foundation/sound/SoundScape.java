...
class SoundScape {
    ...
    public SoundScape repeating(
            SoundEvent sound, float relativeVolume, float relativePitch, int delay) {
    ...
    public float getVolume() {
        ...
        if (renderViewEntity != null) {
            ...
            distanceMultiplier =
                    (float) Mth.lerp(distanceTo / SoundScapes.MAX_AMBIENT_SOURCE_DISTANCE, 2, 0);
        }
