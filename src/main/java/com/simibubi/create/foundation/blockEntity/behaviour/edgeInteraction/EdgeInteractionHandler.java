...
public class EdgeInteractionHandler {
    ...
    public static void onBlockActivated(PlayerInteractEvent.RightClickBlock event) {
        ...
        Direction activatedDirection =
                getActivatedDirection(world, pos, ray.getDirection(), ray.getLocation(), behaviour);
        if (activatedDirection == null) return;
    ...
    public static List<Direction> getConnectiveSides(
        ...
        for (Direction direction : Iterate.directions) {
            ...
            if (!behaviour.connectivityPredicate.test(world, pos, face, direction)) continue;
            sides.add(direction);
        }
    ...
    public static Direction getActivatedDirection(
        ...
        for (Direction facing : getConnectiveSides(world, pos, face, behaviour)) {
            ...
            if (bb.contains(hit)) return facing;
        }
        return null;
    }
