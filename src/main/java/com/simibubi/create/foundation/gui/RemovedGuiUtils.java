...
public class RemovedGuiUtils {
    ...
    public static void drawHoveringText(
        ...
        drawHoveringText(
                ...
                screenHeight,
                maxTextWidth,
                IGuiGraphicsExtension.DEFAULT_BACKGROUND_COLOR,
                IGuiGraphicsExtension.DEFAULT_BORDER_COLOR_START,
                IGuiGraphicsExtension.DEFAULT_BORDER_COLOR_END,
                font);
    }
    ...
    public static void drawHoveringText(
        ...
        List<ClientTooltipComponent> list = ClientHooks.gatherTooltipComponents(
                stack, textLines, stack.getTooltipImage(), mouseX, screenWidth, screenHeight, font);
        RenderTooltipEvent.Pre event = new RenderTooltipEvent.Pre(
                stack, graphics, mouseX, mouseY, screenWidth, screenHeight, font, list, null);
        ...
        if (needsWrap) {
            ...
            for (int i = 0; i < textLines.size(); i++) {
                ...
                List<FormattedText> wrappedLine =
                        font.getSplitter().splitLines(textLine, tooltipTextWidth, Style.EMPTY);
