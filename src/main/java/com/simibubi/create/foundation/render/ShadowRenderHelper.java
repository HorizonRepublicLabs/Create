...
public class ShadowRenderHelper {
    ...
    private static final RenderType SHADOW_LAYER = RenderType.entityNoOutline(
            ResourceLocation.withDefaultNamespace("textures/misc/shadow.png"));

    public static void renderShadow(
            PoseStack matrixStack, MultiBufferSource buffer, float opacity, float radius) {
    ...
    public static void renderShadow(
        ...
        for (BlockPos blockpos :
                BlockPos.betweenClosed(new BlockPos(i, k, i1), new BlockPos(j, l, j1))) {
    ...
    private static void renderBlockShadow(
        ...
        if (blockstate.getRenderShape() != RenderShape.INVISIBLE
                && world.getMaxLocalRawBrightness(pos) > 3) {
