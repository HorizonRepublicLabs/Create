...
public class AirParticleData
        implements ParticleOptions, ICustomParticleDataWithSprite<AirParticleData> {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, AirParticleData> STREAM_CODEC =
