...
public class CreateDamageSources {
    ...
    public static DamageSource potatoCannon(
            Level level, Entity causingEntity, Entity directEntity) {
    ...
    private static DamageSource source(
            ResourceKey<DamageType> key, LevelReader level, @Nullable Entity entity) {
        Registry<DamageType> registry =
                level.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE);
