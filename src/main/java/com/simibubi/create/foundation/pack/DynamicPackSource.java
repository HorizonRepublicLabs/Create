...
public record DynamicPackSource(
    ...
    public void loadPacks(@NotNull Consumer<Pack> onLoad) {
        ...
        ResourcesSupplier resourcesSupplier = new ResourcesSupplier() {
            ...
            public @NotNull PackResources openFull(
                    @NotNull PackLocationInfo packLocationInfo, @NotNull Metadata metadata) {
                return packResources;
            }
        };
        onLoad.accept(
                Pack.readMetaAndCreate(locationInfo, resourcesSupplier, packType, selectionConfig));
    }
}
