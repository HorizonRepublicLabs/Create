...
public class AllCreativeModeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> BASE_CREATIVE_TAB =
            REGISTER.register("base", () -> CreativeModeTab.builder()
                    ...
                    .displayItems(new RegistrateDisplayItemsGenerator(
                            true, AllCreativeModeTabs.BASE_CREATIVE_TAB))
                    .build());

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> PALETTES_CREATIVE_TAB =
            REGISTER.register("palettes", () -> CreativeModeTab.builder()
                    ...
                    .displayItems(new RegistrateDisplayItemsGenerator(
                            false, AllCreativeModeTabs.PALETTES_CREATIVE_TAB))
                    .build());
    ...
    private record RegistrateDisplayItemsGenerator(
            boolean addItems, DeferredHolder<CreativeModeTab, CreativeModeTab> tabFilter)
        ...
        private static List<ItemOrdering> makeOrderings() {
            ...
            Map<ItemProviderEntry<?, ?>, ItemProviderEntry<?, ?>> simpleAfterOrderings =
                    Map.of(AllItems.VERTICAL_GEARBOX, AllBlocks.GEARBOX);
        ...
        private static Function<Item, TabVisibility> makeVisibilityFunc() {
            ...
            Map<ItemProviderEntry<?, ?>, TabVisibility> simpleVisibilities =
                    Map.of(AllItems.BLAZE_CAKE_BASE, TabVisibility.SEARCH_TAB_ONLY);
        ...
        private static void outputAll(
                Output output,
                List<Item> items,
                Function<Item, ItemStack> stackFunc,
