...
public class AllSoundEvents {
    ...
    public static final SoundEntry
            ...
            MECHANICAL_PRESS_ACTIVATION =
                    create("mechanical_press_activation")
                            .subtitle("Mechanical Press clangs")
            ...
            MECHANICAL_PRESS_ACTIVATION_ON_BELT =
                    create("mechanical_press_activation_belt")
                            .subtitle("Mechanical Press bonks")
            ...
            DENY =
                    create("deny")
                            .subtitle("Declining boop")
                            .playExisting(SoundEvents.NOTE_BLOCK_BASS::value, 1f, 0.5f)
                            .category(SoundSource.PLAYERS)
                            .build(),
            COGS =
                    create("cogs")
                            .subtitle("Cogwheels rumble")
                            .category(SoundSource.BLOCKS)
                            .build(),
            FWOOMP =
                    create("fwoomp")
                            .subtitle("Resonant fwoomp")
                            .category(SoundSource.PLAYERS)
                            .build(),
            CARDBOARD_SWORD =
                    create("cardboard_bonk")
                            .subtitle("Resonant bonk")
                            .category(SoundSource.PLAYERS)
                            .build(),
            FROGPORT_OPEN =
                    create("frogport_open")
                            .subtitle("Frogport opens")
                            .playExisting(SoundEvents.WARDEN_TENDRIL_CLICKS, 1f, 2f)
                            .category(SoundSource.BLOCKS)
                            .build(),
            FROGPORT_CLOSE =
                    create("frogport_close")
                            .subtitle("Frogport shuts")
                            .category(SoundSource.BLOCKS)
                            .build(),
            FROGPORT_CATCH =
                    create("frogport_catch")
                            .subtitle("Frogport catches package")
            ...
            STOCK_LINK =
                    create("stock_link")
                            .subtitle("Stock link reacts")
                            .category(SoundSource.BLOCKS)
                            .build(),
            FROGPORT_DEPOSIT =
                    create("frogport_deposit")
                            .subtitle("Frogport places package")
                            .playExisting(SoundEvents.FROG_TONGUE, 1f, 1f)
                            .category(SoundSource.BLOCKS)
                            .build(),
            POTATO_HIT =
                    create("potato_hit")
                            .subtitle("Vegetable impacts")
            ...
            BLAZE_MUNCH =
                    create("blaze_munch")
                            .subtitle("Blaze Burner munches")
                            .playExisting(SoundEvents.GENERIC_EAT, .5f, 1f)
                            .category(SoundSource.BLOCKS)
                            .build(),
            ITEM_HATCH =
                    create("item_hatch")
                            .subtitle("Item Hatch opens")
            ...
            PECULIAR_BELL_USE =
                    create("peculiar_bell_use")
                            .subtitle("Peculiar Bell tolls")
                            .playExisting(SoundEvents.BELL_BLOCK)
                            .category(SoundSource.BLOCKS)
                            .build(),
            DESK_BELL_USE =
                    create("desk_bell")
                            .subtitle("Reception bell dings")
                            .category(SoundSource.BLOCKS)
                            .attenuationDistance(64)
                            .build(),
            WHISTLE_HIGH =
                    create("whistle_high")
                            .subtitle("High whistling")
            ...
            WHISTLE_LOW =
                    create("whistle_low")
                            .subtitle("Low whistling")
                            .category(SoundSource.RECORDS)
                            .attenuationDistance(64)
                            .build(),
            STEAM =
                    create("steam")
                            .subtitle("Steam noises")
                            .category(SoundSource.NEUTRAL)
                            .attenuationDistance(32)
                            .build(),
            TRAIN =
                    create("train")
                            .subtitle("Bogey wheels rumble")
                            .category(SoundSource.NEUTRAL)
            ...
            TRAIN3 =
                    create("train3")
                            .subtitle("Bogey wheels rumble muffled")
                            .category(SoundSource.NEUTRAL)
            ...
            WHISTLE_TRAIN_MANUAL_LOW_END =
                    create("whistle_train_manual_low_end")
                            ...
                            .build(),
            WHISTLE_CHIFF =
                    create("chiff").noSubtitle().category(SoundSource.RECORDS).build(),
            HAUNTED_BELL_CONVERT =
                    create("haunted_bell_convert")
                            .subtitle("Haunted Bell awakens")
                            .category(SoundSource.BLOCKS)
                            .build(),
            HAUNTED_BELL_USE =
                    create("haunted_bell_use")
                            .subtitle("Haunted Bell tolls")
                            .category(SoundSource.BLOCKS)
                            .build(),
            STOCK_TICKER_REQUEST =
                    create("stock_ticker_request")
                            .subtitle("Stock ticker requests")
                            .category(SoundSource.BLOCKS)
                            .build(),
            STOCK_TICKER_TRADE =
                    create("stock_ticker_trade")
                            .subtitle("Stock ticker goes 'ka-ching!'")
                            .category(SoundSource.BLOCKS)
                            .build(),
            CLIPBOARD_CHECKMARK =
    ...
    public static class SoundEntryBuilder {
        ...
        public SoundEntryBuilder playExisting(
                Supplier<SoundEvent> event, float volume, float pitch) {
    ...
    public abstract static class SoundEntry {
        ...
        public abstract void playAt(
                Level world, double x, double y, double z, float volume, float pitch, boolean fade);
    }
    ...
    private static class WrappedSoundEntry extends SoundEntry {
        ...
        public WrappedSoundEntry(
                ResourceLocation id,
                String subtitle,
                List<ConfiguredSoundEvent> wrappedEvents,
                SoundSource category,
                int attenuationDistance) {
        ...
        public void prepare() {
            for (int i = 0; i < wrappedEvents.size(); i++) {
                ...
                DeferredHolder<SoundEvent, SoundEvent> event =
                        DeferredHolder.create(Registries.SOUND_EVENT, location);
                compiledEvents.add(
                        new CompiledSoundEvent(event, wrapped.volume(), wrapped.pitch()));
            }
        }
        ...
        protected ResourceLocation getIdOf(int i) {
            return ResourceLocation.fromNamespaceAndPath(
                    id.getNamespace(), i == 0 ? id.getPath() : id.getPath() + "_compounded_" + i);
        }
        ...
        private record CompiledSoundEvent(
                DeferredHolder<SoundEvent, SoundEvent> event, float volume, float pitch) {}
    }
